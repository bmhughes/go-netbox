...
func (o *CircuitsCircuitTerminationsBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitTerminationsBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitTerminationsBulkDeleteBadRequest creates a CircuitsCircuitTerminationsBulkDeleteBadRequest with default headers values
func NewCircuitsCircuitTerminationsBulkDeleteBadRequest() *CircuitsCircuitTerminationsBulkDeleteBadRequest {
	return &CircuitsCircuitTerminationsBulkDeleteBadRequest{}
}

/*
CircuitsCircuitTerminationsBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitTerminationsBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuit terminations bulk delete bad request response has a 2xx status code
func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuit terminations bulk delete bad request response has a 3xx status code
func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuit terminations bulk delete bad request response has a 4xx status code
func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuit terminations bulk delete bad request response has a 5xx status code
func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuit terminations bulk delete bad request response a status code equal to that given
func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /circuits/circuit-terminations/][%d] circuitsCircuitTerminationsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /circuits/circuit-terminations/][%d] circuitsCircuitTerminationsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsCircuitTerminationsBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
