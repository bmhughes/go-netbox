...
func (o *CircuitsCircuitTerminationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitTerminationsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitTerminationsListBadRequest creates a CircuitsCircuitTerminationsListBadRequest with default headers values
func NewCircuitsCircuitTerminationsListBadRequest() *CircuitsCircuitTerminationsListBadRequest {
	return &CircuitsCircuitTerminationsListBadRequest{}
}

/*
CircuitsCircuitTerminationsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitTerminationsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuit terminations list bad request response has a 2xx status code
func (o *CircuitsCircuitTerminationsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuit terminations list bad request response has a 3xx status code
func (o *CircuitsCircuitTerminationsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuit terminations list bad request response has a 4xx status code
func (o *CircuitsCircuitTerminationsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuit terminations list bad request response has a 5xx status code
func (o *CircuitsCircuitTerminationsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuit terminations list bad request response a status code equal to that given
func (o *CircuitsCircuitTerminationsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitTerminationsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /circuits/circuit-terminations/][%d] circuitsCircuitTerminationsListBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTerminationsListBadRequest) String() string {
	return fmt.Sprintf("[GET /circuits/circuit-terminations/][%d] circuitsCircuitTerminationsListBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTerminationsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsCircuitTerminationsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
