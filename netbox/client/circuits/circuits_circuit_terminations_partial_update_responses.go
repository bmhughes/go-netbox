...
func (o *CircuitsCircuitTerminationsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitTerminationsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitTerminationsPartialUpdateBadRequest creates a CircuitsCircuitTerminationsPartialUpdateBadRequest with default headers values
func NewCircuitsCircuitTerminationsPartialUpdateBadRequest() *CircuitsCircuitTerminationsPartialUpdateBadRequest {
	return &CircuitsCircuitTerminationsPartialUpdateBadRequest{}
}

/*
CircuitsCircuitTerminationsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitTerminationsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuit terminations partial update bad request response has a 2xx status code
func (o *CircuitsCircuitTerminationsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuit terminations partial update bad request response has a 3xx status code
func (o *CircuitsCircuitTerminationsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuit terminations partial update bad request response has a 4xx status code
func (o *CircuitsCircuitTerminationsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuit terminations partial update bad request response has a 5xx status code
func (o *CircuitsCircuitTerminationsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuit terminations partial update bad request response a status code equal to that given
func (o *CircuitsCircuitTerminationsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitTerminationsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /circuits/circuit-terminations/{id}/][%d] circuitsCircuitTerminationsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTerminationsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /circuits/circuit-terminations/{id}/][%d] circuitsCircuitTerminationsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTerminationsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
