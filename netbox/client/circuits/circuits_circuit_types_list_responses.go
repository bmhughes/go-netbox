...
func (o *CircuitsCircuitTypesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitTypesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitTypesListBadRequest creates a CircuitsCircuitTypesListBadRequest with default headers values
func NewCircuitsCircuitTypesListBadRequest() *CircuitsCircuitTypesListBadRequest {
	return &CircuitsCircuitTypesListBadRequest{}
}

/*
CircuitsCircuitTypesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitTypesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuit types list bad request response has a 2xx status code
func (o *CircuitsCircuitTypesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuit types list bad request response has a 3xx status code
func (o *CircuitsCircuitTypesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuit types list bad request response has a 4xx status code
func (o *CircuitsCircuitTypesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuit types list bad request response has a 5xx status code
func (o *CircuitsCircuitTypesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuit types list bad request response a status code equal to that given
func (o *CircuitsCircuitTypesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitTypesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /circuits/circuit-types/][%d] circuitsCircuitTypesListBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTypesListBadRequest) String() string {
	return fmt.Sprintf("[GET /circuits/circuit-types/][%d] circuitsCircuitTypesListBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTypesListBadRequest) GetPayload() interface{} {
	return o.Payload
}
