...
func (o *CircuitsCircuitTypesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitTypesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitTypesPartialUpdateBadRequest creates a CircuitsCircuitTypesPartialUpdateBadRequest with default headers values
func NewCircuitsCircuitTypesPartialUpdateBadRequest() *CircuitsCircuitTypesPartialUpdateBadRequest {
	return &CircuitsCircuitTypesPartialUpdateBadRequest{}
}

/*
CircuitsCircuitTypesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitTypesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuit types partial update bad request response has a 2xx status code
func (o *CircuitsCircuitTypesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuit types partial update bad request response has a 3xx status code
func (o *CircuitsCircuitTypesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuit types partial update bad request response has a 4xx status code
func (o *CircuitsCircuitTypesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuit types partial update bad request response has a 5xx status code
func (o *CircuitsCircuitTypesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuit types partial update bad request response a status code equal to that given
func (o *CircuitsCircuitTypesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitTypesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /circuits/circuit-types/{id}/][%d] circuitsCircuitTypesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTypesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /circuits/circuit-types/{id}/][%d] circuitsCircuitTypesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTypesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsCircuitTypesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
