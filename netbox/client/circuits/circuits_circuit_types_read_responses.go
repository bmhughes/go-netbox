...
func (o *CircuitsCircuitTypesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitTypesReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitTypesReadBadRequest creates a CircuitsCircuitTypesReadBadRequest with default headers values
func NewCircuitsCircuitTypesReadBadRequest() *CircuitsCircuitTypesReadBadRequest {
	return &CircuitsCircuitTypesReadBadRequest{}
}

/*
CircuitsCircuitTypesReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitTypesReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuit types read bad request response has a 2xx status code
func (o *CircuitsCircuitTypesReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuit types read bad request response has a 3xx status code
func (o *CircuitsCircuitTypesReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuit types read bad request response has a 4xx status code
func (o *CircuitsCircuitTypesReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuit types read bad request response has a 5xx status code
func (o *CircuitsCircuitTypesReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuit types read bad request response a status code equal to that given
func (o *CircuitsCircuitTypesReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitTypesReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /circuits/circuit-types/{id}/][%d] circuitsCircuitTypesReadBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTypesReadBadRequest) String() string {
	return fmt.Sprintf("[GET /circuits/circuit-types/{id}/][%d] circuitsCircuitTypesReadBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitTypesReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsCircuitTypesReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
