...
func (o *CircuitsCircuitsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitsBulkPartialUpdateBadRequest creates a CircuitsCircuitsBulkPartialUpdateBadRequest with default headers values
func NewCircuitsCircuitsBulkPartialUpdateBadRequest() *CircuitsCircuitsBulkPartialUpdateBadRequest {
	return &CircuitsCircuitsBulkPartialUpdateBadRequest{}
}

/*
CircuitsCircuitsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuits bulk partial update bad request response has a 2xx status code
func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuits bulk partial update bad request response has a 3xx status code
func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuits bulk partial update bad request response has a 4xx status code
func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuits bulk partial update bad request response has a 5xx status code
func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuits bulk partial update bad request response a status code equal to that given
func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /circuits/circuits/][%d] circuitsCircuitsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /circuits/circuits/][%d] circuitsCircuitsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsCircuitsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
