...
func (o *CircuitsCircuitsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitsBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitsBulkUpdateBadRequest creates a CircuitsCircuitsBulkUpdateBadRequest with default headers values
func NewCircuitsCircuitsBulkUpdateBadRequest() *CircuitsCircuitsBulkUpdateBadRequest {
	return &CircuitsCircuitsBulkUpdateBadRequest{}
}

/*
CircuitsCircuitsBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitsBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuits bulk update bad request response has a 2xx status code
func (o *CircuitsCircuitsBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuits bulk update bad request response has a 3xx status code
func (o *CircuitsCircuitsBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuits bulk update bad request response has a 4xx status code
func (o *CircuitsCircuitsBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuits bulk update bad request response has a 5xx status code
func (o *CircuitsCircuitsBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuits bulk update bad request response a status code equal to that given
func (o *CircuitsCircuitsBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitsBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /circuits/circuits/][%d] circuitsCircuitsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitsBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /circuits/circuits/][%d] circuitsCircuitsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitsBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsCircuitsBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
