...
func (o *CircuitsCircuitsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsCircuitsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsCircuitsListBadRequest creates a CircuitsCircuitsListBadRequest with default headers values
func NewCircuitsCircuitsListBadRequest() *CircuitsCircuitsListBadRequest {
	return &CircuitsCircuitsListBadRequest{}
}

/*
CircuitsCircuitsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsCircuitsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits circuits list bad request response has a 2xx status code
func (o *CircuitsCircuitsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits circuits list bad request response has a 3xx status code
func (o *CircuitsCircuitsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits circuits list bad request response has a 4xx status code
func (o *CircuitsCircuitsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits circuits list bad request response has a 5xx status code
func (o *CircuitsCircuitsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits circuits list bad request response a status code equal to that given
func (o *CircuitsCircuitsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsCircuitsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /circuits/circuits/][%d] circuitsCircuitsListBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitsListBadRequest) String() string {
	return fmt.Sprintf("[GET /circuits/circuits/][%d] circuitsCircuitsListBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsCircuitsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsCircuitsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
