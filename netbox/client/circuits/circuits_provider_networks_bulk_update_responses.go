...
func (o *CircuitsProviderNetworksBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsProviderNetworksBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsProviderNetworksBulkUpdateBadRequest creates a CircuitsProviderNetworksBulkUpdateBadRequest with default headers values
func NewCircuitsProviderNetworksBulkUpdateBadRequest() *CircuitsProviderNetworksBulkUpdateBadRequest {
	return &CircuitsProviderNetworksBulkUpdateBadRequest{}
}

/*
CircuitsProviderNetworksBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsProviderNetworksBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits provider networks bulk update bad request response has a 2xx status code
func (o *CircuitsProviderNetworksBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits provider networks bulk update bad request response has a 3xx status code
func (o *CircuitsProviderNetworksBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits provider networks bulk update bad request response has a 4xx status code
func (o *CircuitsProviderNetworksBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits provider networks bulk update bad request response has a 5xx status code
func (o *CircuitsProviderNetworksBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits provider networks bulk update bad request response a status code equal to that given
func (o *CircuitsProviderNetworksBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsProviderNetworksBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /circuits/provider-networks/][%d] circuitsProviderNetworksBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsProviderNetworksBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /circuits/provider-networks/][%d] circuitsProviderNetworksBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsProviderNetworksBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsProviderNetworksBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
