...
func (o *CircuitsProviderNetworksUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsProviderNetworksUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsProviderNetworksUpdateBadRequest creates a CircuitsProviderNetworksUpdateBadRequest with default headers values
func NewCircuitsProviderNetworksUpdateBadRequest() *CircuitsProviderNetworksUpdateBadRequest {
	return &CircuitsProviderNetworksUpdateBadRequest{}
}

/*
CircuitsProviderNetworksUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsProviderNetworksUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits provider networks update bad request response has a 2xx status code
func (o *CircuitsProviderNetworksUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits provider networks update bad request response has a 3xx status code
func (o *CircuitsProviderNetworksUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits provider networks update bad request response has a 4xx status code
func (o *CircuitsProviderNetworksUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits provider networks update bad request response has a 5xx status code
func (o *CircuitsProviderNetworksUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits provider networks update bad request response a status code equal to that given
func (o *CircuitsProviderNetworksUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsProviderNetworksUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /circuits/provider-networks/{id}/][%d] circuitsProviderNetworksUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsProviderNetworksUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /circuits/provider-networks/{id}/][%d] circuitsProviderNetworksUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsProviderNetworksUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *CircuitsProviderNetworksUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
