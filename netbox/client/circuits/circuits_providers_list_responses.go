...
func (o *CircuitsProvidersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewCircuitsProvidersListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCircuitsProvidersListBadRequest creates a CircuitsProvidersListBadRequest with default headers values
func NewCircuitsProvidersListBadRequest() *CircuitsProvidersListBadRequest {
	return &CircuitsProvidersListBadRequest{}
}

/*
CircuitsProvidersListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type CircuitsProvidersListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this circuits providers list bad request response has a 2xx status code
func (o *CircuitsProvidersListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this circuits providers list bad request response has a 3xx status code
func (o *CircuitsProvidersListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this circuits providers list bad request response has a 4xx status code
func (o *CircuitsProvidersListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this circuits providers list bad request response has a 5xx status code
func (o *CircuitsProvidersListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this circuits providers list bad request response a status code equal to that given
func (o *CircuitsProvidersListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *CircuitsProvidersListBadRequest) Error() string {
	return fmt.Sprintf("[GET /circuits/providers/][%d] circuitsProvidersListBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsProvidersListBadRequest) String() string {
	return fmt.Sprintf("[GET /circuits/providers/][%d] circuitsProvidersListBadRequest  %+v", 400, o.Payload)
}

func (o *CircuitsProvidersListBadRequest) GetPayload() interface{} {
	return o.Payload
}
