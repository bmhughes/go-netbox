...
func (o *DcimCableTerminationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimCableTerminationsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimCableTerminationsListBadRequest creates a DcimCableTerminationsListBadRequest with default headers values
func NewDcimCableTerminationsListBadRequest() *DcimCableTerminationsListBadRequest {
	return &DcimCableTerminationsListBadRequest{}
}

/*
DcimCableTerminationsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimCableTerminationsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim cable terminations list bad request response has a 2xx status code
func (o *DcimCableTerminationsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim cable terminations list bad request response has a 3xx status code
func (o *DcimCableTerminationsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim cable terminations list bad request response has a 4xx status code
func (o *DcimCableTerminationsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim cable terminations list bad request response has a 5xx status code
func (o *DcimCableTerminationsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim cable terminations list bad request response a status code equal to that given
func (o *DcimCableTerminationsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimCableTerminationsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/cable-terminations/][%d] dcimCableTerminationsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimCableTerminationsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/cable-terminations/][%d] dcimCableTerminationsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimCableTerminationsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimCableTerminationsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
