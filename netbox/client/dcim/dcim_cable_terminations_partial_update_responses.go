...
func (o *DcimCableTerminationsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimCableTerminationsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimCableTerminationsPartialUpdateBadRequest creates a DcimCableTerminationsPartialUpdateBadRequest with default headers values
func NewDcimCableTerminationsPartialUpdateBadRequest() *DcimCableTerminationsPartialUpdateBadRequest {
	return &DcimCableTerminationsPartialUpdateBadRequest{}
}

/*
DcimCableTerminationsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimCableTerminationsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim cable terminations partial update bad request response has a 2xx status code
func (o *DcimCableTerminationsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim cable terminations partial update bad request response has a 3xx status code
func (o *DcimCableTerminationsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim cable terminations partial update bad request response has a 4xx status code
func (o *DcimCableTerminationsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim cable terminations partial update bad request response has a 5xx status code
func (o *DcimCableTerminationsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim cable terminations partial update bad request response a status code equal to that given
func (o *DcimCableTerminationsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimCableTerminationsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/cable-terminations/{id}/][%d] dcimCableTerminationsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimCableTerminationsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/cable-terminations/{id}/][%d] dcimCableTerminationsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimCableTerminationsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimCableTerminationsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
