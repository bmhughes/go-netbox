...
func (o *DcimCablesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimCablesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimCablesUpdateBadRequest creates a DcimCablesUpdateBadRequest with default headers values
func NewDcimCablesUpdateBadRequest() *DcimCablesUpdateBadRequest {
	return &DcimCablesUpdateBadRequest{}
}

/*
DcimCablesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimCablesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim cables update bad request response has a 2xx status code
func (o *DcimCablesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim cables update bad request response has a 3xx status code
func (o *DcimCablesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim cables update bad request response has a 4xx status code
func (o *DcimCablesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim cables update bad request response has a 5xx status code
func (o *DcimCablesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim cables update bad request response a status code equal to that given
func (o *DcimCablesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimCablesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/cables/{id}/][%d] dcimCablesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimCablesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/cables/{id}/][%d] dcimCablesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimCablesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimCablesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
