...
func (o *DcimConsolePortTemplatesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsolePortTemplatesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsolePortTemplatesBulkUpdateBadRequest creates a DcimConsolePortTemplatesBulkUpdateBadRequest with default headers values
func NewDcimConsolePortTemplatesBulkUpdateBadRequest() *DcimConsolePortTemplatesBulkUpdateBadRequest {
	return &DcimConsolePortTemplatesBulkUpdateBadRequest{}
}

/*
DcimConsolePortTemplatesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsolePortTemplatesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console port templates bulk update bad request response has a 2xx status code
func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console port templates bulk update bad request response has a 3xx status code
func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console port templates bulk update bad request response has a 4xx status code
func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console port templates bulk update bad request response has a 5xx status code
func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console port templates bulk update bad request response a status code equal to that given
func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/console-port-templates/][%d] dcimConsolePortTemplatesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/console-port-templates/][%d] dcimConsolePortTemplatesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsolePortTemplatesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
