...
func (o *DcimConsolePortTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewDcimConsolePortTemplatesCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsolePortTemplatesCreateBadRequest creates a DcimConsolePortTemplatesCreateBadRequest with default headers values
func NewDcimConsolePortTemplatesCreateBadRequest() *DcimConsolePortTemplatesCreateBadRequest {
	return &DcimConsolePortTemplatesCreateBadRequest{}
}

/*
DcimConsolePortTemplatesCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsolePortTemplatesCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console port templates create bad request response has a 2xx status code
func (o *DcimConsolePortTemplatesCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console port templates create bad request response has a 3xx status code
func (o *DcimConsolePortTemplatesCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console port templates create bad request response has a 4xx status code
func (o *DcimConsolePortTemplatesCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console port templates create bad request response has a 5xx status code
func (o *DcimConsolePortTemplatesCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console port templates create bad request response a status code equal to that given
func (o *DcimConsolePortTemplatesCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsolePortTemplatesCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /dcim/console-port-templates/][%d] dcimConsolePortTemplatesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortTemplatesCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /dcim/console-port-templates/][%d] dcimConsolePortTemplatesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortTemplatesCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsolePortTemplatesCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
