...
func (o *DcimConsolePortTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsolePortTemplatesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsolePortTemplatesPartialUpdateBadRequest creates a DcimConsolePortTemplatesPartialUpdateBadRequest with default headers values
func NewDcimConsolePortTemplatesPartialUpdateBadRequest() *DcimConsolePortTemplatesPartialUpdateBadRequest {
	return &DcimConsolePortTemplatesPartialUpdateBadRequest{}
}

/*
DcimConsolePortTemplatesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsolePortTemplatesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console port templates partial update bad request response has a 2xx status code
func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console port templates partial update bad request response has a 3xx status code
func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console port templates partial update bad request response has a 4xx status code
func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console port templates partial update bad request response has a 5xx status code
func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console port templates partial update bad request response a status code equal to that given
func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/console-port-templates/{id}/][%d] dcimConsolePortTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/console-port-templates/{id}/][%d] dcimConsolePortTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsolePortTemplatesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
