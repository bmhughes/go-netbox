...
func (o *DcimConsolePortsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewDcimConsolePortsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsolePortsCreateBadRequest creates a DcimConsolePortsCreateBadRequest with default headers values
func NewDcimConsolePortsCreateBadRequest() *DcimConsolePortsCreateBadRequest {
	return &DcimConsolePortsCreateBadRequest{}
}

/*
DcimConsolePortsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsolePortsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console ports create bad request response has a 2xx status code
func (o *DcimConsolePortsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console ports create bad request response has a 3xx status code
func (o *DcimConsolePortsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console ports create bad request response has a 4xx status code
func (o *DcimConsolePortsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console ports create bad request response has a 5xx status code
func (o *DcimConsolePortsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console ports create bad request response a status code equal to that given
func (o *DcimConsolePortsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsolePortsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /dcim/console-ports/][%d] dcimConsolePortsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /dcim/console-ports/][%d] dcimConsolePortsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsolePortsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
