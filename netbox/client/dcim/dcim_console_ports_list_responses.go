...
func (o *DcimConsolePortsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsolePortsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsolePortsListBadRequest creates a DcimConsolePortsListBadRequest with default headers values
func NewDcimConsolePortsListBadRequest() *DcimConsolePortsListBadRequest {
	return &DcimConsolePortsListBadRequest{}
}

/*
DcimConsolePortsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsolePortsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console ports list bad request response has a 2xx status code
func (o *DcimConsolePortsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console ports list bad request response has a 3xx status code
func (o *DcimConsolePortsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console ports list bad request response has a 4xx status code
func (o *DcimConsolePortsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console ports list bad request response has a 5xx status code
func (o *DcimConsolePortsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console ports list bad request response a status code equal to that given
func (o *DcimConsolePortsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsolePortsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/console-ports/][%d] dcimConsolePortsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/console-ports/][%d] dcimConsolePortsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsolePortsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsolePortsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
