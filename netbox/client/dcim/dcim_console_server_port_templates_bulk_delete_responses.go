...
func (o *DcimConsoleServerPortTemplatesBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimConsoleServerPortTemplatesBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsoleServerPortTemplatesBulkDeleteBadRequest creates a DcimConsoleServerPortTemplatesBulkDeleteBadRequest with default headers values
func NewDcimConsoleServerPortTemplatesBulkDeleteBadRequest() *DcimConsoleServerPortTemplatesBulkDeleteBadRequest {
	return &DcimConsoleServerPortTemplatesBulkDeleteBadRequest{}
}

/*
DcimConsoleServerPortTemplatesBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsoleServerPortTemplatesBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console server port templates bulk delete bad request response has a 2xx status code
func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console server port templates bulk delete bad request response has a 3xx status code
func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console server port templates bulk delete bad request response has a 4xx status code
func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console server port templates bulk delete bad request response has a 5xx status code
func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console server port templates bulk delete bad request response a status code equal to that given
func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/console-server-port-templates/][%d] dcimConsoleServerPortTemplatesBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/console-server-port-templates/][%d] dcimConsoleServerPortTemplatesBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsoleServerPortTemplatesBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
