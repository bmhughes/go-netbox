...
func (o *DcimConsoleServerPortTemplatesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsoleServerPortTemplatesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsoleServerPortTemplatesBulkUpdateBadRequest creates a DcimConsoleServerPortTemplatesBulkUpdateBadRequest with default headers values
func NewDcimConsoleServerPortTemplatesBulkUpdateBadRequest() *DcimConsoleServerPortTemplatesBulkUpdateBadRequest {
	return &DcimConsoleServerPortTemplatesBulkUpdateBadRequest{}
}

/*
DcimConsoleServerPortTemplatesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsoleServerPortTemplatesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console server port templates bulk update bad request response has a 2xx status code
func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console server port templates bulk update bad request response has a 3xx status code
func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console server port templates bulk update bad request response has a 4xx status code
func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console server port templates bulk update bad request response has a 5xx status code
func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console server port templates bulk update bad request response a status code equal to that given
func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/console-server-port-templates/][%d] dcimConsoleServerPortTemplatesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/console-server-port-templates/][%d] dcimConsoleServerPortTemplatesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsoleServerPortTemplatesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
