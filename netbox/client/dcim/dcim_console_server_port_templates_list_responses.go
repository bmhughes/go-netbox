...
func (o *DcimConsoleServerPortTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsoleServerPortTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsoleServerPortTemplatesListBadRequest creates a DcimConsoleServerPortTemplatesListBadRequest with default headers values
func NewDcimConsoleServerPortTemplatesListBadRequest() *DcimConsoleServerPortTemplatesListBadRequest {
	return &DcimConsoleServerPortTemplatesListBadRequest{}
}

/*
DcimConsoleServerPortTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsoleServerPortTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console server port templates list bad request response has a 2xx status code
func (o *DcimConsoleServerPortTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console server port templates list bad request response has a 3xx status code
func (o *DcimConsoleServerPortTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console server port templates list bad request response has a 4xx status code
func (o *DcimConsoleServerPortTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console server port templates list bad request response has a 5xx status code
func (o *DcimConsoleServerPortTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console server port templates list bad request response a status code equal to that given
func (o *DcimConsoleServerPortTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsoleServerPortTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/console-server-port-templates/][%d] dcimConsoleServerPortTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/console-server-port-templates/][%d] dcimConsoleServerPortTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsoleServerPortTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
