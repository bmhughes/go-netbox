...
func (o *DcimConsoleServerPortTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsoleServerPortTemplatesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsoleServerPortTemplatesPartialUpdateBadRequest creates a DcimConsoleServerPortTemplatesPartialUpdateBadRequest with default headers values
func NewDcimConsoleServerPortTemplatesPartialUpdateBadRequest() *DcimConsoleServerPortTemplatesPartialUpdateBadRequest {
	return &DcimConsoleServerPortTemplatesPartialUpdateBadRequest{}
}

/*
DcimConsoleServerPortTemplatesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsoleServerPortTemplatesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console server port templates partial update bad request response has a 2xx status code
func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console server port templates partial update bad request response has a 3xx status code
func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console server port templates partial update bad request response has a 4xx status code
func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console server port templates partial update bad request response has a 5xx status code
func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console server port templates partial update bad request response a status code equal to that given
func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/console-server-port-templates/{id}/][%d] dcimConsoleServerPortTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/console-server-port-templates/{id}/][%d] dcimConsoleServerPortTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsoleServerPortTemplatesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
