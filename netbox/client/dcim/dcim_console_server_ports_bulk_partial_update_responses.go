...
func (o *DcimConsoleServerPortsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsoleServerPortsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsoleServerPortsBulkPartialUpdateBadRequest creates a DcimConsoleServerPortsBulkPartialUpdateBadRequest with default headers values
func NewDcimConsoleServerPortsBulkPartialUpdateBadRequest() *DcimConsoleServerPortsBulkPartialUpdateBadRequest {
	return &DcimConsoleServerPortsBulkPartialUpdateBadRequest{}
}

/*
DcimConsoleServerPortsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsoleServerPortsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console server ports bulk partial update bad request response has a 2xx status code
func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console server ports bulk partial update bad request response has a 3xx status code
func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console server ports bulk partial update bad request response has a 4xx status code
func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console server ports bulk partial update bad request response has a 5xx status code
func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console server ports bulk partial update bad request response a status code equal to that given
func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/console-server-ports/][%d] dcimConsoleServerPortsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/console-server-ports/][%d] dcimConsoleServerPortsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsoleServerPortsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
