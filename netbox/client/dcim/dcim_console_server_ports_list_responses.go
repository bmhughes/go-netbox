...
func (o *DcimConsoleServerPortsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsoleServerPortsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsoleServerPortsListBadRequest creates a DcimConsoleServerPortsListBadRequest with default headers values
func NewDcimConsoleServerPortsListBadRequest() *DcimConsoleServerPortsListBadRequest {
	return &DcimConsoleServerPortsListBadRequest{}
}

/*
DcimConsoleServerPortsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsoleServerPortsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console server ports list bad request response has a 2xx status code
func (o *DcimConsoleServerPortsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console server ports list bad request response has a 3xx status code
func (o *DcimConsoleServerPortsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console server ports list bad request response has a 4xx status code
func (o *DcimConsoleServerPortsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console server ports list bad request response has a 5xx status code
func (o *DcimConsoleServerPortsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console server ports list bad request response a status code equal to that given
func (o *DcimConsoleServerPortsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsoleServerPortsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/console-server-ports/][%d] dcimConsoleServerPortsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/console-server-ports/][%d] dcimConsoleServerPortsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsoleServerPortsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
