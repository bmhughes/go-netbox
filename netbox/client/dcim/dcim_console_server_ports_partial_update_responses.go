...
func (o *DcimConsoleServerPortsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsoleServerPortsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsoleServerPortsPartialUpdateBadRequest creates a DcimConsoleServerPortsPartialUpdateBadRequest with default headers values
func NewDcimConsoleServerPortsPartialUpdateBadRequest() *DcimConsoleServerPortsPartialUpdateBadRequest {
	return &DcimConsoleServerPortsPartialUpdateBadRequest{}
}

/*
DcimConsoleServerPortsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsoleServerPortsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console server ports partial update bad request response has a 2xx status code
func (o *DcimConsoleServerPortsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console server ports partial update bad request response has a 3xx status code
func (o *DcimConsoleServerPortsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console server ports partial update bad request response has a 4xx status code
func (o *DcimConsoleServerPortsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console server ports partial update bad request response has a 5xx status code
func (o *DcimConsoleServerPortsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console server ports partial update bad request response a status code equal to that given
func (o *DcimConsoleServerPortsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsoleServerPortsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/console-server-ports/{id}/][%d] dcimConsoleServerPortsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/console-server-ports/{id}/][%d] dcimConsoleServerPortsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsoleServerPortsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
