...
func (o *DcimConsoleServerPortsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimConsoleServerPortsUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimConsoleServerPortsUpdateBadRequest creates a DcimConsoleServerPortsUpdateBadRequest with default headers values
func NewDcimConsoleServerPortsUpdateBadRequest() *DcimConsoleServerPortsUpdateBadRequest {
	return &DcimConsoleServerPortsUpdateBadRequest{}
}

/*
DcimConsoleServerPortsUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimConsoleServerPortsUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim console server ports update bad request response has a 2xx status code
func (o *DcimConsoleServerPortsUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim console server ports update bad request response has a 3xx status code
func (o *DcimConsoleServerPortsUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim console server ports update bad request response has a 4xx status code
func (o *DcimConsoleServerPortsUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim console server ports update bad request response has a 5xx status code
func (o *DcimConsoleServerPortsUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim console server ports update bad request response a status code equal to that given
func (o *DcimConsoleServerPortsUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimConsoleServerPortsUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/console-server-ports/{id}/][%d] dcimConsoleServerPortsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortsUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/console-server-ports/{id}/][%d] dcimConsoleServerPortsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimConsoleServerPortsUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimConsoleServerPortsUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
