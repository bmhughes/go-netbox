...
func (o *DcimDeviceBayTemplatesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceBayTemplatesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceBayTemplatesBulkUpdateBadRequest creates a DcimDeviceBayTemplatesBulkUpdateBadRequest with default headers values
func NewDcimDeviceBayTemplatesBulkUpdateBadRequest() *DcimDeviceBayTemplatesBulkUpdateBadRequest {
	return &DcimDeviceBayTemplatesBulkUpdateBadRequest{}
}

/*
DcimDeviceBayTemplatesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceBayTemplatesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device bay templates bulk update bad request response has a 2xx status code
func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device bay templates bulk update bad request response has a 3xx status code
func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device bay templates bulk update bad request response has a 4xx status code
func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device bay templates bulk update bad request response has a 5xx status code
func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device bay templates bulk update bad request response a status code equal to that given
func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/device-bay-templates/][%d] dcimDeviceBayTemplatesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/device-bay-templates/][%d] dcimDeviceBayTemplatesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceBayTemplatesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
