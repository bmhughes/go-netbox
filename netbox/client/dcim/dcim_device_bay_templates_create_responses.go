...
func (o *DcimDeviceBayTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceBayTemplatesCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceBayTemplatesCreateBadRequest creates a DcimDeviceBayTemplatesCreateBadRequest with default headers values
func NewDcimDeviceBayTemplatesCreateBadRequest() *DcimDeviceBayTemplatesCreateBadRequest {
	return &DcimDeviceBayTemplatesCreateBadRequest{}
}

/*
DcimDeviceBayTemplatesCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceBayTemplatesCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device bay templates create bad request response has a 2xx status code
func (o *DcimDeviceBayTemplatesCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device bay templates create bad request response has a 3xx status code
func (o *DcimDeviceBayTemplatesCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device bay templates create bad request response has a 4xx status code
func (o *DcimDeviceBayTemplatesCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device bay templates create bad request response has a 5xx status code
func (o *DcimDeviceBayTemplatesCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device bay templates create bad request response a status code equal to that given
func (o *DcimDeviceBayTemplatesCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceBayTemplatesCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /dcim/device-bay-templates/][%d] dcimDeviceBayTemplatesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBayTemplatesCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /dcim/device-bay-templates/][%d] dcimDeviceBayTemplatesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBayTemplatesCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceBayTemplatesCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
