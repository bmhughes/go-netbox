...
func (o *DcimDeviceBayTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceBayTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceBayTemplatesListBadRequest creates a DcimDeviceBayTemplatesListBadRequest with default headers values
func NewDcimDeviceBayTemplatesListBadRequest() *DcimDeviceBayTemplatesListBadRequest {
	return &DcimDeviceBayTemplatesListBadRequest{}
}

/*
DcimDeviceBayTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceBayTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device bay templates list bad request response has a 2xx status code
func (o *DcimDeviceBayTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device bay templates list bad request response has a 3xx status code
func (o *DcimDeviceBayTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device bay templates list bad request response has a 4xx status code
func (o *DcimDeviceBayTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device bay templates list bad request response has a 5xx status code
func (o *DcimDeviceBayTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device bay templates list bad request response a status code equal to that given
func (o *DcimDeviceBayTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceBayTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/device-bay-templates/][%d] dcimDeviceBayTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBayTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/device-bay-templates/][%d] dcimDeviceBayTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBayTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceBayTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
