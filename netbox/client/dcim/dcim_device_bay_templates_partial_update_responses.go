...
func (o *DcimDeviceBayTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceBayTemplatesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceBayTemplatesPartialUpdateBadRequest creates a DcimDeviceBayTemplatesPartialUpdateBadRequest with default headers values
func NewDcimDeviceBayTemplatesPartialUpdateBadRequest() *DcimDeviceBayTemplatesPartialUpdateBadRequest {
	return &DcimDeviceBayTemplatesPartialUpdateBadRequest{}
}

/*
DcimDeviceBayTemplatesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceBayTemplatesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device bay templates partial update bad request response has a 2xx status code
func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device bay templates partial update bad request response has a 3xx status code
func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device bay templates partial update bad request response has a 4xx status code
func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device bay templates partial update bad request response has a 5xx status code
func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device bay templates partial update bad request response a status code equal to that given
func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/device-bay-templates/{id}/][%d] dcimDeviceBayTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/device-bay-templates/{id}/][%d] dcimDeviceBayTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceBayTemplatesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
