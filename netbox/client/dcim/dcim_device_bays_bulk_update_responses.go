...
func (o *DcimDeviceBaysBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceBaysBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceBaysBulkUpdateBadRequest creates a DcimDeviceBaysBulkUpdateBadRequest with default headers values
func NewDcimDeviceBaysBulkUpdateBadRequest() *DcimDeviceBaysBulkUpdateBadRequest {
	return &DcimDeviceBaysBulkUpdateBadRequest{}
}

/*
DcimDeviceBaysBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceBaysBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device bays bulk update bad request response has a 2xx status code
func (o *DcimDeviceBaysBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device bays bulk update bad request response has a 3xx status code
func (o *DcimDeviceBaysBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device bays bulk update bad request response has a 4xx status code
func (o *DcimDeviceBaysBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device bays bulk update bad request response has a 5xx status code
func (o *DcimDeviceBaysBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device bays bulk update bad request response a status code equal to that given
func (o *DcimDeviceBaysBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceBaysBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/device-bays/][%d] dcimDeviceBaysBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBaysBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/device-bays/][%d] dcimDeviceBaysBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBaysBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceBaysBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
