...
func (o *DcimDeviceBaysListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceBaysListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceBaysListBadRequest creates a DcimDeviceBaysListBadRequest with default headers values
func NewDcimDeviceBaysListBadRequest() *DcimDeviceBaysListBadRequest {
	return &DcimDeviceBaysListBadRequest{}
}

/*
DcimDeviceBaysListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceBaysListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device bays list bad request response has a 2xx status code
func (o *DcimDeviceBaysListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device bays list bad request response has a 3xx status code
func (o *DcimDeviceBaysListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device bays list bad request response has a 4xx status code
func (o *DcimDeviceBaysListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device bays list bad request response has a 5xx status code
func (o *DcimDeviceBaysListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device bays list bad request response a status code equal to that given
func (o *DcimDeviceBaysListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceBaysListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/device-bays/][%d] dcimDeviceBaysListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBaysListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/device-bays/][%d] dcimDeviceBaysListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBaysListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceBaysListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
