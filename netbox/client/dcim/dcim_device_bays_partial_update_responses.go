...
func (o *DcimDeviceBaysPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceBaysPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceBaysPartialUpdateBadRequest creates a DcimDeviceBaysPartialUpdateBadRequest with default headers values
func NewDcimDeviceBaysPartialUpdateBadRequest() *DcimDeviceBaysPartialUpdateBadRequest {
	return &DcimDeviceBaysPartialUpdateBadRequest{}
}

/*
DcimDeviceBaysPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceBaysPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device bays partial update bad request response has a 2xx status code
func (o *DcimDeviceBaysPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device bays partial update bad request response has a 3xx status code
func (o *DcimDeviceBaysPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device bays partial update bad request response has a 4xx status code
func (o *DcimDeviceBaysPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device bays partial update bad request response has a 5xx status code
func (o *DcimDeviceBaysPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device bays partial update bad request response a status code equal to that given
func (o *DcimDeviceBaysPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceBaysPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/device-bays/{id}/][%d] dcimDeviceBaysPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBaysPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/device-bays/{id}/][%d] dcimDeviceBaysPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceBaysPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceBaysPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
