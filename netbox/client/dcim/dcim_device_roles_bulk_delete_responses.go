...
func (o *DcimDeviceRolesBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceRolesBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceRolesBulkDeleteBadRequest creates a DcimDeviceRolesBulkDeleteBadRequest with default headers values
func NewDcimDeviceRolesBulkDeleteBadRequest() *DcimDeviceRolesBulkDeleteBadRequest {
	return &DcimDeviceRolesBulkDeleteBadRequest{}
}

/*
DcimDeviceRolesBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceRolesBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device roles bulk delete bad request response has a 2xx status code
func (o *DcimDeviceRolesBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device roles bulk delete bad request response has a 3xx status code
func (o *DcimDeviceRolesBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device roles bulk delete bad request response has a 4xx status code
func (o *DcimDeviceRolesBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device roles bulk delete bad request response has a 5xx status code
func (o *DcimDeviceRolesBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device roles bulk delete bad request response a status code equal to that given
func (o *DcimDeviceRolesBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceRolesBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/device-roles/][%d] dcimDeviceRolesBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/device-roles/][%d] dcimDeviceRolesBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceRolesBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
