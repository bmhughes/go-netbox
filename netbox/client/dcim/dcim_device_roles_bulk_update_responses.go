...
func (o *DcimDeviceRolesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceRolesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceRolesBulkUpdateBadRequest creates a DcimDeviceRolesBulkUpdateBadRequest with default headers values
func NewDcimDeviceRolesBulkUpdateBadRequest() *DcimDeviceRolesBulkUpdateBadRequest {
	return &DcimDeviceRolesBulkUpdateBadRequest{}
}

/*
DcimDeviceRolesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceRolesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device roles bulk update bad request response has a 2xx status code
func (o *DcimDeviceRolesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device roles bulk update bad request response has a 3xx status code
func (o *DcimDeviceRolesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device roles bulk update bad request response has a 4xx status code
func (o *DcimDeviceRolesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device roles bulk update bad request response has a 5xx status code
func (o *DcimDeviceRolesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device roles bulk update bad request response a status code equal to that given
func (o *DcimDeviceRolesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceRolesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/device-roles/][%d] dcimDeviceRolesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/device-roles/][%d] dcimDeviceRolesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceRolesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
