...
func (o *DcimDeviceRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceRolesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceRolesListBadRequest creates a DcimDeviceRolesListBadRequest with default headers values
func NewDcimDeviceRolesListBadRequest() *DcimDeviceRolesListBadRequest {
	return &DcimDeviceRolesListBadRequest{}
}

/*
DcimDeviceRolesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceRolesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device roles list bad request response has a 2xx status code
func (o *DcimDeviceRolesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device roles list bad request response has a 3xx status code
func (o *DcimDeviceRolesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device roles list bad request response has a 4xx status code
func (o *DcimDeviceRolesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device roles list bad request response has a 5xx status code
func (o *DcimDeviceRolesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device roles list bad request response a status code equal to that given
func (o *DcimDeviceRolesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceRolesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/device-roles/][%d] dcimDeviceRolesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/device-roles/][%d] dcimDeviceRolesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesListBadRequest) GetPayload() interface{} {
	return o.Payload
}
