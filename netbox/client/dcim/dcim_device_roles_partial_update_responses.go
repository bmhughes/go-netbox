...
func (o *DcimDeviceRolesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceRolesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceRolesPartialUpdateBadRequest creates a DcimDeviceRolesPartialUpdateBadRequest with default headers values
func NewDcimDeviceRolesPartialUpdateBadRequest() *DcimDeviceRolesPartialUpdateBadRequest {
	return &DcimDeviceRolesPartialUpdateBadRequest{}
}

/*
DcimDeviceRolesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceRolesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device roles partial update bad request response has a 2xx status code
func (o *DcimDeviceRolesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device roles partial update bad request response has a 3xx status code
func (o *DcimDeviceRolesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device roles partial update bad request response has a 4xx status code
func (o *DcimDeviceRolesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device roles partial update bad request response has a 5xx status code
func (o *DcimDeviceRolesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device roles partial update bad request response a status code equal to that given
func (o *DcimDeviceRolesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceRolesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/device-roles/{id}/][%d] dcimDeviceRolesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/device-roles/{id}/][%d] dcimDeviceRolesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
