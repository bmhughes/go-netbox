...
func (o *DcimDeviceRolesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceRolesReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceRolesReadBadRequest creates a DcimDeviceRolesReadBadRequest with default headers values
func NewDcimDeviceRolesReadBadRequest() *DcimDeviceRolesReadBadRequest {
	return &DcimDeviceRolesReadBadRequest{}
}

/*
DcimDeviceRolesReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceRolesReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device roles read bad request response has a 2xx status code
func (o *DcimDeviceRolesReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device roles read bad request response has a 3xx status code
func (o *DcimDeviceRolesReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device roles read bad request response has a 4xx status code
func (o *DcimDeviceRolesReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device roles read bad request response has a 5xx status code
func (o *DcimDeviceRolesReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device roles read bad request response a status code equal to that given
func (o *DcimDeviceRolesReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceRolesReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/device-roles/{id}/][%d] dcimDeviceRolesReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/device-roles/{id}/][%d] dcimDeviceRolesReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceRolesReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
