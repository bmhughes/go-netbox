...
func (o *DcimDeviceRolesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceRolesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceRolesUpdateBadRequest creates a DcimDeviceRolesUpdateBadRequest with default headers values
func NewDcimDeviceRolesUpdateBadRequest() *DcimDeviceRolesUpdateBadRequest {
	return &DcimDeviceRolesUpdateBadRequest{}
}

/*
DcimDeviceRolesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceRolesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device roles update bad request response has a 2xx status code
func (o *DcimDeviceRolesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device roles update bad request response has a 3xx status code
func (o *DcimDeviceRolesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device roles update bad request response has a 4xx status code
func (o *DcimDeviceRolesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device roles update bad request response has a 5xx status code
func (o *DcimDeviceRolesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device roles update bad request response a status code equal to that given
func (o *DcimDeviceRolesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceRolesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/device-roles/{id}/][%d] dcimDeviceRolesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/device-roles/{id}/][%d] dcimDeviceRolesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceRolesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceRolesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
