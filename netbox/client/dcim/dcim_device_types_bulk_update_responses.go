...
func (o *DcimDeviceTypesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceTypesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceTypesBulkUpdateBadRequest creates a DcimDeviceTypesBulkUpdateBadRequest with default headers values
func NewDcimDeviceTypesBulkUpdateBadRequest() *DcimDeviceTypesBulkUpdateBadRequest {
	return &DcimDeviceTypesBulkUpdateBadRequest{}
}

/*
DcimDeviceTypesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceTypesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device types bulk update bad request response has a 2xx status code
func (o *DcimDeviceTypesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device types bulk update bad request response has a 3xx status code
func (o *DcimDeviceTypesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device types bulk update bad request response has a 4xx status code
func (o *DcimDeviceTypesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device types bulk update bad request response has a 5xx status code
func (o *DcimDeviceTypesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device types bulk update bad request response a status code equal to that given
func (o *DcimDeviceTypesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceTypesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/device-types/][%d] dcimDeviceTypesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceTypesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/device-types/][%d] dcimDeviceTypesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceTypesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceTypesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
