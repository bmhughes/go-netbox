...
func (o *DcimDeviceTypesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimDeviceTypesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimDeviceTypesPartialUpdateBadRequest creates a DcimDeviceTypesPartialUpdateBadRequest with default headers values
func NewDcimDeviceTypesPartialUpdateBadRequest() *DcimDeviceTypesPartialUpdateBadRequest {
	return &DcimDeviceTypesPartialUpdateBadRequest{}
}

/*
DcimDeviceTypesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimDeviceTypesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim device types partial update bad request response has a 2xx status code
func (o *DcimDeviceTypesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim device types partial update bad request response has a 3xx status code
func (o *DcimDeviceTypesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim device types partial update bad request response has a 4xx status code
func (o *DcimDeviceTypesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim device types partial update bad request response has a 5xx status code
func (o *DcimDeviceTypesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim device types partial update bad request response a status code equal to that given
func (o *DcimDeviceTypesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimDeviceTypesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/device-types/{id}/][%d] dcimDeviceTypesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceTypesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/device-types/{id}/][%d] dcimDeviceTypesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimDeviceTypesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimDeviceTypesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
