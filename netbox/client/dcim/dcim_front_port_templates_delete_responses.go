...
func (o *DcimFrontPortTemplatesDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimFrontPortTemplatesDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimFrontPortTemplatesDeleteBadRequest creates a DcimFrontPortTemplatesDeleteBadRequest with default headers values
func NewDcimFrontPortTemplatesDeleteBadRequest() *DcimFrontPortTemplatesDeleteBadRequest {
	return &DcimFrontPortTemplatesDeleteBadRequest{}
}

/*
DcimFrontPortTemplatesDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimFrontPortTemplatesDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim front port templates delete bad request response has a 2xx status code
func (o *DcimFrontPortTemplatesDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim front port templates delete bad request response has a 3xx status code
func (o *DcimFrontPortTemplatesDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim front port templates delete bad request response has a 4xx status code
func (o *DcimFrontPortTemplatesDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim front port templates delete bad request response has a 5xx status code
func (o *DcimFrontPortTemplatesDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim front port templates delete bad request response a status code equal to that given
func (o *DcimFrontPortTemplatesDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimFrontPortTemplatesDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/front-port-templates/{id}/][%d] dcimFrontPortTemplatesDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimFrontPortTemplatesDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/front-port-templates/{id}/][%d] dcimFrontPortTemplatesDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimFrontPortTemplatesDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}
