...
func (o *DcimFrontPortsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimFrontPortsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimFrontPortsPartialUpdateBadRequest creates a DcimFrontPortsPartialUpdateBadRequest with default headers values
func NewDcimFrontPortsPartialUpdateBadRequest() *DcimFrontPortsPartialUpdateBadRequest {
	return &DcimFrontPortsPartialUpdateBadRequest{}
}

/*
DcimFrontPortsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimFrontPortsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim front ports partial update bad request response has a 2xx status code
func (o *DcimFrontPortsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim front ports partial update bad request response has a 3xx status code
func (o *DcimFrontPortsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim front ports partial update bad request response has a 4xx status code
func (o *DcimFrontPortsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim front ports partial update bad request response has a 5xx status code
func (o *DcimFrontPortsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim front ports partial update bad request response a status code equal to that given
func (o *DcimFrontPortsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimFrontPortsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/front-ports/{id}/][%d] dcimFrontPortsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimFrontPortsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/front-ports/{id}/][%d] dcimFrontPortsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimFrontPortsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimFrontPortsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
