...
func (o *DcimFrontPortsPathsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimFrontPortsPathsBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimFrontPortsPathsBadRequest creates a DcimFrontPortsPathsBadRequest with default headers values
func NewDcimFrontPortsPathsBadRequest() *DcimFrontPortsPathsBadRequest {
	return &DcimFrontPortsPathsBadRequest{}
}

/*
DcimFrontPortsPathsBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimFrontPortsPathsBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim front ports paths bad request response has a 2xx status code
func (o *DcimFrontPortsPathsBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim front ports paths bad request response has a 3xx status code
func (o *DcimFrontPortsPathsBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim front ports paths bad request response has a 4xx status code
func (o *DcimFrontPortsPathsBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim front ports paths bad request response has a 5xx status code
func (o *DcimFrontPortsPathsBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim front ports paths bad request response a status code equal to that given
func (o *DcimFrontPortsPathsBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimFrontPortsPathsBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/front-ports/{id}/paths/][%d] dcimFrontPortsPathsBadRequest  %+v", 400, o.Payload)
}

func (o *DcimFrontPortsPathsBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/front-ports/{id}/paths/][%d] dcimFrontPortsPathsBadRequest  %+v", 400, o.Payload)
}

func (o *DcimFrontPortsPathsBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimFrontPortsPathsBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
