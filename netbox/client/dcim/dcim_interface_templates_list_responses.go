...
func (o *DcimInterfaceTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimInterfaceTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimInterfaceTemplatesListBadRequest creates a DcimInterfaceTemplatesListBadRequest with default headers values
func NewDcimInterfaceTemplatesListBadRequest() *DcimInterfaceTemplatesListBadRequest {
	return &DcimInterfaceTemplatesListBadRequest{}
}

/*
DcimInterfaceTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimInterfaceTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim interface templates list bad request response has a 2xx status code
func (o *DcimInterfaceTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim interface templates list bad request response has a 3xx status code
func (o *DcimInterfaceTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim interface templates list bad request response has a 4xx status code
func (o *DcimInterfaceTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim interface templates list bad request response has a 5xx status code
func (o *DcimInterfaceTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim interface templates list bad request response a status code equal to that given
func (o *DcimInterfaceTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimInterfaceTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/interface-templates/][%d] dcimInterfaceTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInterfaceTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/interface-templates/][%d] dcimInterfaceTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInterfaceTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimInterfaceTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
