...
func (o *DcimInterfaceTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimInterfaceTemplatesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimInterfaceTemplatesUpdateBadRequest creates a DcimInterfaceTemplatesUpdateBadRequest with default headers values
func NewDcimInterfaceTemplatesUpdateBadRequest() *DcimInterfaceTemplatesUpdateBadRequest {
	return &DcimInterfaceTemplatesUpdateBadRequest{}
}

/*
DcimInterfaceTemplatesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimInterfaceTemplatesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim interface templates update bad request response has a 2xx status code
func (o *DcimInterfaceTemplatesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim interface templates update bad request response has a 3xx status code
func (o *DcimInterfaceTemplatesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim interface templates update bad request response has a 4xx status code
func (o *DcimInterfaceTemplatesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim interface templates update bad request response has a 5xx status code
func (o *DcimInterfaceTemplatesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim interface templates update bad request response a status code equal to that given
func (o *DcimInterfaceTemplatesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimInterfaceTemplatesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/interface-templates/{id}/][%d] dcimInterfaceTemplatesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInterfaceTemplatesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/interface-templates/{id}/][%d] dcimInterfaceTemplatesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInterfaceTemplatesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimInterfaceTemplatesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
