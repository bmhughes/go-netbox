...
func (o *DcimInventoryItemTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimInventoryItemTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimInventoryItemTemplatesListBadRequest creates a DcimInventoryItemTemplatesListBadRequest with default headers values
func NewDcimInventoryItemTemplatesListBadRequest() *DcimInventoryItemTemplatesListBadRequest {
	return &DcimInventoryItemTemplatesListBadRequest{}
}

/*
DcimInventoryItemTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimInventoryItemTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim inventory item templates list bad request response has a 2xx status code
func (o *DcimInventoryItemTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim inventory item templates list bad request response has a 3xx status code
func (o *DcimInventoryItemTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim inventory item templates list bad request response has a 4xx status code
func (o *DcimInventoryItemTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim inventory item templates list bad request response has a 5xx status code
func (o *DcimInventoryItemTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim inventory item templates list bad request response a status code equal to that given
func (o *DcimInventoryItemTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimInventoryItemTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/inventory-item-templates/][%d] dcimInventoryItemTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/inventory-item-templates/][%d] dcimInventoryItemTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimInventoryItemTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
