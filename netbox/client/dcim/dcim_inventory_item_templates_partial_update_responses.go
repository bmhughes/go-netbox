...
func (o *DcimInventoryItemTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimInventoryItemTemplatesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimInventoryItemTemplatesPartialUpdateBadRequest creates a DcimInventoryItemTemplatesPartialUpdateBadRequest with default headers values
func NewDcimInventoryItemTemplatesPartialUpdateBadRequest() *DcimInventoryItemTemplatesPartialUpdateBadRequest {
	return &DcimInventoryItemTemplatesPartialUpdateBadRequest{}
}

/*
DcimInventoryItemTemplatesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimInventoryItemTemplatesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim inventory item templates partial update bad request response has a 2xx status code
func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim inventory item templates partial update bad request response has a 3xx status code
func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim inventory item templates partial update bad request response has a 4xx status code
func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim inventory item templates partial update bad request response has a 5xx status code
func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim inventory item templates partial update bad request response a status code equal to that given
func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/inventory-item-templates/{id}/][%d] dcimInventoryItemTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/inventory-item-templates/{id}/][%d] dcimInventoryItemTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimInventoryItemTemplatesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
