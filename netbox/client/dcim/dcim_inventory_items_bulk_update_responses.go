...
func (o *DcimInventoryItemsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimInventoryItemsBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimInventoryItemsBulkUpdateBadRequest creates a DcimInventoryItemsBulkUpdateBadRequest with default headers values
func NewDcimInventoryItemsBulkUpdateBadRequest() *DcimInventoryItemsBulkUpdateBadRequest {
	return &DcimInventoryItemsBulkUpdateBadRequest{}
}

/*
DcimInventoryItemsBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimInventoryItemsBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim inventory items bulk update bad request response has a 2xx status code
func (o *DcimInventoryItemsBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim inventory items bulk update bad request response has a 3xx status code
func (o *DcimInventoryItemsBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim inventory items bulk update bad request response has a 4xx status code
func (o *DcimInventoryItemsBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim inventory items bulk update bad request response has a 5xx status code
func (o *DcimInventoryItemsBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim inventory items bulk update bad request response a status code equal to that given
func (o *DcimInventoryItemsBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimInventoryItemsBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/inventory-items/][%d] dcimInventoryItemsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemsBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/inventory-items/][%d] dcimInventoryItemsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemsBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimInventoryItemsBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
