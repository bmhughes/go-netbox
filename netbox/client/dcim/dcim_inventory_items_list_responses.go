...
func (o *DcimInventoryItemsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimInventoryItemsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimInventoryItemsListBadRequest creates a DcimInventoryItemsListBadRequest with default headers values
func NewDcimInventoryItemsListBadRequest() *DcimInventoryItemsListBadRequest {
	return &DcimInventoryItemsListBadRequest{}
}

/*
DcimInventoryItemsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimInventoryItemsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim inventory items list bad request response has a 2xx status code
func (o *DcimInventoryItemsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim inventory items list bad request response has a 3xx status code
func (o *DcimInventoryItemsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim inventory items list bad request response has a 4xx status code
func (o *DcimInventoryItemsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim inventory items list bad request response has a 5xx status code
func (o *DcimInventoryItemsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim inventory items list bad request response a status code equal to that given
func (o *DcimInventoryItemsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimInventoryItemsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/inventory-items/][%d] dcimInventoryItemsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/inventory-items/][%d] dcimInventoryItemsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimInventoryItemsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
