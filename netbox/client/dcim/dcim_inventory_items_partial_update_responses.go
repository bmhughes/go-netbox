...
func (o *DcimInventoryItemsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimInventoryItemsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimInventoryItemsPartialUpdateBadRequest creates a DcimInventoryItemsPartialUpdateBadRequest with default headers values
func NewDcimInventoryItemsPartialUpdateBadRequest() *DcimInventoryItemsPartialUpdateBadRequest {
	return &DcimInventoryItemsPartialUpdateBadRequest{}
}

/*
DcimInventoryItemsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimInventoryItemsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim inventory items partial update bad request response has a 2xx status code
func (o *DcimInventoryItemsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim inventory items partial update bad request response has a 3xx status code
func (o *DcimInventoryItemsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim inventory items partial update bad request response has a 4xx status code
func (o *DcimInventoryItemsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim inventory items partial update bad request response has a 5xx status code
func (o *DcimInventoryItemsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim inventory items partial update bad request response a status code equal to that given
func (o *DcimInventoryItemsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimInventoryItemsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/inventory-items/{id}/][%d] dcimInventoryItemsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/inventory-items/{id}/][%d] dcimInventoryItemsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimInventoryItemsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimInventoryItemsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
