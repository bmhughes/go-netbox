...
func (o *DcimLocationsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewDcimLocationsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimLocationsCreateBadRequest creates a DcimLocationsCreateBadRequest with default headers values
func NewDcimLocationsCreateBadRequest() *DcimLocationsCreateBadRequest {
	return &DcimLocationsCreateBadRequest{}
}

/*
DcimLocationsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimLocationsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim locations create bad request response has a 2xx status code
func (o *DcimLocationsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim locations create bad request response has a 3xx status code
func (o *DcimLocationsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim locations create bad request response has a 4xx status code
func (o *DcimLocationsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim locations create bad request response has a 5xx status code
func (o *DcimLocationsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim locations create bad request response a status code equal to that given
func (o *DcimLocationsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimLocationsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /dcim/locations/][%d] dcimLocationsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimLocationsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /dcim/locations/][%d] dcimLocationsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimLocationsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimLocationsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
