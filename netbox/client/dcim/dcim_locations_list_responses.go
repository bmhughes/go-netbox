...
func (o *DcimLocationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimLocationsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimLocationsListBadRequest creates a DcimLocationsListBadRequest with default headers values
func NewDcimLocationsListBadRequest() *DcimLocationsListBadRequest {
	return &DcimLocationsListBadRequest{}
}

/*
DcimLocationsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimLocationsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim locations list bad request response has a 2xx status code
func (o *DcimLocationsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim locations list bad request response has a 3xx status code
func (o *DcimLocationsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim locations list bad request response has a 4xx status code
func (o *DcimLocationsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim locations list bad request response has a 5xx status code
func (o *DcimLocationsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim locations list bad request response a status code equal to that given
func (o *DcimLocationsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimLocationsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/locations/][%d] dcimLocationsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimLocationsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/locations/][%d] dcimLocationsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimLocationsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimLocationsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
