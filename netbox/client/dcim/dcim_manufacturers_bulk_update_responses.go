...
func (o *DcimManufacturersBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimManufacturersBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimManufacturersBulkUpdateBadRequest creates a DcimManufacturersBulkUpdateBadRequest with default headers values
func NewDcimManufacturersBulkUpdateBadRequest() *DcimManufacturersBulkUpdateBadRequest {
	return &DcimManufacturersBulkUpdateBadRequest{}
}

/*
DcimManufacturersBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimManufacturersBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim manufacturers bulk update bad request response has a 2xx status code
func (o *DcimManufacturersBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim manufacturers bulk update bad request response has a 3xx status code
func (o *DcimManufacturersBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim manufacturers bulk update bad request response has a 4xx status code
func (o *DcimManufacturersBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim manufacturers bulk update bad request response has a 5xx status code
func (o *DcimManufacturersBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim manufacturers bulk update bad request response a status code equal to that given
func (o *DcimManufacturersBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimManufacturersBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/manufacturers/][%d] dcimManufacturersBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimManufacturersBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/manufacturers/][%d] dcimManufacturersBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimManufacturersBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimManufacturersBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
