...
func (o *DcimManufacturersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimManufacturersListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimManufacturersListBadRequest creates a DcimManufacturersListBadRequest with default headers values
func NewDcimManufacturersListBadRequest() *DcimManufacturersListBadRequest {
	return &DcimManufacturersListBadRequest{}
}

/*
DcimManufacturersListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimManufacturersListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim manufacturers list bad request response has a 2xx status code
func (o *DcimManufacturersListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim manufacturers list bad request response has a 3xx status code
func (o *DcimManufacturersListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim manufacturers list bad request response has a 4xx status code
func (o *DcimManufacturersListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim manufacturers list bad request response has a 5xx status code
func (o *DcimManufacturersListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim manufacturers list bad request response a status code equal to that given
func (o *DcimManufacturersListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimManufacturersListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/manufacturers/][%d] dcimManufacturersListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimManufacturersListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/manufacturers/][%d] dcimManufacturersListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimManufacturersListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimManufacturersListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
