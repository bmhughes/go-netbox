...
func (o *DcimModuleBayTemplatesBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimModuleBayTemplatesBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModuleBayTemplatesBulkDeleteBadRequest creates a DcimModuleBayTemplatesBulkDeleteBadRequest with default headers values
func NewDcimModuleBayTemplatesBulkDeleteBadRequest() *DcimModuleBayTemplatesBulkDeleteBadRequest {
	return &DcimModuleBayTemplatesBulkDeleteBadRequest{}
}

/*
DcimModuleBayTemplatesBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModuleBayTemplatesBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim module bay templates bulk delete bad request response has a 2xx status code
func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim module bay templates bulk delete bad request response has a 3xx status code
func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim module bay templates bulk delete bad request response has a 4xx status code
func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim module bay templates bulk delete bad request response has a 5xx status code
func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim module bay templates bulk delete bad request response a status code equal to that given
func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/module-bay-templates/][%d] dcimModuleBayTemplatesBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/module-bay-templates/][%d] dcimModuleBayTemplatesBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModuleBayTemplatesBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
