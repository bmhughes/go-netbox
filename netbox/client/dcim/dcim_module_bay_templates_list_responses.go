...
func (o *DcimModuleBayTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimModuleBayTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModuleBayTemplatesListBadRequest creates a DcimModuleBayTemplatesListBadRequest with default headers values
func NewDcimModuleBayTemplatesListBadRequest() *DcimModuleBayTemplatesListBadRequest {
	return &DcimModuleBayTemplatesListBadRequest{}
}

/*
DcimModuleBayTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModuleBayTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim module bay templates list bad request response has a 2xx status code
func (o *DcimModuleBayTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim module bay templates list bad request response has a 3xx status code
func (o *DcimModuleBayTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim module bay templates list bad request response has a 4xx status code
func (o *DcimModuleBayTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim module bay templates list bad request response has a 5xx status code
func (o *DcimModuleBayTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim module bay templates list bad request response a status code equal to that given
func (o *DcimModuleBayTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModuleBayTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/module-bay-templates/][%d] dcimModuleBayTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBayTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/module-bay-templates/][%d] dcimModuleBayTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBayTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModuleBayTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
