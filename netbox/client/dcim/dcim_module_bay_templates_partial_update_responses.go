...
func (o *DcimModuleBayTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimModuleBayTemplatesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModuleBayTemplatesPartialUpdateBadRequest creates a DcimModuleBayTemplatesPartialUpdateBadRequest with default headers values
func NewDcimModuleBayTemplatesPartialUpdateBadRequest() *DcimModuleBayTemplatesPartialUpdateBadRequest {
	return &DcimModuleBayTemplatesPartialUpdateBadRequest{}
}

/*
DcimModuleBayTemplatesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModuleBayTemplatesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim module bay templates partial update bad request response has a 2xx status code
func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim module bay templates partial update bad request response has a 3xx status code
func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim module bay templates partial update bad request response has a 4xx status code
func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim module bay templates partial update bad request response has a 5xx status code
func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim module bay templates partial update bad request response a status code equal to that given
func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/module-bay-templates/{id}/][%d] dcimModuleBayTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/module-bay-templates/{id}/][%d] dcimModuleBayTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModuleBayTemplatesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
