...
func (o *DcimModuleBaysBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimModuleBaysBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModuleBaysBulkDeleteBadRequest creates a DcimModuleBaysBulkDeleteBadRequest with default headers values
func NewDcimModuleBaysBulkDeleteBadRequest() *DcimModuleBaysBulkDeleteBadRequest {
	return &DcimModuleBaysBulkDeleteBadRequest{}
}

/*
DcimModuleBaysBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModuleBaysBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim module bays bulk delete bad request response has a 2xx status code
func (o *DcimModuleBaysBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim module bays bulk delete bad request response has a 3xx status code
func (o *DcimModuleBaysBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim module bays bulk delete bad request response has a 4xx status code
func (o *DcimModuleBaysBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim module bays bulk delete bad request response has a 5xx status code
func (o *DcimModuleBaysBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim module bays bulk delete bad request response a status code equal to that given
func (o *DcimModuleBaysBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModuleBaysBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/module-bays/][%d] dcimModuleBaysBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBaysBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/module-bays/][%d] dcimModuleBaysBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBaysBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModuleBaysBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
