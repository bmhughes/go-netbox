...
func (o *DcimModuleBaysBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimModuleBaysBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModuleBaysBulkUpdateBadRequest creates a DcimModuleBaysBulkUpdateBadRequest with default headers values
func NewDcimModuleBaysBulkUpdateBadRequest() *DcimModuleBaysBulkUpdateBadRequest {
	return &DcimModuleBaysBulkUpdateBadRequest{}
}

/*
DcimModuleBaysBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModuleBaysBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim module bays bulk update bad request response has a 2xx status code
func (o *DcimModuleBaysBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim module bays bulk update bad request response has a 3xx status code
func (o *DcimModuleBaysBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim module bays bulk update bad request response has a 4xx status code
func (o *DcimModuleBaysBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim module bays bulk update bad request response has a 5xx status code
func (o *DcimModuleBaysBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim module bays bulk update bad request response a status code equal to that given
func (o *DcimModuleBaysBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModuleBaysBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/module-bays/][%d] dcimModuleBaysBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBaysBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/module-bays/][%d] dcimModuleBaysBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleBaysBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModuleBaysBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
