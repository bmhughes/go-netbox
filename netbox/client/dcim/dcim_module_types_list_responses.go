...
func (o *DcimModuleTypesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimModuleTypesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModuleTypesListBadRequest creates a DcimModuleTypesListBadRequest with default headers values
func NewDcimModuleTypesListBadRequest() *DcimModuleTypesListBadRequest {
	return &DcimModuleTypesListBadRequest{}
}

/*
DcimModuleTypesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModuleTypesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim module types list bad request response has a 2xx status code
func (o *DcimModuleTypesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim module types list bad request response has a 3xx status code
func (o *DcimModuleTypesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim module types list bad request response has a 4xx status code
func (o *DcimModuleTypesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim module types list bad request response has a 5xx status code
func (o *DcimModuleTypesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim module types list bad request response a status code equal to that given
func (o *DcimModuleTypesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModuleTypesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/module-types/][%d] dcimModuleTypesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleTypesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/module-types/][%d] dcimModuleTypesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleTypesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModuleTypesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
