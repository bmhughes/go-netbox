...
func (o *DcimModuleTypesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimModuleTypesReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModuleTypesReadBadRequest creates a DcimModuleTypesReadBadRequest with default headers values
func NewDcimModuleTypesReadBadRequest() *DcimModuleTypesReadBadRequest {
	return &DcimModuleTypesReadBadRequest{}
}

/*
DcimModuleTypesReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModuleTypesReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim module types read bad request response has a 2xx status code
func (o *DcimModuleTypesReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim module types read bad request response has a 3xx status code
func (o *DcimModuleTypesReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim module types read bad request response has a 4xx status code
func (o *DcimModuleTypesReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim module types read bad request response has a 5xx status code
func (o *DcimModuleTypesReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim module types read bad request response a status code equal to that given
func (o *DcimModuleTypesReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModuleTypesReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/module-types/{id}/][%d] dcimModuleTypesReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleTypesReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/module-types/{id}/][%d] dcimModuleTypesReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModuleTypesReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModuleTypesReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
