...
func (o *DcimModulesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimModulesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModulesPartialUpdateBadRequest creates a DcimModulesPartialUpdateBadRequest with default headers values
func NewDcimModulesPartialUpdateBadRequest() *DcimModulesPartialUpdateBadRequest {
	return &DcimModulesPartialUpdateBadRequest{}
}

/*
DcimModulesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModulesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim modules partial update bad request response has a 2xx status code
func (o *DcimModulesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim modules partial update bad request response has a 3xx status code
func (o *DcimModulesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim modules partial update bad request response has a 4xx status code
func (o *DcimModulesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim modules partial update bad request response has a 5xx status code
func (o *DcimModulesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim modules partial update bad request response a status code equal to that given
func (o *DcimModulesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModulesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/modules/{id}/][%d] dcimModulesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModulesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/modules/{id}/][%d] dcimModulesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModulesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModulesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
