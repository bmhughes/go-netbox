...
func (o *DcimModulesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimModulesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimModulesUpdateBadRequest creates a DcimModulesUpdateBadRequest with default headers values
func NewDcimModulesUpdateBadRequest() *DcimModulesUpdateBadRequest {
	return &DcimModulesUpdateBadRequest{}
}

/*
DcimModulesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimModulesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim modules update bad request response has a 2xx status code
func (o *DcimModulesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim modules update bad request response has a 3xx status code
func (o *DcimModulesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim modules update bad request response has a 4xx status code
func (o *DcimModulesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim modules update bad request response has a 5xx status code
func (o *DcimModulesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim modules update bad request response a status code equal to that given
func (o *DcimModulesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimModulesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/modules/{id}/][%d] dcimModulesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModulesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/modules/{id}/][%d] dcimModulesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimModulesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimModulesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
