...
func (o *DcimPlatformsBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimPlatformsBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPlatformsBulkDeleteBadRequest creates a DcimPlatformsBulkDeleteBadRequest with default headers values
func NewDcimPlatformsBulkDeleteBadRequest() *DcimPlatformsBulkDeleteBadRequest {
	return &DcimPlatformsBulkDeleteBadRequest{}
}

/*
DcimPlatformsBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPlatformsBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim platforms bulk delete bad request response has a 2xx status code
func (o *DcimPlatformsBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim platforms bulk delete bad request response has a 3xx status code
func (o *DcimPlatformsBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim platforms bulk delete bad request response has a 4xx status code
func (o *DcimPlatformsBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim platforms bulk delete bad request response has a 5xx status code
func (o *DcimPlatformsBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim platforms bulk delete bad request response a status code equal to that given
func (o *DcimPlatformsBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPlatformsBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/platforms/][%d] dcimPlatformsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPlatformsBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/platforms/][%d] dcimPlatformsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPlatformsBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}
