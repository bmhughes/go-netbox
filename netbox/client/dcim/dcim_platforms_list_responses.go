...
func (o *DcimPlatformsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPlatformsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPlatformsListBadRequest creates a DcimPlatformsListBadRequest with default headers values
func NewDcimPlatformsListBadRequest() *DcimPlatformsListBadRequest {
	return &DcimPlatformsListBadRequest{}
}

/*
DcimPlatformsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPlatformsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim platforms list bad request response has a 2xx status code
func (o *DcimPlatformsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim platforms list bad request response has a 3xx status code
func (o *DcimPlatformsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim platforms list bad request response has a 4xx status code
func (o *DcimPlatformsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim platforms list bad request response has a 5xx status code
func (o *DcimPlatformsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim platforms list bad request response a status code equal to that given
func (o *DcimPlatformsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPlatformsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/platforms/][%d] dcimPlatformsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPlatformsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/platforms/][%d] dcimPlatformsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPlatformsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPlatformsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
