...
func (o *DcimPlatformsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPlatformsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPlatformsReadBadRequest creates a DcimPlatformsReadBadRequest with default headers values
func NewDcimPlatformsReadBadRequest() *DcimPlatformsReadBadRequest {
	return &DcimPlatformsReadBadRequest{}
}

/*
DcimPlatformsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPlatformsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim platforms read bad request response has a 2xx status code
func (o *DcimPlatformsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim platforms read bad request response has a 3xx status code
func (o *DcimPlatformsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim platforms read bad request response has a 4xx status code
func (o *DcimPlatformsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim platforms read bad request response has a 5xx status code
func (o *DcimPlatformsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim platforms read bad request response a status code equal to that given
func (o *DcimPlatformsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPlatformsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/platforms/{id}/][%d] dcimPlatformsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPlatformsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/platforms/{id}/][%d] dcimPlatformsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPlatformsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPlatformsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
