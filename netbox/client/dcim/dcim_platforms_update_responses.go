...
func (o *DcimPlatformsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPlatformsUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPlatformsUpdateBadRequest creates a DcimPlatformsUpdateBadRequest with default headers values
func NewDcimPlatformsUpdateBadRequest() *DcimPlatformsUpdateBadRequest {
	return &DcimPlatformsUpdateBadRequest{}
}

/*
DcimPlatformsUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPlatformsUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim platforms update bad request response has a 2xx status code
func (o *DcimPlatformsUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim platforms update bad request response has a 3xx status code
func (o *DcimPlatformsUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim platforms update bad request response has a 4xx status code
func (o *DcimPlatformsUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim platforms update bad request response has a 5xx status code
func (o *DcimPlatformsUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim platforms update bad request response a status code equal to that given
func (o *DcimPlatformsUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPlatformsUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/platforms/{id}/][%d] dcimPlatformsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPlatformsUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/platforms/{id}/][%d] dcimPlatformsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPlatformsUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPlatformsUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
