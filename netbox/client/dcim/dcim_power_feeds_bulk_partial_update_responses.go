...
func (o *DcimPowerFeedsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerFeedsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerFeedsBulkPartialUpdateBadRequest creates a DcimPowerFeedsBulkPartialUpdateBadRequest with default headers values
func NewDcimPowerFeedsBulkPartialUpdateBadRequest() *DcimPowerFeedsBulkPartialUpdateBadRequest {
	return &DcimPowerFeedsBulkPartialUpdateBadRequest{}
}

/*
DcimPowerFeedsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerFeedsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power feeds bulk partial update bad request response has a 2xx status code
func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power feeds bulk partial update bad request response has a 3xx status code
func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power feeds bulk partial update bad request response has a 4xx status code
func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power feeds bulk partial update bad request response has a 5xx status code
func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power feeds bulk partial update bad request response a status code equal to that given
func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/power-feeds/][%d] dcimPowerFeedsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/power-feeds/][%d] dcimPowerFeedsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerFeedsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
