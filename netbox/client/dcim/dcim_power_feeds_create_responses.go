...
func (o *DcimPowerFeedsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewDcimPowerFeedsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerFeedsCreateBadRequest creates a DcimPowerFeedsCreateBadRequest with default headers values
func NewDcimPowerFeedsCreateBadRequest() *DcimPowerFeedsCreateBadRequest {
	return &DcimPowerFeedsCreateBadRequest{}
}

/*
DcimPowerFeedsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerFeedsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power feeds create bad request response has a 2xx status code
func (o *DcimPowerFeedsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power feeds create bad request response has a 3xx status code
func (o *DcimPowerFeedsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power feeds create bad request response has a 4xx status code
func (o *DcimPowerFeedsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power feeds create bad request response has a 5xx status code
func (o *DcimPowerFeedsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power feeds create bad request response a status code equal to that given
func (o *DcimPowerFeedsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerFeedsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /dcim/power-feeds/][%d] dcimPowerFeedsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerFeedsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /dcim/power-feeds/][%d] dcimPowerFeedsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerFeedsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerFeedsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
