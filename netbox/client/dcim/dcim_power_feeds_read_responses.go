...
func (o *DcimPowerFeedsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerFeedsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerFeedsReadBadRequest creates a DcimPowerFeedsReadBadRequest with default headers values
func NewDcimPowerFeedsReadBadRequest() *DcimPowerFeedsReadBadRequest {
	return &DcimPowerFeedsReadBadRequest{}
}

/*
DcimPowerFeedsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerFeedsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power feeds read bad request response has a 2xx status code
func (o *DcimPowerFeedsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power feeds read bad request response has a 3xx status code
func (o *DcimPowerFeedsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power feeds read bad request response has a 4xx status code
func (o *DcimPowerFeedsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power feeds read bad request response has a 5xx status code
func (o *DcimPowerFeedsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power feeds read bad request response a status code equal to that given
func (o *DcimPowerFeedsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerFeedsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/power-feeds/{id}/][%d] dcimPowerFeedsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerFeedsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/power-feeds/{id}/][%d] dcimPowerFeedsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerFeedsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerFeedsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
