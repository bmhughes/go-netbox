...
func (o *DcimPowerOutletTemplatesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerOutletTemplatesBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerOutletTemplatesBulkPartialUpdateBadRequest creates a DcimPowerOutletTemplatesBulkPartialUpdateBadRequest with default headers values
func NewDcimPowerOutletTemplatesBulkPartialUpdateBadRequest() *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest {
	return &DcimPowerOutletTemplatesBulkPartialUpdateBadRequest{}
}

/*
DcimPowerOutletTemplatesBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerOutletTemplatesBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power outlet templates bulk partial update bad request response has a 2xx status code
func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power outlet templates bulk partial update bad request response has a 3xx status code
func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power outlet templates bulk partial update bad request response has a 4xx status code
func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power outlet templates bulk partial update bad request response has a 5xx status code
func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power outlet templates bulk partial update bad request response a status code equal to that given
func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/power-outlet-templates/][%d] dcimPowerOutletTemplatesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/power-outlet-templates/][%d] dcimPowerOutletTemplatesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerOutletTemplatesBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
