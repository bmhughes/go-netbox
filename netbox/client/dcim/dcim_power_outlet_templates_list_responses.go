...
func (o *DcimPowerOutletTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerOutletTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerOutletTemplatesListBadRequest creates a DcimPowerOutletTemplatesListBadRequest with default headers values
func NewDcimPowerOutletTemplatesListBadRequest() *DcimPowerOutletTemplatesListBadRequest {
	return &DcimPowerOutletTemplatesListBadRequest{}
}

/*
DcimPowerOutletTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerOutletTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power outlet templates list bad request response has a 2xx status code
func (o *DcimPowerOutletTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power outlet templates list bad request response has a 3xx status code
func (o *DcimPowerOutletTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power outlet templates list bad request response has a 4xx status code
func (o *DcimPowerOutletTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power outlet templates list bad request response has a 5xx status code
func (o *DcimPowerOutletTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power outlet templates list bad request response a status code equal to that given
func (o *DcimPowerOutletTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerOutletTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/power-outlet-templates/][%d] dcimPowerOutletTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/power-outlet-templates/][%d] dcimPowerOutletTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerOutletTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
