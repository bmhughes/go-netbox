...
func (o *DcimPowerOutletTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerOutletTemplatesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerOutletTemplatesPartialUpdateBadRequest creates a DcimPowerOutletTemplatesPartialUpdateBadRequest with default headers values
func NewDcimPowerOutletTemplatesPartialUpdateBadRequest() *DcimPowerOutletTemplatesPartialUpdateBadRequest {
	return &DcimPowerOutletTemplatesPartialUpdateBadRequest{}
}

/*
DcimPowerOutletTemplatesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerOutletTemplatesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power outlet templates partial update bad request response has a 2xx status code
func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power outlet templates partial update bad request response has a 3xx status code
func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power outlet templates partial update bad request response has a 4xx status code
func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power outlet templates partial update bad request response has a 5xx status code
func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power outlet templates partial update bad request response a status code equal to that given
func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/power-outlet-templates/{id}/][%d] dcimPowerOutletTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/power-outlet-templates/{id}/][%d] dcimPowerOutletTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerOutletTemplatesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
