...
func (o *DcimPowerOutletsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerOutletsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerOutletsListBadRequest creates a DcimPowerOutletsListBadRequest with default headers values
func NewDcimPowerOutletsListBadRequest() *DcimPowerOutletsListBadRequest {
	return &DcimPowerOutletsListBadRequest{}
}

/*
DcimPowerOutletsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerOutletsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power outlets list bad request response has a 2xx status code
func (o *DcimPowerOutletsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power outlets list bad request response has a 3xx status code
func (o *DcimPowerOutletsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power outlets list bad request response has a 4xx status code
func (o *DcimPowerOutletsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power outlets list bad request response has a 5xx status code
func (o *DcimPowerOutletsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power outlets list bad request response a status code equal to that given
func (o *DcimPowerOutletsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerOutletsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/power-outlets/][%d] dcimPowerOutletsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/power-outlets/][%d] dcimPowerOutletsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerOutletsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
