...
func (o *DcimPowerOutletsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerOutletsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerOutletsReadBadRequest creates a DcimPowerOutletsReadBadRequest with default headers values
func NewDcimPowerOutletsReadBadRequest() *DcimPowerOutletsReadBadRequest {
	return &DcimPowerOutletsReadBadRequest{}
}

/*
DcimPowerOutletsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerOutletsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power outlets read bad request response has a 2xx status code
func (o *DcimPowerOutletsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power outlets read bad request response has a 3xx status code
func (o *DcimPowerOutletsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power outlets read bad request response has a 4xx status code
func (o *DcimPowerOutletsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power outlets read bad request response has a 5xx status code
func (o *DcimPowerOutletsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power outlets read bad request response a status code equal to that given
func (o *DcimPowerOutletsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerOutletsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/power-outlets/{id}/][%d] dcimPowerOutletsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/power-outlets/{id}/][%d] dcimPowerOutletsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerOutletsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerOutletsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
