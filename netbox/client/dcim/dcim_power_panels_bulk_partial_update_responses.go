...
func (o *DcimPowerPanelsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPanelsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPanelsBulkPartialUpdateBadRequest creates a DcimPowerPanelsBulkPartialUpdateBadRequest with default headers values
func NewDcimPowerPanelsBulkPartialUpdateBadRequest() *DcimPowerPanelsBulkPartialUpdateBadRequest {
	return &DcimPowerPanelsBulkPartialUpdateBadRequest{}
}

/*
DcimPowerPanelsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPanelsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power panels bulk partial update bad request response has a 2xx status code
func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power panels bulk partial update bad request response has a 3xx status code
func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power panels bulk partial update bad request response has a 4xx status code
func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power panels bulk partial update bad request response has a 5xx status code
func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power panels bulk partial update bad request response a status code equal to that given
func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/power-panels/][%d] dcimPowerPanelsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/power-panels/][%d] dcimPowerPanelsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPanelsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
