...
func (o *DcimPowerPanelsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPanelsBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPanelsBulkUpdateBadRequest creates a DcimPowerPanelsBulkUpdateBadRequest with default headers values
func NewDcimPowerPanelsBulkUpdateBadRequest() *DcimPowerPanelsBulkUpdateBadRequest {
	return &DcimPowerPanelsBulkUpdateBadRequest{}
}

/*
DcimPowerPanelsBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPanelsBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power panels bulk update bad request response has a 2xx status code
func (o *DcimPowerPanelsBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power panels bulk update bad request response has a 3xx status code
func (o *DcimPowerPanelsBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power panels bulk update bad request response has a 4xx status code
func (o *DcimPowerPanelsBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power panels bulk update bad request response has a 5xx status code
func (o *DcimPowerPanelsBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power panels bulk update bad request response a status code equal to that given
func (o *DcimPowerPanelsBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPanelsBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/power-panels/][%d] dcimPowerPanelsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPanelsBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/power-panels/][%d] dcimPowerPanelsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPanelsBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPanelsBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
