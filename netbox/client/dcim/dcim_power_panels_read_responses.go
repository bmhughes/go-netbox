...
func (o *DcimPowerPanelsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPanelsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPanelsReadBadRequest creates a DcimPowerPanelsReadBadRequest with default headers values
func NewDcimPowerPanelsReadBadRequest() *DcimPowerPanelsReadBadRequest {
	return &DcimPowerPanelsReadBadRequest{}
}

/*
DcimPowerPanelsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPanelsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power panels read bad request response has a 2xx status code
func (o *DcimPowerPanelsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power panels read bad request response has a 3xx status code
func (o *DcimPowerPanelsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power panels read bad request response has a 4xx status code
func (o *DcimPowerPanelsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power panels read bad request response has a 5xx status code
func (o *DcimPowerPanelsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power panels read bad request response a status code equal to that given
func (o *DcimPowerPanelsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPanelsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/power-panels/{id}/][%d] dcimPowerPanelsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPanelsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/power-panels/{id}/][%d] dcimPowerPanelsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPanelsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPanelsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
