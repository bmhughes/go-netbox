...
func (o *DcimPowerPortTemplatesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPortTemplatesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPortTemplatesBulkUpdateBadRequest creates a DcimPowerPortTemplatesBulkUpdateBadRequest with default headers values
func NewDcimPowerPortTemplatesBulkUpdateBadRequest() *DcimPowerPortTemplatesBulkUpdateBadRequest {
	return &DcimPowerPortTemplatesBulkUpdateBadRequest{}
}

/*
DcimPowerPortTemplatesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPortTemplatesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power port templates bulk update bad request response has a 2xx status code
func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power port templates bulk update bad request response has a 3xx status code
func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power port templates bulk update bad request response has a 4xx status code
func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power port templates bulk update bad request response has a 5xx status code
func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power port templates bulk update bad request response a status code equal to that given
func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/power-port-templates/][%d] dcimPowerPortTemplatesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/power-port-templates/][%d] dcimPowerPortTemplatesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPortTemplatesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
