...
func (o *DcimPowerPortTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPortTemplatesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPortTemplatesPartialUpdateBadRequest creates a DcimPowerPortTemplatesPartialUpdateBadRequest with default headers values
func NewDcimPowerPortTemplatesPartialUpdateBadRequest() *DcimPowerPortTemplatesPartialUpdateBadRequest {
	return &DcimPowerPortTemplatesPartialUpdateBadRequest{}
}

/*
DcimPowerPortTemplatesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPortTemplatesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power port templates partial update bad request response has a 2xx status code
func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power port templates partial update bad request response has a 3xx status code
func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power port templates partial update bad request response has a 4xx status code
func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power port templates partial update bad request response has a 5xx status code
func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power port templates partial update bad request response a status code equal to that given
func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/power-port-templates/{id}/][%d] dcimPowerPortTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/power-port-templates/{id}/][%d] dcimPowerPortTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPortTemplatesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
