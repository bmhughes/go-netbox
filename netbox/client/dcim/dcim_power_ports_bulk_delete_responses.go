...
func (o *DcimPowerPortsBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPortsBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPortsBulkDeleteBadRequest creates a DcimPowerPortsBulkDeleteBadRequest with default headers values
func NewDcimPowerPortsBulkDeleteBadRequest() *DcimPowerPortsBulkDeleteBadRequest {
	return &DcimPowerPortsBulkDeleteBadRequest{}
}

/*
DcimPowerPortsBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPortsBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power ports bulk delete bad request response has a 2xx status code
func (o *DcimPowerPortsBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power ports bulk delete bad request response has a 3xx status code
func (o *DcimPowerPortsBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power ports bulk delete bad request response has a 4xx status code
func (o *DcimPowerPortsBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power ports bulk delete bad request response has a 5xx status code
func (o *DcimPowerPortsBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power ports bulk delete bad request response a status code equal to that given
func (o *DcimPowerPortsBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPortsBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/power-ports/][%d] dcimPowerPortsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortsBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/power-ports/][%d] dcimPowerPortsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortsBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPortsBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
