...
func (o *DcimPowerPortsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPortsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPortsCreateBadRequest creates a DcimPowerPortsCreateBadRequest with default headers values
func NewDcimPowerPortsCreateBadRequest() *DcimPowerPortsCreateBadRequest {
	return &DcimPowerPortsCreateBadRequest{}
}

/*
DcimPowerPortsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPortsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power ports create bad request response has a 2xx status code
func (o *DcimPowerPortsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power ports create bad request response has a 3xx status code
func (o *DcimPowerPortsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power ports create bad request response has a 4xx status code
func (o *DcimPowerPortsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power ports create bad request response has a 5xx status code
func (o *DcimPowerPortsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power ports create bad request response a status code equal to that given
func (o *DcimPowerPortsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPortsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /dcim/power-ports/][%d] dcimPowerPortsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /dcim/power-ports/][%d] dcimPowerPortsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPortsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
