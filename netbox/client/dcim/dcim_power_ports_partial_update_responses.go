...
func (o *DcimPowerPortsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPortsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPortsPartialUpdateBadRequest creates a DcimPowerPortsPartialUpdateBadRequest with default headers values
func NewDcimPowerPortsPartialUpdateBadRequest() *DcimPowerPortsPartialUpdateBadRequest {
	return &DcimPowerPortsPartialUpdateBadRequest{}
}

/*
DcimPowerPortsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPortsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power ports partial update bad request response has a 2xx status code
func (o *DcimPowerPortsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power ports partial update bad request response has a 3xx status code
func (o *DcimPowerPortsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power ports partial update bad request response has a 4xx status code
func (o *DcimPowerPortsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power ports partial update bad request response has a 5xx status code
func (o *DcimPowerPortsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power ports partial update bad request response a status code equal to that given
func (o *DcimPowerPortsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPortsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/power-ports/{id}/][%d] dcimPowerPortsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/power-ports/{id}/][%d] dcimPowerPortsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPortsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
