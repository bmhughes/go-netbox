...
func (o *DcimPowerPortsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimPowerPortsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimPowerPortsReadBadRequest creates a DcimPowerPortsReadBadRequest with default headers values
func NewDcimPowerPortsReadBadRequest() *DcimPowerPortsReadBadRequest {
	return &DcimPowerPortsReadBadRequest{}
}

/*
DcimPowerPortsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimPowerPortsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim power ports read bad request response has a 2xx status code
func (o *DcimPowerPortsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim power ports read bad request response has a 3xx status code
func (o *DcimPowerPortsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim power ports read bad request response has a 4xx status code
func (o *DcimPowerPortsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim power ports read bad request response has a 5xx status code
func (o *DcimPowerPortsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim power ports read bad request response a status code equal to that given
func (o *DcimPowerPortsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimPowerPortsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/power-ports/{id}/][%d] dcimPowerPortsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/power-ports/{id}/][%d] dcimPowerPortsReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimPowerPortsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimPowerPortsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
