...
func (o *DcimRackReservationsDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimRackReservationsDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRackReservationsDeleteBadRequest creates a DcimRackReservationsDeleteBadRequest with default headers values
func NewDcimRackReservationsDeleteBadRequest() *DcimRackReservationsDeleteBadRequest {
	return &DcimRackReservationsDeleteBadRequest{}
}

/*
DcimRackReservationsDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRackReservationsDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rack reservations delete bad request response has a 2xx status code
func (o *DcimRackReservationsDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rack reservations delete bad request response has a 3xx status code
func (o *DcimRackReservationsDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rack reservations delete bad request response has a 4xx status code
func (o *DcimRackReservationsDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rack reservations delete bad request response has a 5xx status code
func (o *DcimRackReservationsDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rack reservations delete bad request response a status code equal to that given
func (o *DcimRackReservationsDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRackReservationsDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/rack-reservations/{id}/][%d] dcimRackReservationsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRackReservationsDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/rack-reservations/{id}/][%d] dcimRackReservationsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRackReservationsDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}
