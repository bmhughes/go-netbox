...
func (o *DcimRackReservationsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRackReservationsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRackReservationsPartialUpdateBadRequest creates a DcimRackReservationsPartialUpdateBadRequest with default headers values
func NewDcimRackReservationsPartialUpdateBadRequest() *DcimRackReservationsPartialUpdateBadRequest {
	return &DcimRackReservationsPartialUpdateBadRequest{}
}

/*
DcimRackReservationsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRackReservationsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rack reservations partial update bad request response has a 2xx status code
func (o *DcimRackReservationsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rack reservations partial update bad request response has a 3xx status code
func (o *DcimRackReservationsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rack reservations partial update bad request response has a 4xx status code
func (o *DcimRackReservationsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rack reservations partial update bad request response has a 5xx status code
func (o *DcimRackReservationsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rack reservations partial update bad request response a status code equal to that given
func (o *DcimRackReservationsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRackReservationsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/rack-reservations/{id}/][%d] dcimRackReservationsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRackReservationsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/rack-reservations/{id}/][%d] dcimRackReservationsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRackReservationsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRackReservationsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
