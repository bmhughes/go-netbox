...
func (o *DcimRackRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRackRolesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRackRolesListBadRequest creates a DcimRackRolesListBadRequest with default headers values
func NewDcimRackRolesListBadRequest() *DcimRackRolesListBadRequest {
	return &DcimRackRolesListBadRequest{}
}

/*
DcimRackRolesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRackRolesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rack roles list bad request response has a 2xx status code
func (o *DcimRackRolesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rack roles list bad request response has a 3xx status code
func (o *DcimRackRolesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rack roles list bad request response has a 4xx status code
func (o *DcimRackRolesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rack roles list bad request response has a 5xx status code
func (o *DcimRackRolesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rack roles list bad request response a status code equal to that given
func (o *DcimRackRolesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRackRolesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/rack-roles/][%d] dcimRackRolesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRackRolesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/rack-roles/][%d] dcimRackRolesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRackRolesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRackRolesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
