...
func (o *DcimRackRolesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRackRolesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRackRolesUpdateBadRequest creates a DcimRackRolesUpdateBadRequest with default headers values
func NewDcimRackRolesUpdateBadRequest() *DcimRackRolesUpdateBadRequest {
	return &DcimRackRolesUpdateBadRequest{}
}

/*
DcimRackRolesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRackRolesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rack roles update bad request response has a 2xx status code
func (o *DcimRackRolesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rack roles update bad request response has a 3xx status code
func (o *DcimRackRolesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rack roles update bad request response has a 4xx status code
func (o *DcimRackRolesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rack roles update bad request response has a 5xx status code
func (o *DcimRackRolesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rack roles update bad request response a status code equal to that given
func (o *DcimRackRolesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRackRolesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/rack-roles/{id}/][%d] dcimRackRolesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRackRolesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/rack-roles/{id}/][%d] dcimRackRolesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRackRolesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRackRolesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
