...
func (o *DcimRacksPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRacksPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRacksPartialUpdateBadRequest creates a DcimRacksPartialUpdateBadRequest with default headers values
func NewDcimRacksPartialUpdateBadRequest() *DcimRacksPartialUpdateBadRequest {
	return &DcimRacksPartialUpdateBadRequest{}
}

/*
DcimRacksPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRacksPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim racks partial update bad request response has a 2xx status code
func (o *DcimRacksPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim racks partial update bad request response has a 3xx status code
func (o *DcimRacksPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim racks partial update bad request response has a 4xx status code
func (o *DcimRacksPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim racks partial update bad request response has a 5xx status code
func (o *DcimRacksPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim racks partial update bad request response a status code equal to that given
func (o *DcimRacksPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRacksPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/racks/{id}/][%d] dcimRacksPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRacksPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/racks/{id}/][%d] dcimRacksPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRacksPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRacksPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
