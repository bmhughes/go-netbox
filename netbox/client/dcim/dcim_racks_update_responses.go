...
func (o *DcimRacksUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRacksUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRacksUpdateBadRequest creates a DcimRacksUpdateBadRequest with default headers values
func NewDcimRacksUpdateBadRequest() *DcimRacksUpdateBadRequest {
	return &DcimRacksUpdateBadRequest{}
}

/*
DcimRacksUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRacksUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim racks update bad request response has a 2xx status code
func (o *DcimRacksUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim racks update bad request response has a 3xx status code
func (o *DcimRacksUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim racks update bad request response has a 4xx status code
func (o *DcimRacksUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim racks update bad request response has a 5xx status code
func (o *DcimRacksUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim racks update bad request response a status code equal to that given
func (o *DcimRacksUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRacksUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/racks/{id}/][%d] dcimRacksUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRacksUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/racks/{id}/][%d] dcimRacksUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRacksUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRacksUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
