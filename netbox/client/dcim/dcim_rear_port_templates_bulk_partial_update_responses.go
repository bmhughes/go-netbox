...
func (o *DcimRearPortTemplatesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRearPortTemplatesBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRearPortTemplatesBulkPartialUpdateBadRequest creates a DcimRearPortTemplatesBulkPartialUpdateBadRequest with default headers values
func NewDcimRearPortTemplatesBulkPartialUpdateBadRequest() *DcimRearPortTemplatesBulkPartialUpdateBadRequest {
	return &DcimRearPortTemplatesBulkPartialUpdateBadRequest{}
}

/*
DcimRearPortTemplatesBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRearPortTemplatesBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rear port templates bulk partial update bad request response has a 2xx status code
func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rear port templates bulk partial update bad request response has a 3xx status code
func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rear port templates bulk partial update bad request response has a 4xx status code
func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rear port templates bulk partial update bad request response has a 5xx status code
func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rear port templates bulk partial update bad request response a status code equal to that given
func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/rear-port-templates/][%d] dcimRearPortTemplatesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/rear-port-templates/][%d] dcimRearPortTemplatesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRearPortTemplatesBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
