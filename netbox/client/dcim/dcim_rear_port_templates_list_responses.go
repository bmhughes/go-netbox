...
func (o *DcimRearPortTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRearPortTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRearPortTemplatesListBadRequest creates a DcimRearPortTemplatesListBadRequest with default headers values
func NewDcimRearPortTemplatesListBadRequest() *DcimRearPortTemplatesListBadRequest {
	return &DcimRearPortTemplatesListBadRequest{}
}

/*
DcimRearPortTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRearPortTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rear port templates list bad request response has a 2xx status code
func (o *DcimRearPortTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rear port templates list bad request response has a 3xx status code
func (o *DcimRearPortTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rear port templates list bad request response has a 4xx status code
func (o *DcimRearPortTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rear port templates list bad request response has a 5xx status code
func (o *DcimRearPortTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rear port templates list bad request response a status code equal to that given
func (o *DcimRearPortTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRearPortTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/rear-port-templates/][%d] dcimRearPortTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/rear-port-templates/][%d] dcimRearPortTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRearPortTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
