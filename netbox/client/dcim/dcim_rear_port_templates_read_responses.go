...
func (o *DcimRearPortTemplatesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRearPortTemplatesReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRearPortTemplatesReadBadRequest creates a DcimRearPortTemplatesReadBadRequest with default headers values
func NewDcimRearPortTemplatesReadBadRequest() *DcimRearPortTemplatesReadBadRequest {
	return &DcimRearPortTemplatesReadBadRequest{}
}

/*
DcimRearPortTemplatesReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRearPortTemplatesReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rear port templates read bad request response has a 2xx status code
func (o *DcimRearPortTemplatesReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rear port templates read bad request response has a 3xx status code
func (o *DcimRearPortTemplatesReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rear port templates read bad request response has a 4xx status code
func (o *DcimRearPortTemplatesReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rear port templates read bad request response has a 5xx status code
func (o *DcimRearPortTemplatesReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rear port templates read bad request response a status code equal to that given
func (o *DcimRearPortTemplatesReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRearPortTemplatesReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/rear-port-templates/{id}/][%d] dcimRearPortTemplatesReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortTemplatesReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/rear-port-templates/{id}/][%d] dcimRearPortTemplatesReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortTemplatesReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRearPortTemplatesReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
