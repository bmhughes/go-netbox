...
func (o *DcimRearPortTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRearPortTemplatesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRearPortTemplatesUpdateBadRequest creates a DcimRearPortTemplatesUpdateBadRequest with default headers values
func NewDcimRearPortTemplatesUpdateBadRequest() *DcimRearPortTemplatesUpdateBadRequest {
	return &DcimRearPortTemplatesUpdateBadRequest{}
}

/*
DcimRearPortTemplatesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRearPortTemplatesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rear port templates update bad request response has a 2xx status code
func (o *DcimRearPortTemplatesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rear port templates update bad request response has a 3xx status code
func (o *DcimRearPortTemplatesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rear port templates update bad request response has a 4xx status code
func (o *DcimRearPortTemplatesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rear port templates update bad request response has a 5xx status code
func (o *DcimRearPortTemplatesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rear port templates update bad request response a status code equal to that given
func (o *DcimRearPortTemplatesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRearPortTemplatesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/rear-port-templates/{id}/][%d] dcimRearPortTemplatesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortTemplatesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/rear-port-templates/{id}/][%d] dcimRearPortTemplatesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortTemplatesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRearPortTemplatesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
