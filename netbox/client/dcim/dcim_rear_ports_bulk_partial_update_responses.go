...
func (o *DcimRearPortsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRearPortsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRearPortsBulkPartialUpdateBadRequest creates a DcimRearPortsBulkPartialUpdateBadRequest with default headers values
func NewDcimRearPortsBulkPartialUpdateBadRequest() *DcimRearPortsBulkPartialUpdateBadRequest {
	return &DcimRearPortsBulkPartialUpdateBadRequest{}
}

/*
DcimRearPortsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRearPortsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rear ports bulk partial update bad request response has a 2xx status code
func (o *DcimRearPortsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rear ports bulk partial update bad request response has a 3xx status code
func (o *DcimRearPortsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rear ports bulk partial update bad request response has a 4xx status code
func (o *DcimRearPortsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rear ports bulk partial update bad request response has a 5xx status code
func (o *DcimRearPortsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rear ports bulk partial update bad request response a status code equal to that given
func (o *DcimRearPortsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRearPortsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/rear-ports/][%d] dcimRearPortsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/rear-ports/][%d] dcimRearPortsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRearPortsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
