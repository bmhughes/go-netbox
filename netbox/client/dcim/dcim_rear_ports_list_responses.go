...
func (o *DcimRearPortsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRearPortsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRearPortsListBadRequest creates a DcimRearPortsListBadRequest with default headers values
func NewDcimRearPortsListBadRequest() *DcimRearPortsListBadRequest {
	return &DcimRearPortsListBadRequest{}
}

/*
DcimRearPortsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRearPortsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim rear ports list bad request response has a 2xx status code
func (o *DcimRearPortsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim rear ports list bad request response has a 3xx status code
func (o *DcimRearPortsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim rear ports list bad request response has a 4xx status code
func (o *DcimRearPortsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim rear ports list bad request response has a 5xx status code
func (o *DcimRearPortsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim rear ports list bad request response a status code equal to that given
func (o *DcimRearPortsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRearPortsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/rear-ports/][%d] dcimRearPortsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/rear-ports/][%d] dcimRearPortsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRearPortsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimRearPortsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
