...
func (o *DcimRegionsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimRegionsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimRegionsListBadRequest creates a DcimRegionsListBadRequest with default headers values
func NewDcimRegionsListBadRequest() *DcimRegionsListBadRequest {
	return &DcimRegionsListBadRequest{}
}

/*
DcimRegionsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimRegionsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim regions list bad request response has a 2xx status code
func (o *DcimRegionsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim regions list bad request response has a 3xx status code
func (o *DcimRegionsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim regions list bad request response has a 4xx status code
func (o *DcimRegionsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim regions list bad request response has a 5xx status code
func (o *DcimRegionsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim regions list bad request response a status code equal to that given
func (o *DcimRegionsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimRegionsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/regions/][%d] dcimRegionsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRegionsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/regions/][%d] dcimRegionsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimRegionsListBadRequest) GetPayload() interface{} {
	return o.Payload
}
