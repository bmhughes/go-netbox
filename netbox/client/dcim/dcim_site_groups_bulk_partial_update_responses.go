...
func (o *DcimSiteGroupsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimSiteGroupsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimSiteGroupsBulkPartialUpdateBadRequest creates a DcimSiteGroupsBulkPartialUpdateBadRequest with default headers values
func NewDcimSiteGroupsBulkPartialUpdateBadRequest() *DcimSiteGroupsBulkPartialUpdateBadRequest {
	return &DcimSiteGroupsBulkPartialUpdateBadRequest{}
}

/*
DcimSiteGroupsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimSiteGroupsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim site groups bulk partial update bad request response has a 2xx status code
func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim site groups bulk partial update bad request response has a 3xx status code
func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim site groups bulk partial update bad request response has a 4xx status code
func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim site groups bulk partial update bad request response has a 5xx status code
func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim site groups bulk partial update bad request response a status code equal to that given
func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/site-groups/][%d] dcimSiteGroupsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/site-groups/][%d] dcimSiteGroupsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimSiteGroupsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
