...
func (o *DcimSiteGroupsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimSiteGroupsBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimSiteGroupsBulkUpdateBadRequest creates a DcimSiteGroupsBulkUpdateBadRequest with default headers values
func NewDcimSiteGroupsBulkUpdateBadRequest() *DcimSiteGroupsBulkUpdateBadRequest {
	return &DcimSiteGroupsBulkUpdateBadRequest{}
}

/*
DcimSiteGroupsBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimSiteGroupsBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim site groups bulk update bad request response has a 2xx status code
func (o *DcimSiteGroupsBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim site groups bulk update bad request response has a 3xx status code
func (o *DcimSiteGroupsBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim site groups bulk update bad request response has a 4xx status code
func (o *DcimSiteGroupsBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim site groups bulk update bad request response has a 5xx status code
func (o *DcimSiteGroupsBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim site groups bulk update bad request response a status code equal to that given
func (o *DcimSiteGroupsBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimSiteGroupsBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/site-groups/][%d] dcimSiteGroupsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/site-groups/][%d] dcimSiteGroupsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimSiteGroupsBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
