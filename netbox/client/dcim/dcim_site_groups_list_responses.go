...
func (o *DcimSiteGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimSiteGroupsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimSiteGroupsListBadRequest creates a DcimSiteGroupsListBadRequest with default headers values
func NewDcimSiteGroupsListBadRequest() *DcimSiteGroupsListBadRequest {
	return &DcimSiteGroupsListBadRequest{}
}

/*
DcimSiteGroupsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimSiteGroupsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim site groups list bad request response has a 2xx status code
func (o *DcimSiteGroupsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim site groups list bad request response has a 3xx status code
func (o *DcimSiteGroupsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim site groups list bad request response has a 4xx status code
func (o *DcimSiteGroupsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim site groups list bad request response has a 5xx status code
func (o *DcimSiteGroupsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim site groups list bad request response a status code equal to that given
func (o *DcimSiteGroupsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimSiteGroupsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/site-groups/][%d] dcimSiteGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/site-groups/][%d] dcimSiteGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimSiteGroupsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
