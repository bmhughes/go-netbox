...
func (o *DcimSiteGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimSiteGroupsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimSiteGroupsPartialUpdateBadRequest creates a DcimSiteGroupsPartialUpdateBadRequest with default headers values
func NewDcimSiteGroupsPartialUpdateBadRequest() *DcimSiteGroupsPartialUpdateBadRequest {
	return &DcimSiteGroupsPartialUpdateBadRequest{}
}

/*
DcimSiteGroupsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimSiteGroupsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim site groups partial update bad request response has a 2xx status code
func (o *DcimSiteGroupsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim site groups partial update bad request response has a 3xx status code
func (o *DcimSiteGroupsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim site groups partial update bad request response has a 4xx status code
func (o *DcimSiteGroupsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim site groups partial update bad request response has a 5xx status code
func (o *DcimSiteGroupsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim site groups partial update bad request response a status code equal to that given
func (o *DcimSiteGroupsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimSiteGroupsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/site-groups/{id}/][%d] dcimSiteGroupsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/site-groups/{id}/][%d] dcimSiteGroupsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimSiteGroupsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
