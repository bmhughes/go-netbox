...
func (o *DcimSiteGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimSiteGroupsUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimSiteGroupsUpdateBadRequest creates a DcimSiteGroupsUpdateBadRequest with default headers values
func NewDcimSiteGroupsUpdateBadRequest() *DcimSiteGroupsUpdateBadRequest {
	return &DcimSiteGroupsUpdateBadRequest{}
}

/*
DcimSiteGroupsUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimSiteGroupsUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim site groups update bad request response has a 2xx status code
func (o *DcimSiteGroupsUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim site groups update bad request response has a 3xx status code
func (o *DcimSiteGroupsUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim site groups update bad request response has a 4xx status code
func (o *DcimSiteGroupsUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim site groups update bad request response has a 5xx status code
func (o *DcimSiteGroupsUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim site groups update bad request response a status code equal to that given
func (o *DcimSiteGroupsUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimSiteGroupsUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /dcim/site-groups/{id}/][%d] dcimSiteGroupsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /dcim/site-groups/{id}/][%d] dcimSiteGroupsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSiteGroupsUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimSiteGroupsUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
