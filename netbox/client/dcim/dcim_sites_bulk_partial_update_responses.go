...
func (o *DcimSitesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimSitesBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimSitesBulkPartialUpdateBadRequest creates a DcimSitesBulkPartialUpdateBadRequest with default headers values
func NewDcimSitesBulkPartialUpdateBadRequest() *DcimSitesBulkPartialUpdateBadRequest {
	return &DcimSitesBulkPartialUpdateBadRequest{}
}

/*
DcimSitesBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimSitesBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim sites bulk partial update bad request response has a 2xx status code
func (o *DcimSitesBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim sites bulk partial update bad request response has a 3xx status code
func (o *DcimSitesBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim sites bulk partial update bad request response has a 4xx status code
func (o *DcimSitesBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim sites bulk partial update bad request response has a 5xx status code
func (o *DcimSitesBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim sites bulk partial update bad request response a status code equal to that given
func (o *DcimSitesBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimSitesBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /dcim/sites/][%d] dcimSitesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSitesBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /dcim/sites/][%d] dcimSitesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSitesBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
