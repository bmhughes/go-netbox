...
func (o *DcimSitesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewDcimSitesCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimSitesCreateBadRequest creates a DcimSitesCreateBadRequest with default headers values
func NewDcimSitesCreateBadRequest() *DcimSitesCreateBadRequest {
	return &DcimSitesCreateBadRequest{}
}

/*
DcimSitesCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimSitesCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim sites create bad request response has a 2xx status code
func (o *DcimSitesCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim sites create bad request response has a 3xx status code
func (o *DcimSitesCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim sites create bad request response has a 4xx status code
func (o *DcimSitesCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim sites create bad request response has a 5xx status code
func (o *DcimSitesCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim sites create bad request response a status code equal to that given
func (o *DcimSitesCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimSitesCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /dcim/sites/][%d] dcimSitesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSitesCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /dcim/sites/][%d] dcimSitesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSitesCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimSitesCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
