...
func (o *DcimSitesDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimSitesDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimSitesDeleteBadRequest creates a DcimSitesDeleteBadRequest with default headers values
func NewDcimSitesDeleteBadRequest() *DcimSitesDeleteBadRequest {
	return &DcimSitesDeleteBadRequest{}
}

/*
DcimSitesDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimSitesDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim sites delete bad request response has a 2xx status code
func (o *DcimSitesDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim sites delete bad request response has a 3xx status code
func (o *DcimSitesDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim sites delete bad request response has a 4xx status code
func (o *DcimSitesDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim sites delete bad request response has a 5xx status code
func (o *DcimSitesDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim sites delete bad request response a status code equal to that given
func (o *DcimSitesDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimSitesDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/sites/{id}/][%d] dcimSitesDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSitesDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/sites/{id}/][%d] dcimSitesDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSitesDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimSitesDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
