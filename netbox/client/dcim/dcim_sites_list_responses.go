...
/*
DcimSitesListBadRequest describes a response with status code 400, with default header values.
...
// IsSuccess returns true when this dcim sites list bad request response has a 2xx status code
func (o *DcimSitesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim sites list bad request response has a 3xx status code
func (o *DcimSitesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim sites list bad request response has a 4xx status code
func (o *DcimSitesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim sites list bad request response has a 5xx status code
func (o *DcimSitesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim sites list bad request response a status code equal to that given
func (o *DcimSitesListBadRequest) IsCode(code int) bool {
	return code == 400
}
...
func (o *DcimSitesListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/sites/][%d] dcimSitesListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimSitesListBadRequest) GetPayload() interface{} {
	return o.Payload
}
