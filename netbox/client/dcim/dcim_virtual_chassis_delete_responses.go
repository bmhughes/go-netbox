...
func (o *DcimVirtualChassisDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewDcimVirtualChassisDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimVirtualChassisDeleteBadRequest creates a DcimVirtualChassisDeleteBadRequest with default headers values
func NewDcimVirtualChassisDeleteBadRequest() *DcimVirtualChassisDeleteBadRequest {
	return &DcimVirtualChassisDeleteBadRequest{}
}

/*
DcimVirtualChassisDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimVirtualChassisDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim virtual chassis delete bad request response has a 2xx status code
func (o *DcimVirtualChassisDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim virtual chassis delete bad request response has a 3xx status code
func (o *DcimVirtualChassisDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim virtual chassis delete bad request response has a 4xx status code
func (o *DcimVirtualChassisDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim virtual chassis delete bad request response has a 5xx status code
func (o *DcimVirtualChassisDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim virtual chassis delete bad request response a status code equal to that given
func (o *DcimVirtualChassisDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimVirtualChassisDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /dcim/virtual-chassis/{id}/][%d] dcimVirtualChassisDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimVirtualChassisDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /dcim/virtual-chassis/{id}/][%d] dcimVirtualChassisDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *DcimVirtualChassisDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimVirtualChassisDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
