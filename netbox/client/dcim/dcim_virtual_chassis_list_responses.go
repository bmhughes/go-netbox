...
func (o *DcimVirtualChassisListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimVirtualChassisListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimVirtualChassisListBadRequest creates a DcimVirtualChassisListBadRequest with default headers values
func NewDcimVirtualChassisListBadRequest() *DcimVirtualChassisListBadRequest {
	return &DcimVirtualChassisListBadRequest{}
}

/*
DcimVirtualChassisListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimVirtualChassisListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim virtual chassis list bad request response has a 2xx status code
func (o *DcimVirtualChassisListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim virtual chassis list bad request response has a 3xx status code
func (o *DcimVirtualChassisListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim virtual chassis list bad request response has a 4xx status code
func (o *DcimVirtualChassisListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim virtual chassis list bad request response has a 5xx status code
func (o *DcimVirtualChassisListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim virtual chassis list bad request response a status code equal to that given
func (o *DcimVirtualChassisListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimVirtualChassisListBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/virtual-chassis/][%d] dcimVirtualChassisListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimVirtualChassisListBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/virtual-chassis/][%d] dcimVirtualChassisListBadRequest  %+v", 400, o.Payload)
}

func (o *DcimVirtualChassisListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimVirtualChassisListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
