...
func (o *DcimVirtualChassisReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewDcimVirtualChassisReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDcimVirtualChassisReadBadRequest creates a DcimVirtualChassisReadBadRequest with default headers values
func NewDcimVirtualChassisReadBadRequest() *DcimVirtualChassisReadBadRequest {
	return &DcimVirtualChassisReadBadRequest{}
}

/*
DcimVirtualChassisReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type DcimVirtualChassisReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this dcim virtual chassis read bad request response has a 2xx status code
func (o *DcimVirtualChassisReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this dcim virtual chassis read bad request response has a 3xx status code
func (o *DcimVirtualChassisReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this dcim virtual chassis read bad request response has a 4xx status code
func (o *DcimVirtualChassisReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this dcim virtual chassis read bad request response has a 5xx status code
func (o *DcimVirtualChassisReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this dcim virtual chassis read bad request response a status code equal to that given
func (o *DcimVirtualChassisReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *DcimVirtualChassisReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /dcim/virtual-chassis/{id}/][%d] dcimVirtualChassisReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimVirtualChassisReadBadRequest) String() string {
	return fmt.Sprintf("[GET /dcim/virtual-chassis/{id}/][%d] dcimVirtualChassisReadBadRequest  %+v", 400, o.Payload)
}

func (o *DcimVirtualChassisReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *DcimVirtualChassisReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
