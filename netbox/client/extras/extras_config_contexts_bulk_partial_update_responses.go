...
func (o *ExtrasConfigContextsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasConfigContextsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasConfigContextsBulkPartialUpdateBadRequest creates a ExtrasConfigContextsBulkPartialUpdateBadRequest with default headers values
func NewExtrasConfigContextsBulkPartialUpdateBadRequest() *ExtrasConfigContextsBulkPartialUpdateBadRequest {
	return &ExtrasConfigContextsBulkPartialUpdateBadRequest{}
}

/*
ExtrasConfigContextsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasConfigContextsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras config contexts bulk partial update bad request response has a 2xx status code
func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras config contexts bulk partial update bad request response has a 3xx status code
func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras config contexts bulk partial update bad request response has a 4xx status code
func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras config contexts bulk partial update bad request response has a 5xx status code
func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras config contexts bulk partial update bad request response a status code equal to that given
func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /extras/config-contexts/][%d] extrasConfigContextsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /extras/config-contexts/][%d] extrasConfigContextsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasConfigContextsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
