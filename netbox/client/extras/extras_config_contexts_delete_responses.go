...
func (o *ExtrasConfigContextsDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewExtrasConfigContextsDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasConfigContextsDeleteBadRequest creates a ExtrasConfigContextsDeleteBadRequest with default headers values
func NewExtrasConfigContextsDeleteBadRequest() *ExtrasConfigContextsDeleteBadRequest {
	return &ExtrasConfigContextsDeleteBadRequest{}
}

/*
ExtrasConfigContextsDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasConfigContextsDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras config contexts delete bad request response has a 2xx status code
func (o *ExtrasConfigContextsDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras config contexts delete bad request response has a 3xx status code
func (o *ExtrasConfigContextsDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras config contexts delete bad request response has a 4xx status code
func (o *ExtrasConfigContextsDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras config contexts delete bad request response has a 5xx status code
func (o *ExtrasConfigContextsDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras config contexts delete bad request response a status code equal to that given
func (o *ExtrasConfigContextsDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasConfigContextsDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /extras/config-contexts/{id}/][%d] extrasConfigContextsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasConfigContextsDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /extras/config-contexts/{id}/][%d] extrasConfigContextsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasConfigContextsDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}
