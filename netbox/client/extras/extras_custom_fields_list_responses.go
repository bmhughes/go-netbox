...
func (o *ExtrasCustomFieldsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasCustomFieldsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasCustomFieldsListBadRequest creates a ExtrasCustomFieldsListBadRequest with default headers values
func NewExtrasCustomFieldsListBadRequest() *ExtrasCustomFieldsListBadRequest {
	return &ExtrasCustomFieldsListBadRequest{}
}

/*
ExtrasCustomFieldsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasCustomFieldsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras custom fields list bad request response has a 2xx status code
func (o *ExtrasCustomFieldsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras custom fields list bad request response has a 3xx status code
func (o *ExtrasCustomFieldsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras custom fields list bad request response has a 4xx status code
func (o *ExtrasCustomFieldsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras custom fields list bad request response has a 5xx status code
func (o *ExtrasCustomFieldsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras custom fields list bad request response a status code equal to that given
func (o *ExtrasCustomFieldsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasCustomFieldsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/custom-fields/][%d] extrasCustomFieldsListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasCustomFieldsListBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/custom-fields/][%d] extrasCustomFieldsListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasCustomFieldsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasCustomFieldsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
