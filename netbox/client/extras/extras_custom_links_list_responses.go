...
func (o *ExtrasCustomLinksListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasCustomLinksListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasCustomLinksListBadRequest creates a ExtrasCustomLinksListBadRequest with default headers values
func NewExtrasCustomLinksListBadRequest() *ExtrasCustomLinksListBadRequest {
	return &ExtrasCustomLinksListBadRequest{}
}

/*
ExtrasCustomLinksListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasCustomLinksListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras custom links list bad request response has a 2xx status code
func (o *ExtrasCustomLinksListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras custom links list bad request response has a 3xx status code
func (o *ExtrasCustomLinksListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras custom links list bad request response has a 4xx status code
func (o *ExtrasCustomLinksListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras custom links list bad request response has a 5xx status code
func (o *ExtrasCustomLinksListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras custom links list bad request response a status code equal to that given
func (o *ExtrasCustomLinksListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasCustomLinksListBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/custom-links/][%d] extrasCustomLinksListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasCustomLinksListBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/custom-links/][%d] extrasCustomLinksListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasCustomLinksListBadRequest) GetPayload() interface{} {
	return o.Payload
}
