...
func (o *ExtrasCustomLinksPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasCustomLinksPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasCustomLinksPartialUpdateBadRequest creates a ExtrasCustomLinksPartialUpdateBadRequest with default headers values
func NewExtrasCustomLinksPartialUpdateBadRequest() *ExtrasCustomLinksPartialUpdateBadRequest {
	return &ExtrasCustomLinksPartialUpdateBadRequest{}
}

/*
ExtrasCustomLinksPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasCustomLinksPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras custom links partial update bad request response has a 2xx status code
func (o *ExtrasCustomLinksPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras custom links partial update bad request response has a 3xx status code
func (o *ExtrasCustomLinksPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras custom links partial update bad request response has a 4xx status code
func (o *ExtrasCustomLinksPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras custom links partial update bad request response has a 5xx status code
func (o *ExtrasCustomLinksPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras custom links partial update bad request response a status code equal to that given
func (o *ExtrasCustomLinksPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasCustomLinksPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /extras/custom-links/{id}/][%d] extrasCustomLinksPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasCustomLinksPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /extras/custom-links/{id}/][%d] extrasCustomLinksPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasCustomLinksPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasCustomLinksPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
