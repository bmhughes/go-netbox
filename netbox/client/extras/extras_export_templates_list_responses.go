...
func (o *ExtrasExportTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasExportTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasExportTemplatesListBadRequest creates a ExtrasExportTemplatesListBadRequest with default headers values
func NewExtrasExportTemplatesListBadRequest() *ExtrasExportTemplatesListBadRequest {
	return &ExtrasExportTemplatesListBadRequest{}
}

/*
ExtrasExportTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasExportTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras export templates list bad request response has a 2xx status code
func (o *ExtrasExportTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras export templates list bad request response has a 3xx status code
func (o *ExtrasExportTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras export templates list bad request response has a 4xx status code
func (o *ExtrasExportTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras export templates list bad request response has a 5xx status code
func (o *ExtrasExportTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras export templates list bad request response a status code equal to that given
func (o *ExtrasExportTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasExportTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/export-templates/][%d] extrasExportTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasExportTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/export-templates/][%d] extrasExportTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasExportTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasExportTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
