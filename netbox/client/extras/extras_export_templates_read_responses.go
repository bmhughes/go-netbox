...
func (o *ExtrasExportTemplatesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasExportTemplatesReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasExportTemplatesReadBadRequest creates a ExtrasExportTemplatesReadBadRequest with default headers values
func NewExtrasExportTemplatesReadBadRequest() *ExtrasExportTemplatesReadBadRequest {
	return &ExtrasExportTemplatesReadBadRequest{}
}

/*
ExtrasExportTemplatesReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasExportTemplatesReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras export templates read bad request response has a 2xx status code
func (o *ExtrasExportTemplatesReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras export templates read bad request response has a 3xx status code
func (o *ExtrasExportTemplatesReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras export templates read bad request response has a 4xx status code
func (o *ExtrasExportTemplatesReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras export templates read bad request response has a 5xx status code
func (o *ExtrasExportTemplatesReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras export templates read bad request response a status code equal to that given
func (o *ExtrasExportTemplatesReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasExportTemplatesReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/export-templates/{id}/][%d] extrasExportTemplatesReadBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasExportTemplatesReadBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/export-templates/{id}/][%d] extrasExportTemplatesReadBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasExportTemplatesReadBadRequest) GetPayload() interface{} {
	return o.Payload
}
