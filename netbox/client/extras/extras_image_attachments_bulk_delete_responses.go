...
func (o *ExtrasImageAttachmentsBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewExtrasImageAttachmentsBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasImageAttachmentsBulkDeleteBadRequest creates a ExtrasImageAttachmentsBulkDeleteBadRequest with default headers values
func NewExtrasImageAttachmentsBulkDeleteBadRequest() *ExtrasImageAttachmentsBulkDeleteBadRequest {
	return &ExtrasImageAttachmentsBulkDeleteBadRequest{}
}

/*
ExtrasImageAttachmentsBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasImageAttachmentsBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras image attachments bulk delete bad request response has a 2xx status code
func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras image attachments bulk delete bad request response has a 3xx status code
func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras image attachments bulk delete bad request response has a 4xx status code
func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras image attachments bulk delete bad request response has a 5xx status code
func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras image attachments bulk delete bad request response a status code equal to that given
func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /extras/image-attachments/][%d] extrasImageAttachmentsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /extras/image-attachments/][%d] extrasImageAttachmentsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasImageAttachmentsBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
