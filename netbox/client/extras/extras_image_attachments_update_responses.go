...
func (o *ExtrasImageAttachmentsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasImageAttachmentsUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasImageAttachmentsUpdateBadRequest creates a ExtrasImageAttachmentsUpdateBadRequest with default headers values
func NewExtrasImageAttachmentsUpdateBadRequest() *ExtrasImageAttachmentsUpdateBadRequest {
	return &ExtrasImageAttachmentsUpdateBadRequest{}
}

/*
ExtrasImageAttachmentsUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasImageAttachmentsUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras image attachments update bad request response has a 2xx status code
func (o *ExtrasImageAttachmentsUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras image attachments update bad request response has a 3xx status code
func (o *ExtrasImageAttachmentsUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras image attachments update bad request response has a 4xx status code
func (o *ExtrasImageAttachmentsUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras image attachments update bad request response has a 5xx status code
func (o *ExtrasImageAttachmentsUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras image attachments update bad request response a status code equal to that given
func (o *ExtrasImageAttachmentsUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasImageAttachmentsUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /extras/image-attachments/{id}/][%d] extrasImageAttachmentsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasImageAttachmentsUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /extras/image-attachments/{id}/][%d] extrasImageAttachmentsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasImageAttachmentsUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasImageAttachmentsUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
