...
func (o *ExtrasJobResultsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasJobResultsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasJobResultsListBadRequest creates a ExtrasJobResultsListBadRequest with default headers values
func NewExtrasJobResultsListBadRequest() *ExtrasJobResultsListBadRequest {
	return &ExtrasJobResultsListBadRequest{}
}

/*
ExtrasJobResultsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasJobResultsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras job results list bad request response has a 2xx status code
func (o *ExtrasJobResultsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras job results list bad request response has a 3xx status code
func (o *ExtrasJobResultsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras job results list bad request response has a 4xx status code
func (o *ExtrasJobResultsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras job results list bad request response has a 5xx status code
func (o *ExtrasJobResultsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras job results list bad request response a status code equal to that given
func (o *ExtrasJobResultsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasJobResultsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/job-results/][%d] extrasJobResultsListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasJobResultsListBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/job-results/][%d] extrasJobResultsListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasJobResultsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasJobResultsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
