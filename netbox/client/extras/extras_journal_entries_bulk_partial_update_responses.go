...
func (o *ExtrasJournalEntriesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasJournalEntriesBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasJournalEntriesBulkPartialUpdateBadRequest creates a ExtrasJournalEntriesBulkPartialUpdateBadRequest with default headers values
func NewExtrasJournalEntriesBulkPartialUpdateBadRequest() *ExtrasJournalEntriesBulkPartialUpdateBadRequest {
	return &ExtrasJournalEntriesBulkPartialUpdateBadRequest{}
}

/*
ExtrasJournalEntriesBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasJournalEntriesBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras journal entries bulk partial update bad request response has a 2xx status code
func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras journal entries bulk partial update bad request response has a 3xx status code
func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras journal entries bulk partial update bad request response has a 4xx status code
func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras journal entries bulk partial update bad request response has a 5xx status code
func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras journal entries bulk partial update bad request response a status code equal to that given
func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /extras/journal-entries/][%d] extrasJournalEntriesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /extras/journal-entries/][%d] extrasJournalEntriesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasJournalEntriesBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
