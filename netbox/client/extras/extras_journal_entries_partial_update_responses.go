...
func (o *ExtrasJournalEntriesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasJournalEntriesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasJournalEntriesPartialUpdateBadRequest creates a ExtrasJournalEntriesPartialUpdateBadRequest with default headers values
func NewExtrasJournalEntriesPartialUpdateBadRequest() *ExtrasJournalEntriesPartialUpdateBadRequest {
	return &ExtrasJournalEntriesPartialUpdateBadRequest{}
}

/*
ExtrasJournalEntriesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasJournalEntriesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras journal entries partial update bad request response has a 2xx status code
func (o *ExtrasJournalEntriesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras journal entries partial update bad request response has a 3xx status code
func (o *ExtrasJournalEntriesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras journal entries partial update bad request response has a 4xx status code
func (o *ExtrasJournalEntriesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras journal entries partial update bad request response has a 5xx status code
func (o *ExtrasJournalEntriesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras journal entries partial update bad request response a status code equal to that given
func (o *ExtrasJournalEntriesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasJournalEntriesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /extras/journal-entries/{id}/][%d] extrasJournalEntriesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasJournalEntriesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /extras/journal-entries/{id}/][%d] extrasJournalEntriesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasJournalEntriesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasJournalEntriesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
