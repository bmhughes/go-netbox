...
func (o *ExtrasJournalEntriesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasJournalEntriesReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasJournalEntriesReadBadRequest creates a ExtrasJournalEntriesReadBadRequest with default headers values
func NewExtrasJournalEntriesReadBadRequest() *ExtrasJournalEntriesReadBadRequest {
	return &ExtrasJournalEntriesReadBadRequest{}
}

/*
ExtrasJournalEntriesReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasJournalEntriesReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras journal entries read bad request response has a 2xx status code
func (o *ExtrasJournalEntriesReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras journal entries read bad request response has a 3xx status code
func (o *ExtrasJournalEntriesReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras journal entries read bad request response has a 4xx status code
func (o *ExtrasJournalEntriesReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras journal entries read bad request response has a 5xx status code
func (o *ExtrasJournalEntriesReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras journal entries read bad request response a status code equal to that given
func (o *ExtrasJournalEntriesReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasJournalEntriesReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/journal-entries/{id}/][%d] extrasJournalEntriesReadBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasJournalEntriesReadBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/journal-entries/{id}/][%d] extrasJournalEntriesReadBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasJournalEntriesReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasJournalEntriesReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
