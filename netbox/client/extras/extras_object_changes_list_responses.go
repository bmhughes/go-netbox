...
func (o *ExtrasObjectChangesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasObjectChangesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasObjectChangesListBadRequest creates a ExtrasObjectChangesListBadRequest with default headers values
func NewExtrasObjectChangesListBadRequest() *ExtrasObjectChangesListBadRequest {
	return &ExtrasObjectChangesListBadRequest{}
}

/*
ExtrasObjectChangesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasObjectChangesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras object changes list bad request response has a 2xx status code
func (o *ExtrasObjectChangesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras object changes list bad request response has a 3xx status code
func (o *ExtrasObjectChangesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras object changes list bad request response has a 4xx status code
func (o *ExtrasObjectChangesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras object changes list bad request response has a 5xx status code
func (o *ExtrasObjectChangesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras object changes list bad request response a status code equal to that given
func (o *ExtrasObjectChangesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasObjectChangesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/object-changes/][%d] extrasObjectChangesListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasObjectChangesListBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/object-changes/][%d] extrasObjectChangesListBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasObjectChangesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasObjectChangesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
