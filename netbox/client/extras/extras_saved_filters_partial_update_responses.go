...
func (o *ExtrasSavedFiltersPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasSavedFiltersPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasSavedFiltersPartialUpdateBadRequest creates a ExtrasSavedFiltersPartialUpdateBadRequest with default headers values
func NewExtrasSavedFiltersPartialUpdateBadRequest() *ExtrasSavedFiltersPartialUpdateBadRequest {
	return &ExtrasSavedFiltersPartialUpdateBadRequest{}
}

/*
ExtrasSavedFiltersPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasSavedFiltersPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras saved filters partial update bad request response has a 2xx status code
func (o *ExtrasSavedFiltersPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras saved filters partial update bad request response has a 3xx status code
func (o *ExtrasSavedFiltersPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras saved filters partial update bad request response has a 4xx status code
func (o *ExtrasSavedFiltersPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras saved filters partial update bad request response has a 5xx status code
func (o *ExtrasSavedFiltersPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras saved filters partial update bad request response a status code equal to that given
func (o *ExtrasSavedFiltersPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasSavedFiltersPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /extras/saved-filters/{id}/][%d] extrasSavedFiltersPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasSavedFiltersPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /extras/saved-filters/{id}/][%d] extrasSavedFiltersPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasSavedFiltersPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasSavedFiltersPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
