...
func (o *ExtrasScriptsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasScriptsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasScriptsReadBadRequest creates a ExtrasScriptsReadBadRequest with default headers values
func NewExtrasScriptsReadBadRequest() *ExtrasScriptsReadBadRequest {
	return &ExtrasScriptsReadBadRequest{}
}

/*
ExtrasScriptsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasScriptsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras scripts read bad request response has a 2xx status code
func (o *ExtrasScriptsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras scripts read bad request response has a 3xx status code
func (o *ExtrasScriptsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras scripts read bad request response has a 4xx status code
func (o *ExtrasScriptsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras scripts read bad request response has a 5xx status code
func (o *ExtrasScriptsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras scripts read bad request response a status code equal to that given
func (o *ExtrasScriptsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasScriptsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/scripts/{id}/][%d] extrasScriptsReadBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasScriptsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/scripts/{id}/][%d] extrasScriptsReadBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasScriptsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasScriptsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
