...
func (o *ExtrasTagsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasTagsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasTagsPartialUpdateBadRequest creates a ExtrasTagsPartialUpdateBadRequest with default headers values
func NewExtrasTagsPartialUpdateBadRequest() *ExtrasTagsPartialUpdateBadRequest {
	return &ExtrasTagsPartialUpdateBadRequest{}
}

/*
ExtrasTagsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasTagsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras tags partial update bad request response has a 2xx status code
func (o *ExtrasTagsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras tags partial update bad request response has a 3xx status code
func (o *ExtrasTagsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras tags partial update bad request response has a 4xx status code
func (o *ExtrasTagsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras tags partial update bad request response has a 5xx status code
func (o *ExtrasTagsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras tags partial update bad request response a status code equal to that given
func (o *ExtrasTagsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasTagsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /extras/tags/{id}/][%d] extrasTagsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasTagsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /extras/tags/{id}/][%d] extrasTagsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasTagsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasTagsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
