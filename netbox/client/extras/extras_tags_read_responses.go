...
func (o *ExtrasTagsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasTagsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasTagsReadBadRequest creates a ExtrasTagsReadBadRequest with default headers values
func NewExtrasTagsReadBadRequest() *ExtrasTagsReadBadRequest {
	return &ExtrasTagsReadBadRequest{}
}

/*
ExtrasTagsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasTagsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras tags read bad request response has a 2xx status code
func (o *ExtrasTagsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras tags read bad request response has a 3xx status code
func (o *ExtrasTagsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras tags read bad request response has a 4xx status code
func (o *ExtrasTagsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras tags read bad request response has a 5xx status code
func (o *ExtrasTagsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras tags read bad request response a status code equal to that given
func (o *ExtrasTagsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasTagsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /extras/tags/{id}/][%d] extrasTagsReadBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasTagsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /extras/tags/{id}/][%d] extrasTagsReadBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasTagsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasTagsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
