...
func (o *ExtrasWebhooksBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewExtrasWebhooksBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasWebhooksBulkDeleteBadRequest creates a ExtrasWebhooksBulkDeleteBadRequest with default headers values
func NewExtrasWebhooksBulkDeleteBadRequest() *ExtrasWebhooksBulkDeleteBadRequest {
	return &ExtrasWebhooksBulkDeleteBadRequest{}
}

/*
ExtrasWebhooksBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasWebhooksBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras webhooks bulk delete bad request response has a 2xx status code
func (o *ExtrasWebhooksBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras webhooks bulk delete bad request response has a 3xx status code
func (o *ExtrasWebhooksBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras webhooks bulk delete bad request response has a 4xx status code
func (o *ExtrasWebhooksBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras webhooks bulk delete bad request response has a 5xx status code
func (o *ExtrasWebhooksBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras webhooks bulk delete bad request response a status code equal to that given
func (o *ExtrasWebhooksBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasWebhooksBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /extras/webhooks/][%d] extrasWebhooksBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasWebhooksBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /extras/webhooks/][%d] extrasWebhooksBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasWebhooksBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasWebhooksBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
