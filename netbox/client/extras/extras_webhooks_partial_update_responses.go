...
func (o *ExtrasWebhooksPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasWebhooksPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasWebhooksPartialUpdateBadRequest creates a ExtrasWebhooksPartialUpdateBadRequest with default headers values
func NewExtrasWebhooksPartialUpdateBadRequest() *ExtrasWebhooksPartialUpdateBadRequest {
	return &ExtrasWebhooksPartialUpdateBadRequest{}
}

/*
ExtrasWebhooksPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasWebhooksPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras webhooks partial update bad request response has a 2xx status code
func (o *ExtrasWebhooksPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras webhooks partial update bad request response has a 3xx status code
func (o *ExtrasWebhooksPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras webhooks partial update bad request response has a 4xx status code
func (o *ExtrasWebhooksPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras webhooks partial update bad request response has a 5xx status code
func (o *ExtrasWebhooksPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras webhooks partial update bad request response a status code equal to that given
func (o *ExtrasWebhooksPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasWebhooksPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /extras/webhooks/{id}/][%d] extrasWebhooksPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasWebhooksPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /extras/webhooks/{id}/][%d] extrasWebhooksPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasWebhooksPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasWebhooksPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
