...
func (o *ExtrasWebhooksUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewExtrasWebhooksUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExtrasWebhooksUpdateBadRequest creates a ExtrasWebhooksUpdateBadRequest with default headers values
func NewExtrasWebhooksUpdateBadRequest() *ExtrasWebhooksUpdateBadRequest {
	return &ExtrasWebhooksUpdateBadRequest{}
}

/*
ExtrasWebhooksUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type ExtrasWebhooksUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this extras webhooks update bad request response has a 2xx status code
func (o *ExtrasWebhooksUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this extras webhooks update bad request response has a 3xx status code
func (o *ExtrasWebhooksUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this extras webhooks update bad request response has a 4xx status code
func (o *ExtrasWebhooksUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this extras webhooks update bad request response has a 5xx status code
func (o *ExtrasWebhooksUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this extras webhooks update bad request response a status code equal to that given
func (o *ExtrasWebhooksUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *ExtrasWebhooksUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /extras/webhooks/{id}/][%d] extrasWebhooksUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasWebhooksUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /extras/webhooks/{id}/][%d] extrasWebhooksUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *ExtrasWebhooksUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *ExtrasWebhooksUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
