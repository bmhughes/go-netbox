...
func (o *IpamFhrpGroupAssignmentsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamFhrpGroupAssignmentsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamFhrpGroupAssignmentsListBadRequest creates a IpamFhrpGroupAssignmentsListBadRequest with default headers values
func NewIpamFhrpGroupAssignmentsListBadRequest() *IpamFhrpGroupAssignmentsListBadRequest {
	return &IpamFhrpGroupAssignmentsListBadRequest{}
}

/*
IpamFhrpGroupAssignmentsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamFhrpGroupAssignmentsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam fhrp group assignments list bad request response has a 2xx status code
func (o *IpamFhrpGroupAssignmentsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam fhrp group assignments list bad request response has a 3xx status code
func (o *IpamFhrpGroupAssignmentsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam fhrp group assignments list bad request response has a 4xx status code
func (o *IpamFhrpGroupAssignmentsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam fhrp group assignments list bad request response has a 5xx status code
func (o *IpamFhrpGroupAssignmentsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam fhrp group assignments list bad request response a status code equal to that given
func (o *IpamFhrpGroupAssignmentsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamFhrpGroupAssignmentsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/fhrp-group-assignments/][%d] ipamFhrpGroupAssignmentsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamFhrpGroupAssignmentsListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/fhrp-group-assignments/][%d] ipamFhrpGroupAssignmentsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamFhrpGroupAssignmentsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamFhrpGroupAssignmentsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
