...
func (o *IpamFhrpGroupAssignmentsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamFhrpGroupAssignmentsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamFhrpGroupAssignmentsPartialUpdateBadRequest creates a IpamFhrpGroupAssignmentsPartialUpdateBadRequest with default headers values
func NewIpamFhrpGroupAssignmentsPartialUpdateBadRequest() *IpamFhrpGroupAssignmentsPartialUpdateBadRequest {
	return &IpamFhrpGroupAssignmentsPartialUpdateBadRequest{}
}

/*
IpamFhrpGroupAssignmentsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamFhrpGroupAssignmentsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam fhrp group assignments partial update bad request response has a 2xx status code
func (o *IpamFhrpGroupAssignmentsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam fhrp group assignments partial update bad request response has a 3xx status code
func (o *IpamFhrpGroupAssignmentsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam fhrp group assignments partial update bad request response has a 4xx status code
func (o *IpamFhrpGroupAssignmentsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam fhrp group assignments partial update bad request response has a 5xx status code
func (o *IpamFhrpGroupAssignmentsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam fhrp group assignments partial update bad request response a status code equal to that given
func (o *IpamFhrpGroupAssignmentsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamFhrpGroupAssignmentsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /ipam/fhrp-group-assignments/{id}/][%d] ipamFhrpGroupAssignmentsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamFhrpGroupAssignmentsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /ipam/fhrp-group-assignments/{id}/][%d] ipamFhrpGroupAssignmentsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamFhrpGroupAssignmentsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
