...
func (o *IpamFhrpGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamFhrpGroupsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamFhrpGroupsListBadRequest creates a IpamFhrpGroupsListBadRequest with default headers values
func NewIpamFhrpGroupsListBadRequest() *IpamFhrpGroupsListBadRequest {
	return &IpamFhrpGroupsListBadRequest{}
}

/*
IpamFhrpGroupsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamFhrpGroupsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam fhrp groups list bad request response has a 2xx status code
func (o *IpamFhrpGroupsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam fhrp groups list bad request response has a 3xx status code
func (o *IpamFhrpGroupsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam fhrp groups list bad request response has a 4xx status code
func (o *IpamFhrpGroupsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam fhrp groups list bad request response has a 5xx status code
func (o *IpamFhrpGroupsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam fhrp groups list bad request response a status code equal to that given
func (o *IpamFhrpGroupsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamFhrpGroupsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/fhrp-groups/][%d] ipamFhrpGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamFhrpGroupsListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/fhrp-groups/][%d] ipamFhrpGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamFhrpGroupsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamFhrpGroupsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
