...
func (o *IpamFhrpGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamFhrpGroupsUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamFhrpGroupsUpdateBadRequest creates a IpamFhrpGroupsUpdateBadRequest with default headers values
func NewIpamFhrpGroupsUpdateBadRequest() *IpamFhrpGroupsUpdateBadRequest {
	return &IpamFhrpGroupsUpdateBadRequest{}
}

/*
IpamFhrpGroupsUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamFhrpGroupsUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam fhrp groups update bad request response has a 2xx status code
func (o *IpamFhrpGroupsUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam fhrp groups update bad request response has a 3xx status code
func (o *IpamFhrpGroupsUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam fhrp groups update bad request response has a 4xx status code
func (o *IpamFhrpGroupsUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam fhrp groups update bad request response has a 5xx status code
func (o *IpamFhrpGroupsUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam fhrp groups update bad request response a status code equal to that given
func (o *IpamFhrpGroupsUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamFhrpGroupsUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /ipam/fhrp-groups/{id}/][%d] ipamFhrpGroupsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamFhrpGroupsUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /ipam/fhrp-groups/{id}/][%d] ipamFhrpGroupsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamFhrpGroupsUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamFhrpGroupsUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
