...
func (o *IpamIPAddressesBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamIPAddressesBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamIPAddressesBulkPartialUpdateBadRequest creates a IpamIPAddressesBulkPartialUpdateBadRequest with default headers values
func NewIpamIPAddressesBulkPartialUpdateBadRequest() *IpamIPAddressesBulkPartialUpdateBadRequest {
	return &IpamIPAddressesBulkPartialUpdateBadRequest{}
}

/*
IpamIPAddressesBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamIPAddressesBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam Ip addresses bulk partial update bad request response has a 2xx status code
func (o *IpamIPAddressesBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam Ip addresses bulk partial update bad request response has a 3xx status code
func (o *IpamIPAddressesBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam Ip addresses bulk partial update bad request response has a 4xx status code
func (o *IpamIPAddressesBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam Ip addresses bulk partial update bad request response has a 5xx status code
func (o *IpamIPAddressesBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam Ip addresses bulk partial update bad request response a status code equal to that given
func (o *IpamIPAddressesBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamIPAddressesBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /ipam/ip-addresses/][%d] ipamIpAddressesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamIPAddressesBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /ipam/ip-addresses/][%d] ipamIpAddressesBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamIPAddressesBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamIPAddressesBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
