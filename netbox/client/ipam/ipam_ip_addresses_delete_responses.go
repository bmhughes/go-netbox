...
func (o *IpamIPAddressesDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewIpamIPAddressesDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamIPAddressesDeleteBadRequest creates a IpamIPAddressesDeleteBadRequest with default headers values
func NewIpamIPAddressesDeleteBadRequest() *IpamIPAddressesDeleteBadRequest {
	return &IpamIPAddressesDeleteBadRequest{}
}

/*
IpamIPAddressesDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamIPAddressesDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam Ip addresses delete bad request response has a 2xx status code
func (o *IpamIPAddressesDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam Ip addresses delete bad request response has a 3xx status code
func (o *IpamIPAddressesDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam Ip addresses delete bad request response has a 4xx status code
func (o *IpamIPAddressesDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam Ip addresses delete bad request response has a 5xx status code
func (o *IpamIPAddressesDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam Ip addresses delete bad request response a status code equal to that given
func (o *IpamIPAddressesDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamIPAddressesDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /ipam/ip-addresses/{id}/][%d] ipamIpAddressesDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *IpamIPAddressesDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /ipam/ip-addresses/{id}/][%d] ipamIpAddressesDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *IpamIPAddressesDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamIPAddressesDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
