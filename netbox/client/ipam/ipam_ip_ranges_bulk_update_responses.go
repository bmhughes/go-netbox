...
func (o *IpamIPRangesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamIPRangesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamIPRangesBulkUpdateBadRequest creates a IpamIPRangesBulkUpdateBadRequest with default headers values
func NewIpamIPRangesBulkUpdateBadRequest() *IpamIPRangesBulkUpdateBadRequest {
	return &IpamIPRangesBulkUpdateBadRequest{}
}

/*
IpamIPRangesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamIPRangesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam Ip ranges bulk update bad request response has a 2xx status code
func (o *IpamIPRangesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam Ip ranges bulk update bad request response has a 3xx status code
func (o *IpamIPRangesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam Ip ranges bulk update bad request response has a 4xx status code
func (o *IpamIPRangesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam Ip ranges bulk update bad request response has a 5xx status code
func (o *IpamIPRangesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam Ip ranges bulk update bad request response a status code equal to that given
func (o *IpamIPRangesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamIPRangesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /ipam/ip-ranges/][%d] ipamIpRangesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamIPRangesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /ipam/ip-ranges/][%d] ipamIpRangesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamIPRangesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
