...
func (o *IpamL2vpnTerminationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamL2vpnTerminationsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamL2vpnTerminationsListBadRequest creates a IpamL2vpnTerminationsListBadRequest with default headers values
func NewIpamL2vpnTerminationsListBadRequest() *IpamL2vpnTerminationsListBadRequest {
	return &IpamL2vpnTerminationsListBadRequest{}
}

/*
IpamL2vpnTerminationsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamL2vpnTerminationsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam l2vpn terminations list bad request response has a 2xx status code
func (o *IpamL2vpnTerminationsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam l2vpn terminations list bad request response has a 3xx status code
func (o *IpamL2vpnTerminationsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam l2vpn terminations list bad request response has a 4xx status code
func (o *IpamL2vpnTerminationsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam l2vpn terminations list bad request response has a 5xx status code
func (o *IpamL2vpnTerminationsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam l2vpn terminations list bad request response a status code equal to that given
func (o *IpamL2vpnTerminationsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamL2vpnTerminationsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/l2vpn-terminations/][%d] ipamL2vpnTerminationsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamL2vpnTerminationsListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/l2vpn-terminations/][%d] ipamL2vpnTerminationsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamL2vpnTerminationsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamL2vpnTerminationsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
