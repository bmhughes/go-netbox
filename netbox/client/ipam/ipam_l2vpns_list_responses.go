...
func (o *IpamL2vpnsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamL2vpnsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamL2vpnsListBadRequest creates a IpamL2vpnsListBadRequest with default headers values
func NewIpamL2vpnsListBadRequest() *IpamL2vpnsListBadRequest {
	return &IpamL2vpnsListBadRequest{}
}

/*
IpamL2vpnsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamL2vpnsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam l2vpns list bad request response has a 2xx status code
func (o *IpamL2vpnsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam l2vpns list bad request response has a 3xx status code
func (o *IpamL2vpnsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam l2vpns list bad request response has a 4xx status code
func (o *IpamL2vpnsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam l2vpns list bad request response has a 5xx status code
func (o *IpamL2vpnsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam l2vpns list bad request response a status code equal to that given
func (o *IpamL2vpnsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamL2vpnsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/l2vpns/][%d] ipamL2vpnsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamL2vpnsListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/l2vpns/][%d] ipamL2vpnsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamL2vpnsListBadRequest) GetPayload() interface{} {
	return o.Payload
}
