...
/*
IpamPrefixesAvailableIpsCreateBadRequest describes a response with status code 400, with default header values.
...
// IsSuccess returns true when this ipam prefixes available ips create bad request response has a 2xx status code
func (o *IpamPrefixesAvailableIpsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam prefixes available ips create bad request response has a 3xx status code
func (o *IpamPrefixesAvailableIpsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam prefixes available ips create bad request response has a 4xx status code
func (o *IpamPrefixesAvailableIpsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam prefixes available ips create bad request response has a 5xx status code
func (o *IpamPrefixesAvailableIpsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam prefixes available ips create bad request response a status code equal to that given
func (o *IpamPrefixesAvailableIpsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}
...
func (o *IpamPrefixesAvailableIpsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /ipam/prefixes/{id}/available-ips/][%d] ipamPrefixesAvailableIpsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamPrefixesAvailableIpsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}
