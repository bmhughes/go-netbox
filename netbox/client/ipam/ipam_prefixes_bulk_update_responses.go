...
func (o *IpamPrefixesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamPrefixesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamPrefixesBulkUpdateBadRequest creates a IpamPrefixesBulkUpdateBadRequest with default headers values
func NewIpamPrefixesBulkUpdateBadRequest() *IpamPrefixesBulkUpdateBadRequest {
	return &IpamPrefixesBulkUpdateBadRequest{}
}

/*
IpamPrefixesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamPrefixesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam prefixes bulk update bad request response has a 2xx status code
func (o *IpamPrefixesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam prefixes bulk update bad request response has a 3xx status code
func (o *IpamPrefixesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam prefixes bulk update bad request response has a 4xx status code
func (o *IpamPrefixesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam prefixes bulk update bad request response has a 5xx status code
func (o *IpamPrefixesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam prefixes bulk update bad request response a status code equal to that given
func (o *IpamPrefixesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamPrefixesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /ipam/prefixes/][%d] ipamPrefixesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamPrefixesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /ipam/prefixes/][%d] ipamPrefixesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamPrefixesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamPrefixesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
