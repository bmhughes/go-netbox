...
func (o *IpamPrefixesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamPrefixesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamPrefixesListBadRequest creates a IpamPrefixesListBadRequest with default headers values
func NewIpamPrefixesListBadRequest() *IpamPrefixesListBadRequest {
	return &IpamPrefixesListBadRequest{}
}

/*
IpamPrefixesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamPrefixesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam prefixes list bad request response has a 2xx status code
func (o *IpamPrefixesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam prefixes list bad request response has a 3xx status code
func (o *IpamPrefixesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam prefixes list bad request response has a 4xx status code
func (o *IpamPrefixesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam prefixes list bad request response has a 5xx status code
func (o *IpamPrefixesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam prefixes list bad request response a status code equal to that given
func (o *IpamPrefixesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamPrefixesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/prefixes/][%d] ipamPrefixesListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamPrefixesListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/prefixes/][%d] ipamPrefixesListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamPrefixesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamPrefixesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
