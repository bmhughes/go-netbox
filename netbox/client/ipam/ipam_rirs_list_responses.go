...
func (o *IpamRirsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamRirsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamRirsListBadRequest creates a IpamRirsListBadRequest with default headers values
func NewIpamRirsListBadRequest() *IpamRirsListBadRequest {
	return &IpamRirsListBadRequest{}
}

/*
IpamRirsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamRirsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam rirs list bad request response has a 2xx status code
func (o *IpamRirsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam rirs list bad request response has a 3xx status code
func (o *IpamRirsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam rirs list bad request response has a 4xx status code
func (o *IpamRirsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam rirs list bad request response has a 5xx status code
func (o *IpamRirsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam rirs list bad request response a status code equal to that given
func (o *IpamRirsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamRirsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/rirs/][%d] ipamRirsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRirsListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/rirs/][%d] ipamRirsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRirsListBadRequest) GetPayload() interface{} {
	return o.Payload
}
