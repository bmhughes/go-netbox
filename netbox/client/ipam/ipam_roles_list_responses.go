...
func (o *IpamRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamRolesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamRolesListBadRequest creates a IpamRolesListBadRequest with default headers values
func NewIpamRolesListBadRequest() *IpamRolesListBadRequest {
	return &IpamRolesListBadRequest{}
}

/*
IpamRolesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamRolesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam roles list bad request response has a 2xx status code
func (o *IpamRolesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam roles list bad request response has a 3xx status code
func (o *IpamRolesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam roles list bad request response has a 4xx status code
func (o *IpamRolesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam roles list bad request response has a 5xx status code
func (o *IpamRolesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam roles list bad request response a status code equal to that given
func (o *IpamRolesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamRolesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/roles/][%d] ipamRolesListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRolesListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/roles/][%d] ipamRolesListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRolesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamRolesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
