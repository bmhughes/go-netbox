...
func (o *IpamRolesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamRolesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamRolesPartialUpdateBadRequest creates a IpamRolesPartialUpdateBadRequest with default headers values
func NewIpamRolesPartialUpdateBadRequest() *IpamRolesPartialUpdateBadRequest {
	return &IpamRolesPartialUpdateBadRequest{}
}

/*
IpamRolesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamRolesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam roles partial update bad request response has a 2xx status code
func (o *IpamRolesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam roles partial update bad request response has a 3xx status code
func (o *IpamRolesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam roles partial update bad request response has a 4xx status code
func (o *IpamRolesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam roles partial update bad request response has a 5xx status code
func (o *IpamRolesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam roles partial update bad request response a status code equal to that given
func (o *IpamRolesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamRolesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /ipam/roles/{id}/][%d] ipamRolesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRolesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /ipam/roles/{id}/][%d] ipamRolesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRolesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamRolesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
