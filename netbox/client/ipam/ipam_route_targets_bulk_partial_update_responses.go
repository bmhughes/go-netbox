...
func (o *IpamRouteTargetsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamRouteTargetsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamRouteTargetsBulkPartialUpdateBadRequest creates a IpamRouteTargetsBulkPartialUpdateBadRequest with default headers values
func NewIpamRouteTargetsBulkPartialUpdateBadRequest() *IpamRouteTargetsBulkPartialUpdateBadRequest {
	return &IpamRouteTargetsBulkPartialUpdateBadRequest{}
}

/*
IpamRouteTargetsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamRouteTargetsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam route targets bulk partial update bad request response has a 2xx status code
func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam route targets bulk partial update bad request response has a 3xx status code
func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam route targets bulk partial update bad request response has a 4xx status code
func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam route targets bulk partial update bad request response has a 5xx status code
func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam route targets bulk partial update bad request response a status code equal to that given
func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /ipam/route-targets/][%d] ipamRouteTargetsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /ipam/route-targets/][%d] ipamRouteTargetsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamRouteTargetsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
