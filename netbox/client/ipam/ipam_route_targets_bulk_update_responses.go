...
func (o *IpamRouteTargetsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamRouteTargetsBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamRouteTargetsBulkUpdateBadRequest creates a IpamRouteTargetsBulkUpdateBadRequest with default headers values
func NewIpamRouteTargetsBulkUpdateBadRequest() *IpamRouteTargetsBulkUpdateBadRequest {
	return &IpamRouteTargetsBulkUpdateBadRequest{}
}

/*
IpamRouteTargetsBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamRouteTargetsBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam route targets bulk update bad request response has a 2xx status code
func (o *IpamRouteTargetsBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam route targets bulk update bad request response has a 3xx status code
func (o *IpamRouteTargetsBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam route targets bulk update bad request response has a 4xx status code
func (o *IpamRouteTargetsBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam route targets bulk update bad request response has a 5xx status code
func (o *IpamRouteTargetsBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam route targets bulk update bad request response a status code equal to that given
func (o *IpamRouteTargetsBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamRouteTargetsBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /ipam/route-targets/][%d] ipamRouteTargetsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRouteTargetsBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /ipam/route-targets/][%d] ipamRouteTargetsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRouteTargetsBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamRouteTargetsBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
