...
func (o *IpamRouteTargetsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamRouteTargetsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamRouteTargetsListBadRequest creates a IpamRouteTargetsListBadRequest with default headers values
func NewIpamRouteTargetsListBadRequest() *IpamRouteTargetsListBadRequest {
	return &IpamRouteTargetsListBadRequest{}
}

/*
IpamRouteTargetsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamRouteTargetsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam route targets list bad request response has a 2xx status code
func (o *IpamRouteTargetsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam route targets list bad request response has a 3xx status code
func (o *IpamRouteTargetsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam route targets list bad request response has a 4xx status code
func (o *IpamRouteTargetsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam route targets list bad request response has a 5xx status code
func (o *IpamRouteTargetsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam route targets list bad request response a status code equal to that given
func (o *IpamRouteTargetsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamRouteTargetsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/route-targets/][%d] ipamRouteTargetsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRouteTargetsListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/route-targets/][%d] ipamRouteTargetsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamRouteTargetsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamRouteTargetsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
