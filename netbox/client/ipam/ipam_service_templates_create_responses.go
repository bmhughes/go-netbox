...
func (o *IpamServiceTemplatesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewIpamServiceTemplatesCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamServiceTemplatesCreateBadRequest creates a IpamServiceTemplatesCreateBadRequest with default headers values
func NewIpamServiceTemplatesCreateBadRequest() *IpamServiceTemplatesCreateBadRequest {
	return &IpamServiceTemplatesCreateBadRequest{}
}

/*
IpamServiceTemplatesCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamServiceTemplatesCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam service templates create bad request response has a 2xx status code
func (o *IpamServiceTemplatesCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam service templates create bad request response has a 3xx status code
func (o *IpamServiceTemplatesCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam service templates create bad request response has a 4xx status code
func (o *IpamServiceTemplatesCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam service templates create bad request response has a 5xx status code
func (o *IpamServiceTemplatesCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam service templates create bad request response a status code equal to that given
func (o *IpamServiceTemplatesCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamServiceTemplatesCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /ipam/service-templates/][%d] ipamServiceTemplatesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /ipam/service-templates/][%d] ipamServiceTemplatesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamServiceTemplatesCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
