...
func (o *IpamServiceTemplatesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamServiceTemplatesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamServiceTemplatesListBadRequest creates a IpamServiceTemplatesListBadRequest with default headers values
func NewIpamServiceTemplatesListBadRequest() *IpamServiceTemplatesListBadRequest {
	return &IpamServiceTemplatesListBadRequest{}
}

/*
IpamServiceTemplatesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamServiceTemplatesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam service templates list bad request response has a 2xx status code
func (o *IpamServiceTemplatesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam service templates list bad request response has a 3xx status code
func (o *IpamServiceTemplatesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam service templates list bad request response has a 4xx status code
func (o *IpamServiceTemplatesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam service templates list bad request response has a 5xx status code
func (o *IpamServiceTemplatesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam service templates list bad request response a status code equal to that given
func (o *IpamServiceTemplatesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamServiceTemplatesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/service-templates/][%d] ipamServiceTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/service-templates/][%d] ipamServiceTemplatesListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamServiceTemplatesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
