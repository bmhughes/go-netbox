...
func (o *IpamServiceTemplatesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamServiceTemplatesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamServiceTemplatesPartialUpdateBadRequest creates a IpamServiceTemplatesPartialUpdateBadRequest with default headers values
func NewIpamServiceTemplatesPartialUpdateBadRequest() *IpamServiceTemplatesPartialUpdateBadRequest {
	return &IpamServiceTemplatesPartialUpdateBadRequest{}
}

/*
IpamServiceTemplatesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamServiceTemplatesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam service templates partial update bad request response has a 2xx status code
func (o *IpamServiceTemplatesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam service templates partial update bad request response has a 3xx status code
func (o *IpamServiceTemplatesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam service templates partial update bad request response has a 4xx status code
func (o *IpamServiceTemplatesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam service templates partial update bad request response has a 5xx status code
func (o *IpamServiceTemplatesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam service templates partial update bad request response a status code equal to that given
func (o *IpamServiceTemplatesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamServiceTemplatesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /ipam/service-templates/{id}/][%d] ipamServiceTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /ipam/service-templates/{id}/][%d] ipamServiceTemplatesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamServiceTemplatesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
