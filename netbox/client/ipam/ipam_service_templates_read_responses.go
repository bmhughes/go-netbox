...
func (o *IpamServiceTemplatesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamServiceTemplatesReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamServiceTemplatesReadBadRequest creates a IpamServiceTemplatesReadBadRequest with default headers values
func NewIpamServiceTemplatesReadBadRequest() *IpamServiceTemplatesReadBadRequest {
	return &IpamServiceTemplatesReadBadRequest{}
}

/*
IpamServiceTemplatesReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamServiceTemplatesReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam service templates read bad request response has a 2xx status code
func (o *IpamServiceTemplatesReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam service templates read bad request response has a 3xx status code
func (o *IpamServiceTemplatesReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam service templates read bad request response has a 4xx status code
func (o *IpamServiceTemplatesReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam service templates read bad request response has a 5xx status code
func (o *IpamServiceTemplatesReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam service templates read bad request response a status code equal to that given
func (o *IpamServiceTemplatesReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamServiceTemplatesReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/service-templates/{id}/][%d] ipamServiceTemplatesReadBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesReadBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/service-templates/{id}/][%d] ipamServiceTemplatesReadBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamServiceTemplatesReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
