...
func (o *IpamServiceTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamServiceTemplatesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamServiceTemplatesUpdateBadRequest creates a IpamServiceTemplatesUpdateBadRequest with default headers values
func NewIpamServiceTemplatesUpdateBadRequest() *IpamServiceTemplatesUpdateBadRequest {
	return &IpamServiceTemplatesUpdateBadRequest{}
}

/*
IpamServiceTemplatesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamServiceTemplatesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam service templates update bad request response has a 2xx status code
func (o *IpamServiceTemplatesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam service templates update bad request response has a 3xx status code
func (o *IpamServiceTemplatesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam service templates update bad request response has a 4xx status code
func (o *IpamServiceTemplatesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam service templates update bad request response has a 5xx status code
func (o *IpamServiceTemplatesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam service templates update bad request response a status code equal to that given
func (o *IpamServiceTemplatesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamServiceTemplatesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /ipam/service-templates/{id}/][%d] ipamServiceTemplatesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /ipam/service-templates/{id}/][%d] ipamServiceTemplatesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServiceTemplatesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamServiceTemplatesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
