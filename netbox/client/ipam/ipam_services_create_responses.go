...
func (o *IpamServicesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewIpamServicesCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamServicesCreateBadRequest creates a IpamServicesCreateBadRequest with default headers values
func NewIpamServicesCreateBadRequest() *IpamServicesCreateBadRequest {
	return &IpamServicesCreateBadRequest{}
}

/*
IpamServicesCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamServicesCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam services create bad request response has a 2xx status code
func (o *IpamServicesCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam services create bad request response has a 3xx status code
func (o *IpamServicesCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam services create bad request response has a 4xx status code
func (o *IpamServicesCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam services create bad request response has a 5xx status code
func (o *IpamServicesCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam services create bad request response a status code equal to that given
func (o *IpamServicesCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamServicesCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /ipam/services/][%d] ipamServicesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServicesCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /ipam/services/][%d] ipamServicesCreateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServicesCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamServicesCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
