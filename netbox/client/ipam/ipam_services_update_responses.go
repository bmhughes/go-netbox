...
func (o *IpamServicesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamServicesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamServicesUpdateBadRequest creates a IpamServicesUpdateBadRequest with default headers values
func NewIpamServicesUpdateBadRequest() *IpamServicesUpdateBadRequest {
	return &IpamServicesUpdateBadRequest{}
}

/*
IpamServicesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamServicesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam services update bad request response has a 2xx status code
func (o *IpamServicesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam services update bad request response has a 3xx status code
func (o *IpamServicesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam services update bad request response has a 4xx status code
func (o *IpamServicesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam services update bad request response has a 5xx status code
func (o *IpamServicesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam services update bad request response a status code equal to that given
func (o *IpamServicesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamServicesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /ipam/services/{id}/][%d] ipamServicesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServicesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /ipam/services/{id}/][%d] ipamServicesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamServicesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamServicesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
