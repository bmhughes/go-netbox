...
func (o *IpamVlanGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamVlanGroupsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamVlanGroupsListBadRequest creates a IpamVlanGroupsListBadRequest with default headers values
func NewIpamVlanGroupsListBadRequest() *IpamVlanGroupsListBadRequest {
	return &IpamVlanGroupsListBadRequest{}
}

/*
IpamVlanGroupsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamVlanGroupsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam vlan groups list bad request response has a 2xx status code
func (o *IpamVlanGroupsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam vlan groups list bad request response has a 3xx status code
func (o *IpamVlanGroupsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam vlan groups list bad request response has a 4xx status code
func (o *IpamVlanGroupsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam vlan groups list bad request response has a 5xx status code
func (o *IpamVlanGroupsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam vlan groups list bad request response a status code equal to that given
func (o *IpamVlanGroupsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamVlanGroupsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/vlan-groups/][%d] ipamVlanGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVlanGroupsListBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/vlan-groups/][%d] ipamVlanGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVlanGroupsListBadRequest) GetPayload() interface{} {
	return o.Payload
}
