...
func (o *IpamVlanGroupsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamVlanGroupsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamVlanGroupsReadBadRequest creates a IpamVlanGroupsReadBadRequest with default headers values
func NewIpamVlanGroupsReadBadRequest() *IpamVlanGroupsReadBadRequest {
	return &IpamVlanGroupsReadBadRequest{}
}

/*
IpamVlanGroupsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamVlanGroupsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam vlan groups read bad request response has a 2xx status code
func (o *IpamVlanGroupsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam vlan groups read bad request response has a 3xx status code
func (o *IpamVlanGroupsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam vlan groups read bad request response has a 4xx status code
func (o *IpamVlanGroupsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam vlan groups read bad request response has a 5xx status code
func (o *IpamVlanGroupsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam vlan groups read bad request response a status code equal to that given
func (o *IpamVlanGroupsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamVlanGroupsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /ipam/vlan-groups/{id}/][%d] ipamVlanGroupsReadBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVlanGroupsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /ipam/vlan-groups/{id}/][%d] ipamVlanGroupsReadBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVlanGroupsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamVlanGroupsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
