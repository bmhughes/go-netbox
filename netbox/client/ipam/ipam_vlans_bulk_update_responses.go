...
func (o *IpamVlansBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewIpamVlansBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamVlansBulkUpdateBadRequest creates a IpamVlansBulkUpdateBadRequest with default headers values
func NewIpamVlansBulkUpdateBadRequest() *IpamVlansBulkUpdateBadRequest {
	return &IpamVlansBulkUpdateBadRequest{}
}

/*
IpamVlansBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamVlansBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam vlans bulk update bad request response has a 2xx status code
func (o *IpamVlansBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam vlans bulk update bad request response has a 3xx status code
func (o *IpamVlansBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam vlans bulk update bad request response has a 4xx status code
func (o *IpamVlansBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam vlans bulk update bad request response has a 5xx status code
func (o *IpamVlansBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam vlans bulk update bad request response a status code equal to that given
func (o *IpamVlansBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamVlansBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /ipam/vlans/][%d] ipamVlansBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVlansBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /ipam/vlans/][%d] ipamVlansBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVlansBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamVlansBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
