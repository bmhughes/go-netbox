...
func (o *IpamVlansDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewIpamVlansDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamVlansDeleteBadRequest creates a IpamVlansDeleteBadRequest with default headers values
func NewIpamVlansDeleteBadRequest() *IpamVlansDeleteBadRequest {
	return &IpamVlansDeleteBadRequest{}
}

/*
IpamVlansDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamVlansDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam vlans delete bad request response has a 2xx status code
func (o *IpamVlansDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam vlans delete bad request response has a 3xx status code
func (o *IpamVlansDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam vlans delete bad request response has a 4xx status code
func (o *IpamVlansDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam vlans delete bad request response has a 5xx status code
func (o *IpamVlansDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam vlans delete bad request response a status code equal to that given
func (o *IpamVlansDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamVlansDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /ipam/vlans/{id}/][%d] ipamVlansDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVlansDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /ipam/vlans/{id}/][%d] ipamVlansDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVlansDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamVlansDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
