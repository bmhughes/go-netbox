...
func (o *IpamVrfsBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewIpamVrfsBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamVrfsBulkDeleteBadRequest creates a IpamVrfsBulkDeleteBadRequest with default headers values
func NewIpamVrfsBulkDeleteBadRequest() *IpamVrfsBulkDeleteBadRequest {
	return &IpamVrfsBulkDeleteBadRequest{}
}

/*
IpamVrfsBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamVrfsBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam vrfs bulk delete bad request response has a 2xx status code
func (o *IpamVrfsBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam vrfs bulk delete bad request response has a 3xx status code
func (o *IpamVrfsBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam vrfs bulk delete bad request response has a 4xx status code
func (o *IpamVrfsBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam vrfs bulk delete bad request response has a 5xx status code
func (o *IpamVrfsBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam vrfs bulk delete bad request response a status code equal to that given
func (o *IpamVrfsBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamVrfsBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /ipam/vrfs/][%d] ipamVrfsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVrfsBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /ipam/vrfs/][%d] ipamVrfsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVrfsBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamVrfsBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
