...
func (o *IpamVrfsDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewIpamVrfsDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIpamVrfsDeleteBadRequest creates a IpamVrfsDeleteBadRequest with default headers values
func NewIpamVrfsDeleteBadRequest() *IpamVrfsDeleteBadRequest {
	return &IpamVrfsDeleteBadRequest{}
}

/*
IpamVrfsDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type IpamVrfsDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this ipam vrfs delete bad request response has a 2xx status code
func (o *IpamVrfsDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ipam vrfs delete bad request response has a 3xx status code
func (o *IpamVrfsDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ipam vrfs delete bad request response has a 4xx status code
func (o *IpamVrfsDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this ipam vrfs delete bad request response has a 5xx status code
func (o *IpamVrfsDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this ipam vrfs delete bad request response a status code equal to that given
func (o *IpamVrfsDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *IpamVrfsDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /ipam/vrfs/{id}/][%d] ipamVrfsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVrfsDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /ipam/vrfs/{id}/][%d] ipamVrfsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *IpamVrfsDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *IpamVrfsDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
