...
func (o *TenancyContactAssignmentsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyContactAssignmentsBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactAssignmentsBulkUpdateBadRequest creates a TenancyContactAssignmentsBulkUpdateBadRequest with default headers values
func NewTenancyContactAssignmentsBulkUpdateBadRequest() *TenancyContactAssignmentsBulkUpdateBadRequest {
	return &TenancyContactAssignmentsBulkUpdateBadRequest{}
}

/*
TenancyContactAssignmentsBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactAssignmentsBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contact assignments bulk update bad request response has a 2xx status code
func (o *TenancyContactAssignmentsBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contact assignments bulk update bad request response has a 3xx status code
func (o *TenancyContactAssignmentsBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contact assignments bulk update bad request response has a 4xx status code
func (o *TenancyContactAssignmentsBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contact assignments bulk update bad request response has a 5xx status code
func (o *TenancyContactAssignmentsBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contact assignments bulk update bad request response a status code equal to that given
func (o *TenancyContactAssignmentsBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactAssignmentsBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /tenancy/contact-assignments/][%d] tenancyContactAssignmentsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactAssignmentsBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /tenancy/contact-assignments/][%d] tenancyContactAssignmentsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactAssignmentsBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactAssignmentsBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
