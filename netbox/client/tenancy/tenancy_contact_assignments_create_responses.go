...
func (o *TenancyContactAssignmentsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewTenancyContactAssignmentsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactAssignmentsCreateBadRequest creates a TenancyContactAssignmentsCreateBadRequest with default headers values
func NewTenancyContactAssignmentsCreateBadRequest() *TenancyContactAssignmentsCreateBadRequest {
	return &TenancyContactAssignmentsCreateBadRequest{}
}

/*
TenancyContactAssignmentsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactAssignmentsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contact assignments create bad request response has a 2xx status code
func (o *TenancyContactAssignmentsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contact assignments create bad request response has a 3xx status code
func (o *TenancyContactAssignmentsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contact assignments create bad request response has a 4xx status code
func (o *TenancyContactAssignmentsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contact assignments create bad request response has a 5xx status code
func (o *TenancyContactAssignmentsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contact assignments create bad request response a status code equal to that given
func (o *TenancyContactAssignmentsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactAssignmentsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /tenancy/contact-assignments/][%d] tenancyContactAssignmentsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactAssignmentsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /tenancy/contact-assignments/][%d] tenancyContactAssignmentsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactAssignmentsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactAssignmentsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
