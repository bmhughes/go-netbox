...
func (o *TenancyContactAssignmentsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyContactAssignmentsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactAssignmentsPartialUpdateBadRequest creates a TenancyContactAssignmentsPartialUpdateBadRequest with default headers values
func NewTenancyContactAssignmentsPartialUpdateBadRequest() *TenancyContactAssignmentsPartialUpdateBadRequest {
	return &TenancyContactAssignmentsPartialUpdateBadRequest{}
}

/*
TenancyContactAssignmentsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactAssignmentsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contact assignments partial update bad request response has a 2xx status code
func (o *TenancyContactAssignmentsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contact assignments partial update bad request response has a 3xx status code
func (o *TenancyContactAssignmentsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contact assignments partial update bad request response has a 4xx status code
func (o *TenancyContactAssignmentsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contact assignments partial update bad request response has a 5xx status code
func (o *TenancyContactAssignmentsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contact assignments partial update bad request response a status code equal to that given
func (o *TenancyContactAssignmentsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactAssignmentsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /tenancy/contact-assignments/{id}/][%d] tenancyContactAssignmentsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactAssignmentsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /tenancy/contact-assignments/{id}/][%d] tenancyContactAssignmentsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactAssignmentsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
