...
func (o *TenancyContactAssignmentsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyContactAssignmentsUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactAssignmentsUpdateBadRequest creates a TenancyContactAssignmentsUpdateBadRequest with default headers values
func NewTenancyContactAssignmentsUpdateBadRequest() *TenancyContactAssignmentsUpdateBadRequest {
	return &TenancyContactAssignmentsUpdateBadRequest{}
}

/*
TenancyContactAssignmentsUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactAssignmentsUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contact assignments update bad request response has a 2xx status code
func (o *TenancyContactAssignmentsUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contact assignments update bad request response has a 3xx status code
func (o *TenancyContactAssignmentsUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contact assignments update bad request response has a 4xx status code
func (o *TenancyContactAssignmentsUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contact assignments update bad request response has a 5xx status code
func (o *TenancyContactAssignmentsUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contact assignments update bad request response a status code equal to that given
func (o *TenancyContactAssignmentsUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactAssignmentsUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /tenancy/contact-assignments/{id}/][%d] tenancyContactAssignmentsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactAssignmentsUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /tenancy/contact-assignments/{id}/][%d] tenancyContactAssignmentsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactAssignmentsUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactAssignmentsUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
