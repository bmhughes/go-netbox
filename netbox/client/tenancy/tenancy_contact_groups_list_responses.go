...
func (o *TenancyContactGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyContactGroupsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactGroupsListBadRequest creates a TenancyContactGroupsListBadRequest with default headers values
func NewTenancyContactGroupsListBadRequest() *TenancyContactGroupsListBadRequest {
	return &TenancyContactGroupsListBadRequest{}
}

/*
TenancyContactGroupsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactGroupsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contact groups list bad request response has a 2xx status code
func (o *TenancyContactGroupsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contact groups list bad request response has a 3xx status code
func (o *TenancyContactGroupsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contact groups list bad request response has a 4xx status code
func (o *TenancyContactGroupsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contact groups list bad request response has a 5xx status code
func (o *TenancyContactGroupsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contact groups list bad request response a status code equal to that given
func (o *TenancyContactGroupsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactGroupsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /tenancy/contact-groups/][%d] tenancyContactGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactGroupsListBadRequest) String() string {
	return fmt.Sprintf("[GET /tenancy/contact-groups/][%d] tenancyContactGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactGroupsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactGroupsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
