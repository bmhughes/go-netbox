...
func (o *TenancyContactRolesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyContactRolesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactRolesBulkUpdateBadRequest creates a TenancyContactRolesBulkUpdateBadRequest with default headers values
func NewTenancyContactRolesBulkUpdateBadRequest() *TenancyContactRolesBulkUpdateBadRequest {
	return &TenancyContactRolesBulkUpdateBadRequest{}
}

/*
TenancyContactRolesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactRolesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contact roles bulk update bad request response has a 2xx status code
func (o *TenancyContactRolesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contact roles bulk update bad request response has a 3xx status code
func (o *TenancyContactRolesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contact roles bulk update bad request response has a 4xx status code
func (o *TenancyContactRolesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contact roles bulk update bad request response has a 5xx status code
func (o *TenancyContactRolesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contact roles bulk update bad request response a status code equal to that given
func (o *TenancyContactRolesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactRolesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /tenancy/contact-roles/][%d] tenancyContactRolesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactRolesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /tenancy/contact-roles/][%d] tenancyContactRolesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactRolesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactRolesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
