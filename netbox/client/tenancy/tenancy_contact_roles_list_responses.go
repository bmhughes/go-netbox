...
func (o *TenancyContactRolesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyContactRolesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactRolesListBadRequest creates a TenancyContactRolesListBadRequest with default headers values
func NewTenancyContactRolesListBadRequest() *TenancyContactRolesListBadRequest {
	return &TenancyContactRolesListBadRequest{}
}

/*
TenancyContactRolesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactRolesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contact roles list bad request response has a 2xx status code
func (o *TenancyContactRolesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contact roles list bad request response has a 3xx status code
func (o *TenancyContactRolesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contact roles list bad request response has a 4xx status code
func (o *TenancyContactRolesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contact roles list bad request response has a 5xx status code
func (o *TenancyContactRolesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contact roles list bad request response a status code equal to that given
func (o *TenancyContactRolesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactRolesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /tenancy/contact-roles/][%d] tenancyContactRolesListBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactRolesListBadRequest) String() string {
	return fmt.Sprintf("[GET /tenancy/contact-roles/][%d] tenancyContactRolesListBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactRolesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactRolesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
