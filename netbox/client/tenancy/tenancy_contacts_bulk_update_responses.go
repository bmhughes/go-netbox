...
func (o *TenancyContactsBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyContactsBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactsBulkUpdateBadRequest creates a TenancyContactsBulkUpdateBadRequest with default headers values
func NewTenancyContactsBulkUpdateBadRequest() *TenancyContactsBulkUpdateBadRequest {
	return &TenancyContactsBulkUpdateBadRequest{}
}

/*
TenancyContactsBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactsBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contacts bulk update bad request response has a 2xx status code
func (o *TenancyContactsBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contacts bulk update bad request response has a 3xx status code
func (o *TenancyContactsBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contacts bulk update bad request response has a 4xx status code
func (o *TenancyContactsBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contacts bulk update bad request response has a 5xx status code
func (o *TenancyContactsBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contacts bulk update bad request response a status code equal to that given
func (o *TenancyContactsBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactsBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /tenancy/contacts/][%d] tenancyContactsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactsBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /tenancy/contacts/][%d] tenancyContactsBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactsBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactsBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
