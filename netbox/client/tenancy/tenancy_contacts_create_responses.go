...
func (o *TenancyContactsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewTenancyContactsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactsCreateBadRequest creates a TenancyContactsCreateBadRequest with default headers values
func NewTenancyContactsCreateBadRequest() *TenancyContactsCreateBadRequest {
	return &TenancyContactsCreateBadRequest{}
}

/*
TenancyContactsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contacts create bad request response has a 2xx status code
func (o *TenancyContactsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contacts create bad request response has a 3xx status code
func (o *TenancyContactsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contacts create bad request response has a 4xx status code
func (o *TenancyContactsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contacts create bad request response has a 5xx status code
func (o *TenancyContactsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contacts create bad request response a status code equal to that given
func (o *TenancyContactsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /tenancy/contacts/][%d] tenancyContactsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /tenancy/contacts/][%d] tenancyContactsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
