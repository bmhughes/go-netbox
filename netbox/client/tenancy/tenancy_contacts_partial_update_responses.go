...
func (o *TenancyContactsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyContactsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyContactsPartialUpdateBadRequest creates a TenancyContactsPartialUpdateBadRequest with default headers values
func NewTenancyContactsPartialUpdateBadRequest() *TenancyContactsPartialUpdateBadRequest {
	return &TenancyContactsPartialUpdateBadRequest{}
}

/*
TenancyContactsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyContactsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy contacts partial update bad request response has a 2xx status code
func (o *TenancyContactsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy contacts partial update bad request response has a 3xx status code
func (o *TenancyContactsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy contacts partial update bad request response has a 4xx status code
func (o *TenancyContactsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy contacts partial update bad request response has a 5xx status code
func (o *TenancyContactsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy contacts partial update bad request response a status code equal to that given
func (o *TenancyContactsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyContactsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /tenancy/contacts/{id}/][%d] tenancyContactsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /tenancy/contacts/{id}/][%d] tenancyContactsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyContactsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyContactsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
