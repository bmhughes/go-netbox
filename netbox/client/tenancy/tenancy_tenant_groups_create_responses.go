...
func (o *TenancyTenantGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantGroupsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantGroupsCreateBadRequest creates a TenancyTenantGroupsCreateBadRequest with default headers values
func NewTenancyTenantGroupsCreateBadRequest() *TenancyTenantGroupsCreateBadRequest {
	return &TenancyTenantGroupsCreateBadRequest{}
}

/*
TenancyTenantGroupsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantGroupsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenant groups create bad request response has a 2xx status code
func (o *TenancyTenantGroupsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenant groups create bad request response has a 3xx status code
func (o *TenancyTenantGroupsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenant groups create bad request response has a 4xx status code
func (o *TenancyTenantGroupsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenant groups create bad request response has a 5xx status code
func (o *TenancyTenantGroupsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenant groups create bad request response a status code equal to that given
func (o *TenancyTenantGroupsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantGroupsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /tenancy/tenant-groups/][%d] tenancyTenantGroupsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantGroupsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /tenancy/tenant-groups/][%d] tenancyTenantGroupsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantGroupsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyTenantGroupsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
