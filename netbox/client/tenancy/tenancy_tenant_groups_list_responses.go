...
func (o *TenancyTenantGroupsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantGroupsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantGroupsListBadRequest creates a TenancyTenantGroupsListBadRequest with default headers values
func NewTenancyTenantGroupsListBadRequest() *TenancyTenantGroupsListBadRequest {
	return &TenancyTenantGroupsListBadRequest{}
}

/*
TenancyTenantGroupsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantGroupsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenant groups list bad request response has a 2xx status code
func (o *TenancyTenantGroupsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenant groups list bad request response has a 3xx status code
func (o *TenancyTenantGroupsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenant groups list bad request response has a 4xx status code
func (o *TenancyTenantGroupsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenant groups list bad request response has a 5xx status code
func (o *TenancyTenantGroupsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenant groups list bad request response a status code equal to that given
func (o *TenancyTenantGroupsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantGroupsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /tenancy/tenant-groups/][%d] tenancyTenantGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantGroupsListBadRequest) String() string {
	return fmt.Sprintf("[GET /tenancy/tenant-groups/][%d] tenancyTenantGroupsListBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantGroupsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyTenantGroupsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
