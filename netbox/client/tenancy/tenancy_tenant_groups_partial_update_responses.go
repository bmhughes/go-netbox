...
func (o *TenancyTenantGroupsPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantGroupsPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantGroupsPartialUpdateBadRequest creates a TenancyTenantGroupsPartialUpdateBadRequest with default headers values
func NewTenancyTenantGroupsPartialUpdateBadRequest() *TenancyTenantGroupsPartialUpdateBadRequest {
	return &TenancyTenantGroupsPartialUpdateBadRequest{}
}

/*
TenancyTenantGroupsPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantGroupsPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenant groups partial update bad request response has a 2xx status code
func (o *TenancyTenantGroupsPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenant groups partial update bad request response has a 3xx status code
func (o *TenancyTenantGroupsPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenant groups partial update bad request response has a 4xx status code
func (o *TenancyTenantGroupsPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenant groups partial update bad request response has a 5xx status code
func (o *TenancyTenantGroupsPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenant groups partial update bad request response a status code equal to that given
func (o *TenancyTenantGroupsPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantGroupsPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /tenancy/tenant-groups/{id}/][%d] tenancyTenantGroupsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantGroupsPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /tenancy/tenant-groups/{id}/][%d] tenancyTenantGroupsPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantGroupsPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyTenantGroupsPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
