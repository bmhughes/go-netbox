...
func (o *TenancyTenantGroupsReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantGroupsReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantGroupsReadBadRequest creates a TenancyTenantGroupsReadBadRequest with default headers values
func NewTenancyTenantGroupsReadBadRequest() *TenancyTenantGroupsReadBadRequest {
	return &TenancyTenantGroupsReadBadRequest{}
}

/*
TenancyTenantGroupsReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantGroupsReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenant groups read bad request response has a 2xx status code
func (o *TenancyTenantGroupsReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenant groups read bad request response has a 3xx status code
func (o *TenancyTenantGroupsReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenant groups read bad request response has a 4xx status code
func (o *TenancyTenantGroupsReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenant groups read bad request response has a 5xx status code
func (o *TenancyTenantGroupsReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenant groups read bad request response a status code equal to that given
func (o *TenancyTenantGroupsReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantGroupsReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /tenancy/tenant-groups/{id}/][%d] tenancyTenantGroupsReadBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantGroupsReadBadRequest) String() string {
	return fmt.Sprintf("[GET /tenancy/tenant-groups/{id}/][%d] tenancyTenantGroupsReadBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantGroupsReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyTenantGroupsReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
