...
func (o *TenancyTenantsBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantsBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantsBulkDeleteBadRequest creates a TenancyTenantsBulkDeleteBadRequest with default headers values
func NewTenancyTenantsBulkDeleteBadRequest() *TenancyTenantsBulkDeleteBadRequest {
	return &TenancyTenantsBulkDeleteBadRequest{}
}

/*
TenancyTenantsBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantsBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenants bulk delete bad request response has a 2xx status code
func (o *TenancyTenantsBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenants bulk delete bad request response has a 3xx status code
func (o *TenancyTenantsBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenants bulk delete bad request response has a 4xx status code
func (o *TenancyTenantsBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenants bulk delete bad request response has a 5xx status code
func (o *TenancyTenantsBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenants bulk delete bad request response a status code equal to that given
func (o *TenancyTenantsBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantsBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /tenancy/tenants/][%d] tenancyTenantsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /tenancy/tenants/][%d] tenancyTenantsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}
