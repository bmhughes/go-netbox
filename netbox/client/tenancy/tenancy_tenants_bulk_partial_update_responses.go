...
func (o *TenancyTenantsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantsBulkPartialUpdateBadRequest creates a TenancyTenantsBulkPartialUpdateBadRequest with default headers values
func NewTenancyTenantsBulkPartialUpdateBadRequest() *TenancyTenantsBulkPartialUpdateBadRequest {
	return &TenancyTenantsBulkPartialUpdateBadRequest{}
}

/*
TenancyTenantsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenants bulk partial update bad request response has a 2xx status code
func (o *TenancyTenantsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenants bulk partial update bad request response has a 3xx status code
func (o *TenancyTenantsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenants bulk partial update bad request response has a 4xx status code
func (o *TenancyTenantsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenants bulk partial update bad request response has a 5xx status code
func (o *TenancyTenantsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenants bulk partial update bad request response a status code equal to that given
func (o *TenancyTenantsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /tenancy/tenants/][%d] tenancyTenantsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /tenancy/tenants/][%d] tenancyTenantsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyTenantsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
