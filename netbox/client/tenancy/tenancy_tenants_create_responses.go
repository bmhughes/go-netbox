...
func (o *TenancyTenantsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantsCreateBadRequest creates a TenancyTenantsCreateBadRequest with default headers values
func NewTenancyTenantsCreateBadRequest() *TenancyTenantsCreateBadRequest {
	return &TenancyTenantsCreateBadRequest{}
}

/*
TenancyTenantsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenants create bad request response has a 2xx status code
func (o *TenancyTenantsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenants create bad request response has a 3xx status code
func (o *TenancyTenantsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenants create bad request response has a 4xx status code
func (o *TenancyTenantsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenants create bad request response has a 5xx status code
func (o *TenancyTenantsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenants create bad request response a status code equal to that given
func (o *TenancyTenantsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /tenancy/tenants/][%d] tenancyTenantsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /tenancy/tenants/][%d] tenancyTenantsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyTenantsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
