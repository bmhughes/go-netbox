...
func (o *TenancyTenantsDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantsDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantsDeleteBadRequest creates a TenancyTenantsDeleteBadRequest with default headers values
func NewTenancyTenantsDeleteBadRequest() *TenancyTenantsDeleteBadRequest {
	return &TenancyTenantsDeleteBadRequest{}
}

/*
TenancyTenantsDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantsDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenants delete bad request response has a 2xx status code
func (o *TenancyTenantsDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenants delete bad request response has a 3xx status code
func (o *TenancyTenantsDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenants delete bad request response has a 4xx status code
func (o *TenancyTenantsDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenants delete bad request response has a 5xx status code
func (o *TenancyTenantsDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenants delete bad request response a status code equal to that given
func (o *TenancyTenantsDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantsDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /tenancy/tenants/{id}/][%d] tenancyTenantsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /tenancy/tenants/{id}/][%d] tenancyTenantsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyTenantsDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
