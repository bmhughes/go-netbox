...
func (o *TenancyTenantsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewTenancyTenantsListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTenancyTenantsListBadRequest creates a TenancyTenantsListBadRequest with default headers values
func NewTenancyTenantsListBadRequest() *TenancyTenantsListBadRequest {
	return &TenancyTenantsListBadRequest{}
}

/*
TenancyTenantsListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type TenancyTenantsListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this tenancy tenants list bad request response has a 2xx status code
func (o *TenancyTenantsListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this tenancy tenants list bad request response has a 3xx status code
func (o *TenancyTenantsListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this tenancy tenants list bad request response has a 4xx status code
func (o *TenancyTenantsListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this tenancy tenants list bad request response has a 5xx status code
func (o *TenancyTenantsListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this tenancy tenants list bad request response a status code equal to that given
func (o *TenancyTenantsListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *TenancyTenantsListBadRequest) Error() string {
	return fmt.Sprintf("[GET /tenancy/tenants/][%d] tenancyTenantsListBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsListBadRequest) String() string {
	return fmt.Sprintf("[GET /tenancy/tenants/][%d] tenancyTenantsListBadRequest  %+v", 400, o.Payload)
}

func (o *TenancyTenantsListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *TenancyTenantsListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
