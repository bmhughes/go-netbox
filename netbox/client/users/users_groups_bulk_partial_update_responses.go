...
func (o *UsersGroupsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewUsersGroupsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersGroupsBulkPartialUpdateBadRequest creates a UsersGroupsBulkPartialUpdateBadRequest with default headers values
func NewUsersGroupsBulkPartialUpdateBadRequest() *UsersGroupsBulkPartialUpdateBadRequest {
	return &UsersGroupsBulkPartialUpdateBadRequest{}
}

/*
UsersGroupsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type UsersGroupsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this users groups bulk partial update bad request response has a 2xx status code
func (o *UsersGroupsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this users groups bulk partial update bad request response has a 3xx status code
func (o *UsersGroupsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this users groups bulk partial update bad request response has a 4xx status code
func (o *UsersGroupsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this users groups bulk partial update bad request response has a 5xx status code
func (o *UsersGroupsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this users groups bulk partial update bad request response a status code equal to that given
func (o *UsersGroupsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *UsersGroupsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /users/groups/][%d] usersGroupsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *UsersGroupsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /users/groups/][%d] usersGroupsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *UsersGroupsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *UsersGroupsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
