...
func (o *UsersGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewUsersGroupsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersGroupsCreateBadRequest creates a UsersGroupsCreateBadRequest with default headers values
func NewUsersGroupsCreateBadRequest() *UsersGroupsCreateBadRequest {
	return &UsersGroupsCreateBadRequest{}
}

/*
UsersGroupsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type UsersGroupsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this users groups create bad request response has a 2xx status code
func (o *UsersGroupsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this users groups create bad request response has a 3xx status code
func (o *UsersGroupsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this users groups create bad request response has a 4xx status code
func (o *UsersGroupsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this users groups create bad request response has a 5xx status code
func (o *UsersGroupsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this users groups create bad request response a status code equal to that given
func (o *UsersGroupsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *UsersGroupsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /users/groups/][%d] usersGroupsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *UsersGroupsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /users/groups/][%d] usersGroupsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *UsersGroupsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *UsersGroupsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
