...
func (o *UsersGroupsDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUsersGroupsDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersGroupsDeleteBadRequest creates a UsersGroupsDeleteBadRequest with default headers values
func NewUsersGroupsDeleteBadRequest() *UsersGroupsDeleteBadRequest {
	return &UsersGroupsDeleteBadRequest{}
}

/*
UsersGroupsDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type UsersGroupsDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this users groups delete bad request response has a 2xx status code
func (o *UsersGroupsDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this users groups delete bad request response has a 3xx status code
func (o *UsersGroupsDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this users groups delete bad request response has a 4xx status code
func (o *UsersGroupsDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this users groups delete bad request response has a 5xx status code
func (o *UsersGroupsDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this users groups delete bad request response a status code equal to that given
func (o *UsersGroupsDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *UsersGroupsDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /users/groups/{id}/][%d] usersGroupsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *UsersGroupsDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /users/groups/{id}/][%d] usersGroupsDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *UsersGroupsDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *UsersGroupsDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
