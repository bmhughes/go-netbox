...
func (o *UsersPermissionsBulkDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUsersPermissionsBulkDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersPermissionsBulkDeleteBadRequest creates a UsersPermissionsBulkDeleteBadRequest with default headers values
func NewUsersPermissionsBulkDeleteBadRequest() *UsersPermissionsBulkDeleteBadRequest {
	return &UsersPermissionsBulkDeleteBadRequest{}
}

/*
UsersPermissionsBulkDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type UsersPermissionsBulkDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this users permissions bulk delete bad request response has a 2xx status code
func (o *UsersPermissionsBulkDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this users permissions bulk delete bad request response has a 3xx status code
func (o *UsersPermissionsBulkDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this users permissions bulk delete bad request response has a 4xx status code
func (o *UsersPermissionsBulkDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this users permissions bulk delete bad request response has a 5xx status code
func (o *UsersPermissionsBulkDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this users permissions bulk delete bad request response a status code equal to that given
func (o *UsersPermissionsBulkDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *UsersPermissionsBulkDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /users/permissions/][%d] usersPermissionsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *UsersPermissionsBulkDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /users/permissions/][%d] usersPermissionsBulkDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *UsersPermissionsBulkDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *UsersPermissionsBulkDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
