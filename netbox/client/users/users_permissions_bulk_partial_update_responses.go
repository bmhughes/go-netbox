...
func (o *UsersPermissionsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewUsersPermissionsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersPermissionsBulkPartialUpdateBadRequest creates a UsersPermissionsBulkPartialUpdateBadRequest with default headers values
func NewUsersPermissionsBulkPartialUpdateBadRequest() *UsersPermissionsBulkPartialUpdateBadRequest {
	return &UsersPermissionsBulkPartialUpdateBadRequest{}
}

/*
UsersPermissionsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type UsersPermissionsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this users permissions bulk partial update bad request response has a 2xx status code
func (o *UsersPermissionsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this users permissions bulk partial update bad request response has a 3xx status code
func (o *UsersPermissionsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this users permissions bulk partial update bad request response has a 4xx status code
func (o *UsersPermissionsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this users permissions bulk partial update bad request response has a 5xx status code
func (o *UsersPermissionsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this users permissions bulk partial update bad request response a status code equal to that given
func (o *UsersPermissionsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *UsersPermissionsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /users/permissions/][%d] usersPermissionsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *UsersPermissionsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /users/permissions/][%d] usersPermissionsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *UsersPermissionsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
