...
func (o *UsersTokensDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewUsersTokensDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersTokensDeleteBadRequest creates a UsersTokensDeleteBadRequest with default headers values
func NewUsersTokensDeleteBadRequest() *UsersTokensDeleteBadRequest {
	return &UsersTokensDeleteBadRequest{}
}

/*
UsersTokensDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type UsersTokensDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this users tokens delete bad request response has a 2xx status code
func (o *UsersTokensDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this users tokens delete bad request response has a 3xx status code
func (o *UsersTokensDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this users tokens delete bad request response has a 4xx status code
func (o *UsersTokensDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this users tokens delete bad request response has a 5xx status code
func (o *UsersTokensDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this users tokens delete bad request response a status code equal to that given
func (o *UsersTokensDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *UsersTokensDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /users/tokens/{id}/][%d] usersTokensDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *UsersTokensDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /users/tokens/{id}/][%d] usersTokensDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *UsersTokensDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *UsersTokensDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
