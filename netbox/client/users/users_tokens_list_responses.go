...
func (o *UsersTokensListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewUsersTokensListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersTokensListBadRequest creates a UsersTokensListBadRequest with default headers values
func NewUsersTokensListBadRequest() *UsersTokensListBadRequest {
	return &UsersTokensListBadRequest{}
}

/*
UsersTokensListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type UsersTokensListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this users tokens list bad request response has a 2xx status code
func (o *UsersTokensListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this users tokens list bad request response has a 3xx status code
func (o *UsersTokensListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this users tokens list bad request response has a 4xx status code
func (o *UsersTokensListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this users tokens list bad request response has a 5xx status code
func (o *UsersTokensListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this users tokens list bad request response a status code equal to that given
func (o *UsersTokensListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *UsersTokensListBadRequest) Error() string {
	return fmt.Sprintf("[GET /users/tokens/][%d] usersTokensListBadRequest  %+v", 400, o.Payload)
}

func (o *UsersTokensListBadRequest) String() string {
	return fmt.Sprintf("[GET /users/tokens/][%d] usersTokensListBadRequest  %+v", 400, o.Payload)
}

func (o *UsersTokensListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *UsersTokensListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
