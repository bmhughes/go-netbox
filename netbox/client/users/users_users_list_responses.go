...
func (o *UsersUsersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewUsersUsersListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersUsersListBadRequest creates a UsersUsersListBadRequest with default headers values
func NewUsersUsersListBadRequest() *UsersUsersListBadRequest {
	return &UsersUsersListBadRequest{}
}

/*
UsersUsersListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type UsersUsersListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this users users list bad request response has a 2xx status code
func (o *UsersUsersListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this users users list bad request response has a 3xx status code
func (o *UsersUsersListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this users users list bad request response has a 4xx status code
func (o *UsersUsersListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this users users list bad request response has a 5xx status code
func (o *UsersUsersListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this users users list bad request response a status code equal to that given
func (o *UsersUsersListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *UsersUsersListBadRequest) Error() string {
	return fmt.Sprintf("[GET /users/users/][%d] usersUsersListBadRequest  %+v", 400, o.Payload)
}

func (o *UsersUsersListBadRequest) String() string {
	return fmt.Sprintf("[GET /users/users/][%d] usersUsersListBadRequest  %+v", 400, o.Payload)
}

func (o *UsersUsersListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *UsersUsersListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
