...
func (o *VirtualizationClusterGroupsBulkPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationClusterGroupsBulkPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationClusterGroupsBulkPartialUpdateBadRequest creates a VirtualizationClusterGroupsBulkPartialUpdateBadRequest with default headers values
func NewVirtualizationClusterGroupsBulkPartialUpdateBadRequest() *VirtualizationClusterGroupsBulkPartialUpdateBadRequest {
	return &VirtualizationClusterGroupsBulkPartialUpdateBadRequest{}
}

/*
VirtualizationClusterGroupsBulkPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationClusterGroupsBulkPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization cluster groups bulk partial update bad request response has a 2xx status code
func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization cluster groups bulk partial update bad request response has a 3xx status code
func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization cluster groups bulk partial update bad request response has a 4xx status code
func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization cluster groups bulk partial update bad request response has a 5xx status code
func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization cluster groups bulk partial update bad request response a status code equal to that given
func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /virtualization/cluster-groups/][%d] virtualizationClusterGroupsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /virtualization/cluster-groups/][%d] virtualizationClusterGroupsBulkPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationClusterGroupsBulkPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
