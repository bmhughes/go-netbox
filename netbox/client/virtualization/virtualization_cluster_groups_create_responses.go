...
func (o *VirtualizationClusterGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewVirtualizationClusterGroupsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationClusterGroupsCreateBadRequest creates a VirtualizationClusterGroupsCreateBadRequest with default headers values
func NewVirtualizationClusterGroupsCreateBadRequest() *VirtualizationClusterGroupsCreateBadRequest {
	return &VirtualizationClusterGroupsCreateBadRequest{}
}

/*
VirtualizationClusterGroupsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationClusterGroupsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization cluster groups create bad request response has a 2xx status code
func (o *VirtualizationClusterGroupsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization cluster groups create bad request response has a 3xx status code
func (o *VirtualizationClusterGroupsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization cluster groups create bad request response has a 4xx status code
func (o *VirtualizationClusterGroupsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization cluster groups create bad request response has a 5xx status code
func (o *VirtualizationClusterGroupsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization cluster groups create bad request response a status code equal to that given
func (o *VirtualizationClusterGroupsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationClusterGroupsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /virtualization/cluster-groups/][%d] virtualizationClusterGroupsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterGroupsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /virtualization/cluster-groups/][%d] virtualizationClusterGroupsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterGroupsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationClusterGroupsCreateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
