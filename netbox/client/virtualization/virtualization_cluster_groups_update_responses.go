...
func (o *VirtualizationClusterGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationClusterGroupsUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationClusterGroupsUpdateBadRequest creates a VirtualizationClusterGroupsUpdateBadRequest with default headers values
func NewVirtualizationClusterGroupsUpdateBadRequest() *VirtualizationClusterGroupsUpdateBadRequest {
	return &VirtualizationClusterGroupsUpdateBadRequest{}
}

/*
VirtualizationClusterGroupsUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationClusterGroupsUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization cluster groups update bad request response has a 2xx status code
func (o *VirtualizationClusterGroupsUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization cluster groups update bad request response has a 3xx status code
func (o *VirtualizationClusterGroupsUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization cluster groups update bad request response has a 4xx status code
func (o *VirtualizationClusterGroupsUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization cluster groups update bad request response has a 5xx status code
func (o *VirtualizationClusterGroupsUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization cluster groups update bad request response a status code equal to that given
func (o *VirtualizationClusterGroupsUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationClusterGroupsUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /virtualization/cluster-groups/{id}/][%d] virtualizationClusterGroupsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterGroupsUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /virtualization/cluster-groups/{id}/][%d] virtualizationClusterGroupsUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterGroupsUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationClusterGroupsUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
