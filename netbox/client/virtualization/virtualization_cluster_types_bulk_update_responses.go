...
func (o *VirtualizationClusterTypesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationClusterTypesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationClusterTypesBulkUpdateBadRequest creates a VirtualizationClusterTypesBulkUpdateBadRequest with default headers values
func NewVirtualizationClusterTypesBulkUpdateBadRequest() *VirtualizationClusterTypesBulkUpdateBadRequest {
	return &VirtualizationClusterTypesBulkUpdateBadRequest{}
}

/*
VirtualizationClusterTypesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationClusterTypesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization cluster types bulk update bad request response has a 2xx status code
func (o *VirtualizationClusterTypesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization cluster types bulk update bad request response has a 3xx status code
func (o *VirtualizationClusterTypesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization cluster types bulk update bad request response has a 4xx status code
func (o *VirtualizationClusterTypesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization cluster types bulk update bad request response has a 5xx status code
func (o *VirtualizationClusterTypesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization cluster types bulk update bad request response a status code equal to that given
func (o *VirtualizationClusterTypesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationClusterTypesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /virtualization/cluster-types/][%d] virtualizationClusterTypesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterTypesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /virtualization/cluster-types/][%d] virtualizationClusterTypesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterTypesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationClusterTypesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
