...
func (o *VirtualizationClusterTypesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationClusterTypesListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationClusterTypesListBadRequest creates a VirtualizationClusterTypesListBadRequest with default headers values
func NewVirtualizationClusterTypesListBadRequest() *VirtualizationClusterTypesListBadRequest {
	return &VirtualizationClusterTypesListBadRequest{}
}

/*
VirtualizationClusterTypesListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationClusterTypesListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization cluster types list bad request response has a 2xx status code
func (o *VirtualizationClusterTypesListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization cluster types list bad request response has a 3xx status code
func (o *VirtualizationClusterTypesListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization cluster types list bad request response has a 4xx status code
func (o *VirtualizationClusterTypesListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization cluster types list bad request response has a 5xx status code
func (o *VirtualizationClusterTypesListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization cluster types list bad request response a status code equal to that given
func (o *VirtualizationClusterTypesListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationClusterTypesListBadRequest) Error() string {
	return fmt.Sprintf("[GET /virtualization/cluster-types/][%d] virtualizationClusterTypesListBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterTypesListBadRequest) String() string {
	return fmt.Sprintf("[GET /virtualization/cluster-types/][%d] virtualizationClusterTypesListBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterTypesListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationClusterTypesListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
