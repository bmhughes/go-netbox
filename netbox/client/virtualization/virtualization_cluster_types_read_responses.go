...
func (o *VirtualizationClusterTypesReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationClusterTypesReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationClusterTypesReadBadRequest creates a VirtualizationClusterTypesReadBadRequest with default headers values
func NewVirtualizationClusterTypesReadBadRequest() *VirtualizationClusterTypesReadBadRequest {
	return &VirtualizationClusterTypesReadBadRequest{}
}

/*
VirtualizationClusterTypesReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationClusterTypesReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization cluster types read bad request response has a 2xx status code
func (o *VirtualizationClusterTypesReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization cluster types read bad request response has a 3xx status code
func (o *VirtualizationClusterTypesReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization cluster types read bad request response has a 4xx status code
func (o *VirtualizationClusterTypesReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization cluster types read bad request response has a 5xx status code
func (o *VirtualizationClusterTypesReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization cluster types read bad request response a status code equal to that given
func (o *VirtualizationClusterTypesReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationClusterTypesReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /virtualization/cluster-types/{id}/][%d] virtualizationClusterTypesReadBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterTypesReadBadRequest) String() string {
	return fmt.Sprintf("[GET /virtualization/cluster-types/{id}/][%d] virtualizationClusterTypesReadBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClusterTypesReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationClusterTypesReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
