...
func (o *VirtualizationClustersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationClustersListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationClustersListBadRequest creates a VirtualizationClustersListBadRequest with default headers values
func NewVirtualizationClustersListBadRequest() *VirtualizationClustersListBadRequest {
	return &VirtualizationClustersListBadRequest{}
}

/*
VirtualizationClustersListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationClustersListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization clusters list bad request response has a 2xx status code
func (o *VirtualizationClustersListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization clusters list bad request response has a 3xx status code
func (o *VirtualizationClustersListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization clusters list bad request response has a 4xx status code
func (o *VirtualizationClustersListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization clusters list bad request response has a 5xx status code
func (o *VirtualizationClustersListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization clusters list bad request response a status code equal to that given
func (o *VirtualizationClustersListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationClustersListBadRequest) Error() string {
	return fmt.Sprintf("[GET /virtualization/clusters/][%d] virtualizationClustersListBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClustersListBadRequest) String() string {
	return fmt.Sprintf("[GET /virtualization/clusters/][%d] virtualizationClustersListBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationClustersListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationClustersListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
