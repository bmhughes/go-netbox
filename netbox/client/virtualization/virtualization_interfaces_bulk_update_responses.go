...
func (o *VirtualizationInterfacesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationInterfacesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationInterfacesBulkUpdateBadRequest creates a VirtualizationInterfacesBulkUpdateBadRequest with default headers values
func NewVirtualizationInterfacesBulkUpdateBadRequest() *VirtualizationInterfacesBulkUpdateBadRequest {
	return &VirtualizationInterfacesBulkUpdateBadRequest{}
}

/*
VirtualizationInterfacesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationInterfacesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization interfaces bulk update bad request response has a 2xx status code
func (o *VirtualizationInterfacesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization interfaces bulk update bad request response has a 3xx status code
func (o *VirtualizationInterfacesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization interfaces bulk update bad request response has a 4xx status code
func (o *VirtualizationInterfacesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization interfaces bulk update bad request response has a 5xx status code
func (o *VirtualizationInterfacesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization interfaces bulk update bad request response a status code equal to that given
func (o *VirtualizationInterfacesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationInterfacesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /virtualization/interfaces/][%d] virtualizationInterfacesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationInterfacesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /virtualization/interfaces/][%d] virtualizationInterfacesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationInterfacesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
