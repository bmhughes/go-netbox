...
func (o *VirtualizationInterfacesDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewVirtualizationInterfacesDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationInterfacesDeleteBadRequest creates a VirtualizationInterfacesDeleteBadRequest with default headers values
func NewVirtualizationInterfacesDeleteBadRequest() *VirtualizationInterfacesDeleteBadRequest {
	return &VirtualizationInterfacesDeleteBadRequest{}
}

/*
VirtualizationInterfacesDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationInterfacesDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization interfaces delete bad request response has a 2xx status code
func (o *VirtualizationInterfacesDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization interfaces delete bad request response has a 3xx status code
func (o *VirtualizationInterfacesDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization interfaces delete bad request response has a 4xx status code
func (o *VirtualizationInterfacesDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization interfaces delete bad request response has a 5xx status code
func (o *VirtualizationInterfacesDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization interfaces delete bad request response a status code equal to that given
func (o *VirtualizationInterfacesDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationInterfacesDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /virtualization/interfaces/{id}/][%d] virtualizationInterfacesDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationInterfacesDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /virtualization/interfaces/{id}/][%d] virtualizationInterfacesDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationInterfacesDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationInterfacesDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
