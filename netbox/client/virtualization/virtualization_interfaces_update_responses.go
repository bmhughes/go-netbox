...
func (o *VirtualizationInterfacesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationInterfacesUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationInterfacesUpdateBadRequest creates a VirtualizationInterfacesUpdateBadRequest with default headers values
func NewVirtualizationInterfacesUpdateBadRequest() *VirtualizationInterfacesUpdateBadRequest {
	return &VirtualizationInterfacesUpdateBadRequest{}
}

/*
VirtualizationInterfacesUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationInterfacesUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization interfaces update bad request response has a 2xx status code
func (o *VirtualizationInterfacesUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization interfaces update bad request response has a 3xx status code
func (o *VirtualizationInterfacesUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization interfaces update bad request response has a 4xx status code
func (o *VirtualizationInterfacesUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization interfaces update bad request response has a 5xx status code
func (o *VirtualizationInterfacesUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization interfaces update bad request response a status code equal to that given
func (o *VirtualizationInterfacesUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationInterfacesUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /virtualization/interfaces/{id}/][%d] virtualizationInterfacesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationInterfacesUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /virtualization/interfaces/{id}/][%d] virtualizationInterfacesUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationInterfacesUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationInterfacesUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
