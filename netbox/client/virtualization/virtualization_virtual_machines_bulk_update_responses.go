...
func (o *VirtualizationVirtualMachinesBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationVirtualMachinesBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationVirtualMachinesBulkUpdateBadRequest creates a VirtualizationVirtualMachinesBulkUpdateBadRequest with default headers values
func NewVirtualizationVirtualMachinesBulkUpdateBadRequest() *VirtualizationVirtualMachinesBulkUpdateBadRequest {
	return &VirtualizationVirtualMachinesBulkUpdateBadRequest{}
}

/*
VirtualizationVirtualMachinesBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationVirtualMachinesBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization virtual machines bulk update bad request response has a 2xx status code
func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization virtual machines bulk update bad request response has a 3xx status code
func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization virtual machines bulk update bad request response has a 4xx status code
func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization virtual machines bulk update bad request response has a 5xx status code
func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization virtual machines bulk update bad request response a status code equal to that given
func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /virtualization/virtual-machines/][%d] virtualizationVirtualMachinesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /virtualization/virtual-machines/][%d] virtualizationVirtualMachinesBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationVirtualMachinesBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
