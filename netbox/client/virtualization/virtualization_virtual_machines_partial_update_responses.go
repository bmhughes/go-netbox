...
func (o *VirtualizationVirtualMachinesPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewVirtualizationVirtualMachinesPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewVirtualizationVirtualMachinesPartialUpdateBadRequest creates a VirtualizationVirtualMachinesPartialUpdateBadRequest with default headers values
func NewVirtualizationVirtualMachinesPartialUpdateBadRequest() *VirtualizationVirtualMachinesPartialUpdateBadRequest {
	return &VirtualizationVirtualMachinesPartialUpdateBadRequest{}
}

/*
VirtualizationVirtualMachinesPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type VirtualizationVirtualMachinesPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this virtualization virtual machines partial update bad request response has a 2xx status code
func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this virtualization virtual machines partial update bad request response has a 3xx status code
func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this virtualization virtual machines partial update bad request response has a 4xx status code
func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this virtualization virtual machines partial update bad request response has a 5xx status code
func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this virtualization virtual machines partial update bad request response a status code equal to that given
func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /virtualization/virtual-machines/{id}/][%d] virtualizationVirtualMachinesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /virtualization/virtual-machines/{id}/][%d] virtualizationVirtualMachinesPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *VirtualizationVirtualMachinesPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
