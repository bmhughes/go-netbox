...
func (o *WirelessWirelessLanGroupsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	case 400:
		result := NewWirelessWirelessLanGroupsCreateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWirelessWirelessLanGroupsCreateBadRequest creates a WirelessWirelessLanGroupsCreateBadRequest with default headers values
func NewWirelessWirelessLanGroupsCreateBadRequest() *WirelessWirelessLanGroupsCreateBadRequest {
	return &WirelessWirelessLanGroupsCreateBadRequest{}
}

/*
WirelessWirelessLanGroupsCreateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type WirelessWirelessLanGroupsCreateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this wireless wireless lan groups create bad request response has a 2xx status code
func (o *WirelessWirelessLanGroupsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this wireless wireless lan groups create bad request response has a 3xx status code
func (o *WirelessWirelessLanGroupsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this wireless wireless lan groups create bad request response has a 4xx status code
func (o *WirelessWirelessLanGroupsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this wireless wireless lan groups create bad request response has a 5xx status code
func (o *WirelessWirelessLanGroupsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this wireless wireless lan groups create bad request response a status code equal to that given
func (o *WirelessWirelessLanGroupsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *WirelessWirelessLanGroupsCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /wireless/wireless-lan-groups/][%d] wirelessWirelessLanGroupsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLanGroupsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /wireless/wireless-lan-groups/][%d] wirelessWirelessLanGroupsCreateBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLanGroupsCreateBadRequest) GetPayload() interface{} {
	return o.Payload
}
