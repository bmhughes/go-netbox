...
func (o *WirelessWirelessLansBulkUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewWirelessWirelessLansBulkUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWirelessWirelessLansBulkUpdateBadRequest creates a WirelessWirelessLansBulkUpdateBadRequest with default headers values
func NewWirelessWirelessLansBulkUpdateBadRequest() *WirelessWirelessLansBulkUpdateBadRequest {
	return &WirelessWirelessLansBulkUpdateBadRequest{}
}

/*
WirelessWirelessLansBulkUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type WirelessWirelessLansBulkUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this wireless wireless lans bulk update bad request response has a 2xx status code
func (o *WirelessWirelessLansBulkUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this wireless wireless lans bulk update bad request response has a 3xx status code
func (o *WirelessWirelessLansBulkUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this wireless wireless lans bulk update bad request response has a 4xx status code
func (o *WirelessWirelessLansBulkUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this wireless wireless lans bulk update bad request response has a 5xx status code
func (o *WirelessWirelessLansBulkUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this wireless wireless lans bulk update bad request response a status code equal to that given
func (o *WirelessWirelessLansBulkUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *WirelessWirelessLansBulkUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /wireless/wireless-lans/][%d] wirelessWirelessLansBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLansBulkUpdateBadRequest) String() string {
	return fmt.Sprintf("[PUT /wireless/wireless-lans/][%d] wirelessWirelessLansBulkUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLansBulkUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *WirelessWirelessLansBulkUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
