...
func (o *WirelessWirelessLansListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewWirelessWirelessLansListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWirelessWirelessLansListBadRequest creates a WirelessWirelessLansListBadRequest with default headers values
func NewWirelessWirelessLansListBadRequest() *WirelessWirelessLansListBadRequest {
	return &WirelessWirelessLansListBadRequest{}
}

/*
WirelessWirelessLansListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type WirelessWirelessLansListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this wireless wireless lans list bad request response has a 2xx status code
func (o *WirelessWirelessLansListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this wireless wireless lans list bad request response has a 3xx status code
func (o *WirelessWirelessLansListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this wireless wireless lans list bad request response has a 4xx status code
func (o *WirelessWirelessLansListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this wireless wireless lans list bad request response has a 5xx status code
func (o *WirelessWirelessLansListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this wireless wireless lans list bad request response a status code equal to that given
func (o *WirelessWirelessLansListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *WirelessWirelessLansListBadRequest) Error() string {
	return fmt.Sprintf("[GET /wireless/wireless-lans/][%d] wirelessWirelessLansListBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLansListBadRequest) String() string {
	return fmt.Sprintf("[GET /wireless/wireless-lans/][%d] wirelessWirelessLansListBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLansListBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *WirelessWirelessLansListBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
