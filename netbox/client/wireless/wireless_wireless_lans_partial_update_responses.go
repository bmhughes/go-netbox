...
func (o *WirelessWirelessLansPartialUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewWirelessWirelessLansPartialUpdateBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWirelessWirelessLansPartialUpdateBadRequest creates a WirelessWirelessLansPartialUpdateBadRequest with default headers values
func NewWirelessWirelessLansPartialUpdateBadRequest() *WirelessWirelessLansPartialUpdateBadRequest {
	return &WirelessWirelessLansPartialUpdateBadRequest{}
}

/*
WirelessWirelessLansPartialUpdateBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type WirelessWirelessLansPartialUpdateBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this wireless wireless lans partial update bad request response has a 2xx status code
func (o *WirelessWirelessLansPartialUpdateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this wireless wireless lans partial update bad request response has a 3xx status code
func (o *WirelessWirelessLansPartialUpdateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this wireless wireless lans partial update bad request response has a 4xx status code
func (o *WirelessWirelessLansPartialUpdateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this wireless wireless lans partial update bad request response has a 5xx status code
func (o *WirelessWirelessLansPartialUpdateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this wireless wireless lans partial update bad request response a status code equal to that given
func (o *WirelessWirelessLansPartialUpdateBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *WirelessWirelessLansPartialUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /wireless/wireless-lans/{id}/][%d] wirelessWirelessLansPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLansPartialUpdateBadRequest) String() string {
	return fmt.Sprintf("[PATCH /wireless/wireless-lans/{id}/][%d] wirelessWirelessLansPartialUpdateBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLansPartialUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *WirelessWirelessLansPartialUpdateBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
