...
func (o *WirelessWirelessLinksDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		...
		return result, nil
	case 400:
		result := NewWirelessWirelessLinksDeleteBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWirelessWirelessLinksDeleteBadRequest creates a WirelessWirelessLinksDeleteBadRequest with default headers values
func NewWirelessWirelessLinksDeleteBadRequest() *WirelessWirelessLinksDeleteBadRequest {
	return &WirelessWirelessLinksDeleteBadRequest{}
}

/*
WirelessWirelessLinksDeleteBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type WirelessWirelessLinksDeleteBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this wireless wireless links delete bad request response has a 2xx status code
func (o *WirelessWirelessLinksDeleteBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this wireless wireless links delete bad request response has a 3xx status code
func (o *WirelessWirelessLinksDeleteBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this wireless wireless links delete bad request response has a 4xx status code
func (o *WirelessWirelessLinksDeleteBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this wireless wireless links delete bad request response has a 5xx status code
func (o *WirelessWirelessLinksDeleteBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this wireless wireless links delete bad request response a status code equal to that given
func (o *WirelessWirelessLinksDeleteBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *WirelessWirelessLinksDeleteBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /wireless/wireless-links/{id}/][%d] wirelessWirelessLinksDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLinksDeleteBadRequest) String() string {
	return fmt.Sprintf("[DELETE /wireless/wireless-links/{id}/][%d] wirelessWirelessLinksDeleteBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLinksDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *WirelessWirelessLinksDeleteBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
