...
func (o *WirelessWirelessLinksListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewWirelessWirelessLinksListBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWirelessWirelessLinksListBadRequest creates a WirelessWirelessLinksListBadRequest with default headers values
func NewWirelessWirelessLinksListBadRequest() *WirelessWirelessLinksListBadRequest {
	return &WirelessWirelessLinksListBadRequest{}
}

/*
WirelessWirelessLinksListBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type WirelessWirelessLinksListBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this wireless wireless links list bad request response has a 2xx status code
func (o *WirelessWirelessLinksListBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this wireless wireless links list bad request response has a 3xx status code
func (o *WirelessWirelessLinksListBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this wireless wireless links list bad request response has a 4xx status code
func (o *WirelessWirelessLinksListBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this wireless wireless links list bad request response has a 5xx status code
func (o *WirelessWirelessLinksListBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this wireless wireless links list bad request response a status code equal to that given
func (o *WirelessWirelessLinksListBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *WirelessWirelessLinksListBadRequest) Error() string {
	return fmt.Sprintf("[GET /wireless/wireless-links/][%d] wirelessWirelessLinksListBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLinksListBadRequest) String() string {
	return fmt.Sprintf("[GET /wireless/wireless-links/][%d] wirelessWirelessLinksListBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLinksListBadRequest) GetPayload() interface{} {
	return o.Payload
}
