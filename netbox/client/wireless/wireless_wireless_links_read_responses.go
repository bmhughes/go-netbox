...
func (o *WirelessWirelessLinksReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewWirelessWirelessLinksReadBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewWirelessWirelessLinksReadBadRequest creates a WirelessWirelessLinksReadBadRequest with default headers values
func NewWirelessWirelessLinksReadBadRequest() *WirelessWirelessLinksReadBadRequest {
	return &WirelessWirelessLinksReadBadRequest{}
}

/*
WirelessWirelessLinksReadBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type WirelessWirelessLinksReadBadRequest struct {
	Payload interface{}
}

// IsSuccess returns true when this wireless wireless links read bad request response has a 2xx status code
func (o *WirelessWirelessLinksReadBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this wireless wireless links read bad request response has a 3xx status code
func (o *WirelessWirelessLinksReadBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this wireless wireless links read bad request response has a 4xx status code
func (o *WirelessWirelessLinksReadBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this wireless wireless links read bad request response has a 5xx status code
func (o *WirelessWirelessLinksReadBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this wireless wireless links read bad request response a status code equal to that given
func (o *WirelessWirelessLinksReadBadRequest) IsCode(code int) bool {
	return code == 400
}

func (o *WirelessWirelessLinksReadBadRequest) Error() string {
	return fmt.Sprintf("[GET /wireless/wireless-links/{id}/][%d] wirelessWirelessLinksReadBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLinksReadBadRequest) String() string {
	return fmt.Sprintf("[GET /wireless/wireless-links/{id}/][%d] wirelessWirelessLinksReadBadRequest  %+v", 400, o.Payload)
}

func (o *WirelessWirelessLinksReadBadRequest) GetPayload() interface{} {
	return o.Payload
}

func (o *WirelessWirelessLinksReadBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
